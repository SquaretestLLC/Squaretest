...
public class NewTestHandler extends BaseNewTestHandler {
    ...
    public void invoke(@NotNull final Project project, @NotNull final Editor editor, @NotNull final PsiFile psiFile) {
        ...
        if(module == null) {
            // This happens when you open a java file outside the current IntelliJ project (via file->open), and then
        ...
        final UnitTestGenerator generator = newTestHandlerComponent.createUnitTestGenerator(determineConfigResult.configInfo(), false);
