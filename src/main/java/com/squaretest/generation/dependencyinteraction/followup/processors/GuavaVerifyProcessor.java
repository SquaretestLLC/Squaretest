...
public class GuavaVerifyProcessor implements MethodCallProcessor {
    @NotNull
    private final JavaPsiFacade javaPsiFacade;
    @NotNull
    private final PsiClass sourceClass;

    public GuavaVerifyProcessor(@NotNull final JavaPsiFacade javaPsiFacade, @NotNull final PsiClass sourceClass) {
    ...
    public NextStep tryProcessMethodCallWithArgThatContainsElement(
        ...
        if(!isGuavaVerifyClass(containingClass)) {
            return null;
        }
        ...
        if(methodName.equals("verify")) {
            ...
            if(currentReturnOutcome == ReturnOutcome.False) {
                ...
                ret.withExceptionThrown(currentMethodCall, getVerifyException());
        ...
        if(methodName.equals("verifyNotNull")) {
            if(index != 0) {
                return null;
            }
    ...
    private PsiType getVerifyException() {
        return getException("com.google.common.base.VerifyException");
    }
    ...
    private boolean isGuavaVerifyClass(final PsiClass containingClass) {
        final String qualifiedName = containingClass.getQualifiedName();
        return StringUtils.equals(qualifiedName, "com.google.common.base.Verify");
    }
