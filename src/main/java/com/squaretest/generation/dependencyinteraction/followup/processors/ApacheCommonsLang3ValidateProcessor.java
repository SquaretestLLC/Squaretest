...
public class ApacheCommonsLang3ValidateProcessor implements MethodCallProcessor {
    ...
    public ApacheCommonsLang3ValidateProcessor(@NotNull final JavaPsiFacade javaPsiFacade, @NotNull final PsiClass sourceClass) {
    ...
    private static boolean isValidateClass(final PsiClass containingClass) {
        ...
        return StringUtils.equalsAny(qualifiedName, "org.apache.commons.lang3.Validate", "com.azure.cosmos.implementation.apachecommons.lang.Validate");
    }
}
