...
public class SpringAssertProcessor implements MethodCallProcessor {
    ...
    public SpringAssertProcessor(@NotNull final JavaPsiFacade javaPsiFacade, @NotNull final PsiClass sourceClass) {
    ...
    public NextStep tryProcessMethodCallWithArgThatContainsElement(
        ...
        if(!isSpringAssertClass(containingClass)) {
            return null;
        }
    ...
    private static boolean isSpringAssertClass(final PsiClass containingClass) {
        final String qualifiedName = containingClass.getQualifiedName();
        return StringUtils.equalsAny(qualifiedName, "org.springframework.util.Assert");
    }
}
