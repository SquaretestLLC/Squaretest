...
class UsedInSourceDecider implements MethodCalledDecider {
    private final CalledMethodsInfoProvider calledMethodsInfoProvider;

    public UsedInSourceDecider(final CalledMethodsInfoProvider calledMethodsInfoProvider) {
    ...
    public CalledMethodInfo getCalledMethodInfo(final PsiMethod psiMethod) {
        return calledMethodsInfoProvider.getSourceAndSuperMethodCallInfo(psiMethod);
    }

    @Override
    public boolean isReferenced(final PsiField psiField) {
        return calledMethodsInfoProvider.referencedInSourceAndSupers(psiField);
    }
}
