 ...
 *
 */
package javatests.junit5.spring;
...
public class JUnit5MockitoSpringWithSourcesUUIDTests extends DefaultTemplateUUIDTestBase {

    private static final String TestDataDir = "src/test/data/java/junit5/spring/JUnit5MockitoSpringWithSourcesUUIDTests";
    private static final String TemplateName = "SQTJ-JUnit5MockitoSpring.java";

    public JUnit5MockitoSpringWithSourcesUUIDTests(@NotNull final DefaultTemplateTestInfo defaultTemplateTestInfo) {
    ...
    protected LightProjectDescriptor getProjectDescriptor() {
        return new SquaretestProjectDescriptor(TestLibs.CommonLibs, TestLibs.SpringFrameworkLibsWithSources, TestLibs.JakartaValidationLibs, TestLibs.JacksonLibs, Arrays.asList(TestLibs.Mockito3_0, TestLibs.JUnit5_7, TestLibs.Guava));
    }
}
