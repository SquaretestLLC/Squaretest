...
public class JUnit5MockitoSpring172TestMethodGeneratorTests extends TestMethodGeneratorCustomTemplateTestBase {

    private static final String TestDataDir = "src/test/data/java/junit5/spring/JUnit5MockitoSpring172TestMethodGeneratorTests";
