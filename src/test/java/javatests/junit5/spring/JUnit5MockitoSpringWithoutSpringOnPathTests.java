...
public class JUnit5MockitoSpringWithoutSpringOnPathTests extends DefaultTemplateTestBase {

    private static final String TestDataDir = "src/test/data/java/junit5/spring/JUnit5MockitoSpringWithoutSpringOnPathTests";
    private static final String TemplateName = "SQTJ-JUnit5MockitoSpring.java";

    public JUnit5MockitoSpringWithoutSpringOnPathTests(@NotNull final DefaultTemplateTestInfo defaultTemplateTestInfo) {
    ...
    protected LightProjectDescriptor getProjectDescriptor() {
        return new SquaretestProjectDescriptor(TestLibs.CommonLibs, TestLibs.JacksonLibs, Arrays.asList(TestLibs.Mockito3_0, TestLibs.JUnit5_7, TestLibs.Guava));
    }
}
