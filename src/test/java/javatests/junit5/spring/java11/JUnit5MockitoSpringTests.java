 ...
 *
 */
package javatests.junit5.spring.java11;
...
public class JUnit5MockitoSpringTests extends DefaultTemplateTestBase {

    private static final String TestDataDir = "src/test/data/java/junit5/spring/java11/JUnit5MockitoSpringTests";
    private static final String TemplateName = "SQTJ-JUnit5MockitoSpring.java";

    public JUnit5MockitoSpringTests(@NotNull final DefaultTemplateTestInfo defaultTemplateTestInfo) {
    ...
    protected LightProjectDescriptor getProjectDescriptor() {
        return new SquaretestProjectDescriptor(LanguageLevel.JDK_11, TestLibs.CommonLibs, TestLibs.SpringFrameworkLibs, TestLibs.JakartaValidationLibs, TestLibs.JacksonLibs, Arrays.asList(TestLibs.Mockito3_0, TestLibs.JUnit5_7, TestLibs.Guava));
    }
}
