...
public class JUnit5MockitoSpringBoot202Tests extends DefaultTemplateTestBase {
    ...
    private static final String TestDataDir = "src/test/data/java/junit5/spring/JUnit5MockitoSpringBoot202Tests";
    ...
    protected LightProjectDescriptor getProjectDescriptor() {
        return new SquaretestProjectDescriptor(TestLibs.CommonLibs, TestLibs.SpringFramework202Libs, Arrays.asList(TestLibs.Mockito3_0, TestLibs.JUnit5_7));
    }
}
