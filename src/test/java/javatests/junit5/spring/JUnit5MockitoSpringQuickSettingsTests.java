...
public class JUnit5MockitoSpringQuickSettingsTests extends QuickSettingsTestBase {

    private static final String TestDataDir = "src/test/data/java/junit5/spring/JUnit5MockitoSpringQuickSettingsTests";

    public JUnit5MockitoSpringQuickSettingsTests(@NotNull final QuickSettingsTestInfo quickSettingsTestInfo) {
    ...
    protected LightProjectDescriptor getProjectDescriptor() {
        return new SquaretestProjectDescriptor(TestLibs.CommonLibs, Arrays.asList(TestLibs.Mockito3_0, TestLibs.JUnit5_7, TestLibs.SquaretestSuperTypes, TestLibs.Guava));
    }
}
