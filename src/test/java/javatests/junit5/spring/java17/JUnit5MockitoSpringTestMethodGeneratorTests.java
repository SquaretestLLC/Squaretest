 ...
 *
 */
package javatests.junit5.spring.java17;
...
public class JUnit5MockitoSpringTestMethodGeneratorTests extends TestMethodGeneratorTestBase {

    private static final String TestDataDir = "src/test/data/java/junit5/spring/java17/JUnit5MockitoSpringTestMethodGenerator";
