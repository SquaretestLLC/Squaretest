 ...
 *
 */
package javatests.junit5.spring.java17.userselection;
...
public class SelectNoDepsAndAllMethodsTests extends DefaultTemplateTestBase {
    ...
    private static final String TestDataDir = "src/test/data/java/junit5/spring/java17/userselection/SelectNoDepsAndAllMethods";
