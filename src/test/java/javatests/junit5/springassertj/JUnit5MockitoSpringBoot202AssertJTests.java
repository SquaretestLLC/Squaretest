...
public class JUnit5MockitoSpringBoot202AssertJTests extends DefaultTemplateTestBase {

    private static final String TestDataDir = "src/test/data/java/junit5/springassertj/JUnit5MockitoSpringBoot202AssertJTests";
    private static final String TemplateName = "SQTJ-JUnit5MockitoSpringAssertJ.java";

    public JUnit5MockitoSpringBoot202AssertJTests(@NotNull final DefaultTemplateTestInfo defaultTemplateTestInfo) {
    ...
    protected LightProjectDescriptor getProjectDescriptor() {
        return new SquaretestProjectDescriptor(TestLibs.CommonLibs, TestLibs.SpringFramework202Libs, Arrays.asList(TestLibs.Mockito3_0, TestLibs.AssertJ, TestLibs.JUnit5_7));
    }
}
