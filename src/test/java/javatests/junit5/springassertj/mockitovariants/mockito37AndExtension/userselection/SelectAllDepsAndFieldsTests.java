...
public class SelectAllDepsAndFieldsTests extends DefaultTemplateTestBase {
    ...
    private static final String TestDataDir = "src/test/data/java/junit5/springassertj/mockitovariants/Mockito37AndExtension/userselection/SelectAllDepsAndFields";
