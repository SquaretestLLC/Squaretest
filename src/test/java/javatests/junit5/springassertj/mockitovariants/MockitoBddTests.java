...
public class MockitoBddTests extends QuickSettingsTestBase {
    ...
    private static final String TestDataDir = "src/test/data/java/junit5/springassertj/mockitovariants/MockitoBdd";
    ...
    protected LightProjectDescriptor getProjectDescriptor() {
        return new SquaretestProjectDescriptor(TestLibs.CommonLibs, TestLibs.SpringFrameworkLibs, TestLibs.JakartaValidationLibs, TestLibs.JacksonLibs, Arrays.asList(TestLibs.Mockito3_0, TestLibs.JUnit5_7, TestLibs.AssertJ, TestLibs.Guava));
    }
}
