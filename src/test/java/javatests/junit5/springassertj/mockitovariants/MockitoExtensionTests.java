 ...
 *
 */
package javatests.junit5.springassertj.mockitovariants;
...
public class MockitoExtensionTests extends DefaultTemplateTestBase {
    ...
    private static final String TestDataDir = "src/test/data/java/junit5/springassertj/mockitovariants/MockitoExtension";
