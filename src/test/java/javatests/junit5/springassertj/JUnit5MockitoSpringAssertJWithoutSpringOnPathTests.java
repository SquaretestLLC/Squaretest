...
public class JUnit5MockitoSpringAssertJWithoutSpringOnPathTests extends DefaultTemplateTestBase {

    private static final String TestDataDir = "src/test/data/java/junit5/springassertj/JUnit5MockitoSpringAssertJWithoutSpringOnPathTests";
    private static final String TemplateName = "SQTJ-JUnit5MockitoSpringAssertJ.java";

    public JUnit5MockitoSpringAssertJWithoutSpringOnPathTests(@NotNull final DefaultTemplateTestInfo defaultTemplateTestInfo) {
    ...
    protected LightProjectDescriptor getProjectDescriptor() {
        return new SquaretestProjectDescriptor(TestLibs.CommonLibs, TestLibs.JacksonLibs, Arrays.asList(TestLibs.Mockito3_0, TestLibs.AssertJ, TestLibs.JUnit5_7, TestLibs.Guava));
    }
}
