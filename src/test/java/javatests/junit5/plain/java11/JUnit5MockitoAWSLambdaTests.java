...
import javatests.junit5.plain.JUnit5MockitoTests;
...
public class JUnit5MockitoAWSLambdaTests extends JUnit5MockitoTests {

    private static final String TestDataDir = "src/test/data/java/junit5/plain/java11/JUnit5MockitoAWSLambdaTests";
    private static final String TemplateName = "SQTJ-JUnit5Mockito.java";

    public JUnit5MockitoAWSLambdaTests(@NotNull final DefaultTemplateTestInfo defaultTemplateTestInfo) {
    ...
    protected LightProjectDescriptor getProjectDescriptor() {
        return new SquaretestProjectDescriptor(LanguageLevel.JDK_11, TestLibs.CommonLibs, TestLibs.AWSV1LambdaLibs,
                Arrays.asList(TestLibs.Mockito3_0, TestLibs.JUnit5_7, TestLibs.JodaTime));
    }
}