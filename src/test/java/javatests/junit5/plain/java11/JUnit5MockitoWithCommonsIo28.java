 ...
 *
 */
package javatests.junit5.plain.java11;
...
public class JUnit5MockitoWithCommonsIo28 extends DefaultTemplateTestBase {

    private static final String TestDataDir = "src/test/data/java/junit5/plain/java11/JUnit5MockitoJava11WithCommonsIo28Tests";
    private static final String TemplateName = "SQTJ-JUnit5Mockito.java";

    public JUnit5MockitoWithCommonsIo28(@NotNull final DefaultTemplateTestInfo defaultTemplateTestInfo) {
    ...
    protected LightProjectDescriptor getProjectDescriptor() {
        return new SquaretestProjectDescriptor(LanguageLevel.JDK_11,
                TestLibs.CommonLibs, TestLibs.JacksonLibs, Arrays.asList(TestLibs.JodaTime, TestLibs.SwaggerAnnotationsV1, TestLibs.CommonsIO2_8), Arrays.asList(TestLibs.Mockito3_0, TestLibs.JUnit5_7, TestLibs.Guava));
    }
}
