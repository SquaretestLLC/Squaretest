...
public class JUnit5MockitoAWSV2NoAWSSourcesTests  extends JUnit5MockitoTests {

    private static final String TestDataDir = "src/test/data/java/junit5/plain/JUnit5MockitoAWSV2NoAWSSourcesTests";
    private static final String TemplateName = "SQTJ-JUnit5Mockito.java";

    public JUnit5MockitoAWSV2NoAWSSourcesTests(@NotNull final DefaultTemplateTestInfo defaultTemplateTestInfo) {
    ...
    protected LightProjectDescriptor getProjectDescriptor() {
        return new SquaretestProjectDescriptor(TestLibs.CommonLibs, TestLibs.AWSV2NoSourcesLibs, Arrays.asList(TestLibs.Mockito3_0, TestLibs.JUnit5_7, TestLibs.Guava));
    }
}
