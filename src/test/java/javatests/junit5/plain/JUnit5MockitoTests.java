...
public class JUnit5MockitoTests extends DefaultTemplateTestBase {

    private static final String TestDataDir = "src/test/data/java/junit5/plain/JUnit5MockitoTests";
    private static final String TemplateName = "SQTJ-JUnit5Mockito.java";

    public JUnit5MockitoTests(@NotNull final DefaultTemplateTestInfo defaultTemplateTestInfo) {
    ...
    protected LightProjectDescriptor getProjectDescriptor() {
        return new SquaretestProjectDescriptor(TestLibs.CommonLibs, TestLibs.JacksonLibs, TestLibs.JakartaWSAPILibs,
                TestLibs.JavaXWSAPILibs, TestLibs.JJWT, TestLibs.ApacheHttpLibs, Arrays.asList(TestLibs.JodaTime, TestLibs.SwaggerAnnotationsV1,
                TestLibs.SquaretestSuperTypes, TestLibs.Guava, TestLibs.CommonsLang2), Arrays.asList(TestLibs.Mockito3_0, TestLibs.JUnit5_7));
    }
}
