 ...
 *
 */
package javatests.junit5.plain.mockitovariants;
...
public class MockitoExtensionTests extends DefaultTemplateTestBase {
    ...
    private static final String TestDataDir = "src/test/data/java/junit5/plain/mockitovariants/MockitoExtension";
