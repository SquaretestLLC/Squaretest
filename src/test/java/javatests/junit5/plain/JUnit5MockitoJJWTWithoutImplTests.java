...
public class JUnit5MockitoJJWTWithoutImplTests extends DefaultTemplateTestBase {

    private static final String TestDataDir = "src/test/data/java/junit5/plain/JUnit5MockitoJJWTWithoutImplTests";
    private static final String TemplateName = "SQTJ-JUnit5Mockito.java";

    public JUnit5MockitoJJWTWithoutImplTests(@NotNull final DefaultTemplateTestInfo defaultTemplateTestInfo) {
    ...
    protected LightProjectDescriptor getProjectDescriptor() {
        return new SquaretestProjectDescriptor(TestLibs.CommonLibs, TestLibs.JacksonLibs, TestLibs.JakartaWSAPILibs,
                TestLibs.JavaXWSAPILibs, TestLibs.JJWTWithoutImpl, Arrays.asList(TestLibs.JodaTime, TestLibs.SwaggerAnnotationsV1,
