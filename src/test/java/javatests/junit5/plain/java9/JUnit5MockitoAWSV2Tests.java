 ...
 *
 */
package javatests.junit5.plain.java9;
...
public class JUnit5MockitoAWSV2Tests extends JUnit5MockitoTests {

    private static final String TestDataDir = "src/test/data/java/junit5/plain/java9/JUnit5MockitoJava9AWSV2Tests";
    private static final String TemplateName = "SQTJ-JUnit5Mockito.java";

    public JUnit5MockitoAWSV2Tests(@NotNull final DefaultTemplateTestInfo defaultTemplateTestInfo) {
    ...
    protected LightProjectDescriptor getProjectDescriptor() {
        return new SquaretestProjectDescriptor(LanguageLevel.JDK_1_9, TestLibs.CommonLibs, TestLibs.AWSV2Libs, Arrays.asList(TestLibs.Mockito3_0, TestLibs.JUnit5_7, TestLibs.Guava));
    }
}
