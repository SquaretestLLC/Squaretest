...
public class JUnit5MockitoRxJava2 extends JUnit5MockitoTests {

    private static final String TestDataDir = "src/test/data/java/junit5/plain/JUnit5MockitoRxJava2Tests";
    private static final String TemplateName = "SQTJ-JUnit5Mockito.java";

    public JUnit5MockitoRxJava2(@NotNull final DefaultTemplateTestInfo defaultTemplateTestInfo) {
    ...
    protected LightProjectDescriptor getProjectDescriptor() {
        return new SquaretestProjectDescriptor(Arrays.asList(TestLibs.Mockito3_0, TestLibs.JUnit5_7, TestLibs.RxJava2, TestLibs.ReactiveStreams));
    }
}
