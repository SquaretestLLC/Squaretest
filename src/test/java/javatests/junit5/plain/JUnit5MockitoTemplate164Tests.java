...
public class JUnit5MockitoTemplate164Tests extends CustomTemplateTestBase {

    private static final String TestDataDir = "src/test/data/java/junit5/plain/JUnit5MockitoTemplate164Tests";

    public JUnit5MockitoTemplate164Tests(@NotNull final CustomTemplateTestInfo defaultTemplateTestInfo) {
