...
public class JUnit5MockitoAWSLambdaTests extends JUnit5MockitoTests {
    ...
    private static final String TestDataDir = "src/test/data/java/junit5/plain/JUnit5MockitoAWSLambdaTests";
    ...
    protected LightProjectDescriptor getProjectDescriptor() {
        return new SquaretestProjectDescriptor(TestLibs.CommonLibs, TestLibs.AWSV1LambdaLibs,
