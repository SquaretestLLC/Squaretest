...
public class JUnit5MockitoGoogleCloudNoGCSSourcesTests extends JUnit5MockitoTests {

    private static final String TestDataDir = "src/test/data/java/junit5/plain/JUnit5MockitoGoogleCloudNoGCSSourcesTests";
    private static final String TemplateName = "SQTJ-JUnit5Mockito.java";

    public JUnit5MockitoGoogleCloudNoGCSSourcesTests(@NotNull final DefaultTemplateTestInfo defaultTemplateTestInfo) {
    ...
    protected LightProjectDescriptor getProjectDescriptor() {
        return new SquaretestProjectDescriptor(TestLibs.CommonLibs, TestLibs.GoogleCloudNoSourcesLibs, Arrays.asList(TestLibs.Mockito3_0, TestLibs.JUnit5_7, TestLibs.Guava));
    }
}