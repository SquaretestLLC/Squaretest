...
public class NoJUnit5MockitoTests extends DefaultTemplateTestBase {

    private static final String TestDataDir = "src/test/data/java/junit5/plain/NoJUnit5MockitoTests";
    private static final String TemplateName = "SQTJ-JUnit5Mockito.java";

    public NoJUnit5MockitoTests(@NotNull final DefaultTemplateTestInfo defaultTemplateTestInfo) {
    ...
    protected LightProjectDescriptor getProjectDescriptor() {
        return new SquaretestProjectDescriptor(TestLibs.CommonLibs, TestLibs.JacksonLibs, TestLibs.JakartaWSAPILibs,
                ...
                TestLibs.SquaretestSuperTypes, TestLibs.Guava), Arrays.asList(TestLibs.Mockito3_0));
    }
}
