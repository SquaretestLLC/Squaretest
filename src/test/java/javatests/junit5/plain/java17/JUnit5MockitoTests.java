 ...
 *
 */
package javatests.junit5.plain.java17;
...
public class JUnit5MockitoTests extends DefaultTemplateTestBase {
    ...
    private static final String TestDataDir = "src/test/data/java/junit5/plain/java17/JUnit5MockitoTests";
    ...
    protected LightProjectDescriptor getProjectDescriptor() {
        return new SquaretestProjectDescriptor(LanguageLevel.JDK_17, TestLibs.CommonLibs, TestLibs.JacksonLibs, Arrays.asList(TestLibs.JodaTime, TestLibs.SwaggerAnnotationsV1,  TestLibs.SquaretestSuperTypes, TestLibs.Guava), Arrays.asList(TestLibs.Mockito3_0, TestLibs.JUnit5_7));
    }
}
