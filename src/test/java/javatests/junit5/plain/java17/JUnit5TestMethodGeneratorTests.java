...
public class JUnit5TestMethodGeneratorTests extends TestMethodGeneratorTestBase {

    private static final String TestDataDir = "src/test/data/java/junit5/plain/java17/JUnit5TestMethodGenerator";
