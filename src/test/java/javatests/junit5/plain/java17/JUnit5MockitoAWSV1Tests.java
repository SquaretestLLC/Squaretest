...
public class JUnit5MockitoAWSV1Tests extends JUnit5MockitoTests {
    ...
    private static final String TestDataDir = "src/test/data/java/junit5/plain/java17/JUnit5MockitoAWSV1Tests";
    ...
    protected LightProjectDescriptor getProjectDescriptor() {
        return new SquaretestProjectDescriptor(LanguageLevel.JDK_17, TestLibs.CommonLibs, TestLibs.AWSV1Libs, Arrays.asList(TestLibs.Mockito3_0, TestLibs.JUnit5_7, TestLibs.Guava));
    }
}