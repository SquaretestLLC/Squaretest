...
public class JUnit5MockitoWithCommonsIo26Tests extends DefaultTemplateTestBase {

    private static final String TestDataDir = "src/test/data/java/junit5/plain/JUnit5MockitoWithCommonsIo26Tests";
    private static final String TemplateName = "SQTJ-JUnit5Mockito.java";

    public JUnit5MockitoWithCommonsIo26Tests(@NotNull final DefaultTemplateTestInfo defaultTemplateTestInfo) {
    ...
    protected LightProjectDescriptor getProjectDescriptor() {
        return new SquaretestProjectDescriptor(
                TestLibs.CommonLibs, TestLibs.JacksonLibs, Arrays.asList(TestLibs.JodaTime, TestLibs.SwaggerAnnotationsV1, TestLibs.CommonsIO2_6, TestLibs.Mockito3_0, TestLibs.JUnit5_7, TestLibs.Guava));
    }
}
