 ...
 *
 */
package javatests.junit5.assertj.mockitovariants.mockito37AndExtension;
...
public class Mockito37AndExtensionTests extends DefaultTemplateTestBase {
    ...
    private static final String TestDataDir = "src/test/data/java/junit5/assertj/mockitovariants/Mockito37AndExtension/Mockito37AndExtension";
