 ...
 *
 */
package javatests.junit5.assertj.mockitovariants;
...
public class MockitoExtensionTests extends DefaultTemplateTestBase {
    ...
    private static final String TestDataDir = "src/test/data/java/junit5/assertj/mockitovariants/MockitoExtension";
