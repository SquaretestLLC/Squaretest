...
public class AndroidJUnit4MockitoAWSV1Tests  extends DefaultTemplateTestBase {

    private static final String TestDataDir = "src/test/data/java/android/AndroidJUnit4MockitoAWSV1Tests";
    private static final String TemplateName = "SQTJ-AndroidJUnit4Mockito.java";

    public AndroidJUnit4MockitoAWSV1Tests(@NotNull final DefaultTemplateTestInfo defaultTemplateTestInfo) {
    ...
    protected LightProjectDescriptor getProjectDescriptor() {
        return new SquaretestProjectDescriptor(TestLibs.AndroidLibs, TestLibs.CommonLibs, TestLibs.AWSV1Libs, Arrays.asList(TestLibs.Mockito3_0, TestLibs.JUnit4_12, TestLibs.Guava));
    }
}