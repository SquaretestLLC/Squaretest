...
public class AndroidJUnit4MockitoQuickSettingsTests extends QuickSettingsTestBase {

    private static final String TestDataDir = "src/test/data/java/android/AndroidJUnit4MockitoQuickSettingsTests";

    public AndroidJUnit4MockitoQuickSettingsTests(@NotNull final QuickSettingsTestInfo quickSettingsTestInfo) {
    ...
    protected LightProjectDescriptor getProjectDescriptor() {
        return new SquaretestProjectDescriptor(TestLibs.CommonLibs, TestLibs.AndroidLibs, Arrays.asList(TestLibs.Mockito3_0, TestLibs.JUnit4_12, TestLibs.Guava));
    }
}
