...
public class AndroidJUnit4MockitoTests extends DefaultTemplateTestBase {

    private static final String TestDataDir = "src/test/data/java/android/AndroidJUnit4MockitoTests";
    private static final String TemplateName = "SQTJ-AndroidJUnit4Mockito.java";

    public AndroidJUnit4MockitoTests(@NotNull final DefaultTemplateTestInfo defaultTemplateTestInfo) {
