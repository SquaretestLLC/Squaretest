 ...
 *
 */
package javatests.android.mockitovariants;
...
public class Mockito37Tests extends DefaultTemplateTestBase {
    ...
    private static final String TestDataDir = "src/test/data/java/android/mockitovariants/Mockito37";
    ...
    protected LightProjectDescriptor getProjectDescriptor() {
        return new SquaretestProjectDescriptor(
                TestLibs.CommonLibs, TestLibs.AndroidLibs, Arrays.asList(TestLibs.Mockito3_7, TestLibs.JUnit4_12, TestLibs.Guava));
    }
}
