...
public class NoMockitoTests extends DefaultTemplateTestBase {
    ...
    private static final String TestDataDir = "src/test/data/java/android/mockitovariants/NoMockito";
    ...
    protected LightProjectDescriptor getProjectDescriptor() {
        return new SquaretestProjectDescriptor(
                TestLibs.CommonLibs, TestLibs.AndroidLibs, Arrays.asList(TestLibs.JUnit4_12, TestLibs.Guava));
    }
}