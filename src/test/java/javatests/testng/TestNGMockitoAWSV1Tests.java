...
public class TestNGMockitoAWSV1Tests extends JUnit4MockitoTests {

    private static final String TestDataDir = "src/test/data/java/testng/TestNGMockitoAWSV1Tests";
    ...
    protected LightProjectDescriptor getProjectDescriptor() {
        return new SquaretestProjectDescriptor(TestLibs.CommonLibs, TestLibs.AWSV1Libs, Arrays.asList(TestLibs.TestNG6_8, TestLibs.Mockito3_0, TestLibs.Guava));
    }
}