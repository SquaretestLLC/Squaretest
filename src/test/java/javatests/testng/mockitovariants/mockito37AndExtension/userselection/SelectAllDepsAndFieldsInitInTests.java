...
public class SelectAllDepsAndFieldsInitInTests extends DefaultTemplateTestBase {
    ...
    private static final String TestDataDir = "src/test/data/java/testng/mockitovariants/Mockito37AndExtension/userselection/SelectAllDepsAndFieldsInitInTest";
