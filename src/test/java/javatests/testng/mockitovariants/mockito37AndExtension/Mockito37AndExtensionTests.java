 ...
 *
 */
package javatests.testng.mockitovariants.mockito37AndExtension;
...
public class Mockito37AndExtensionTests extends DefaultTemplateTestBase {
    ...
    private static final String TestDataDir = "src/test/data/java/testng/mockitovariants/Mockito37AndExtension/Mockito37AndExtension";
