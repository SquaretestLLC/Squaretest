...
public class Robolectric3JUnit413MockitoTests extends DefaultTemplateTestBase {
    ...
    private static final String TestDataDir = "src/test/data/java/robolectric/Robolectric3JUnit413MockitoTests";
    ...
    protected LightProjectDescriptor getProjectDescriptor() {
        return new SquaretestProjectDescriptor(TestLibs.AndroidLibs, TestLibs.CommonLibs,
                Arrays.asList(TestLibs.JUnit4_13, TestLibs.Mockito3_0, TestLibs.Robolectric3, TestLibs.Guava));
    }
}