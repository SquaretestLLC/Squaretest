...
public class MockitoBddTests extends QuickSettingsTestBase {
    ...
    private static final String TestDataDir = "src/test/data/java/robolectric/mockitovariants/MockitoBdd";
    ...
    protected LightProjectDescriptor getProjectDescriptor() {
        return new SquaretestProjectDescriptor(
                TestLibs.CommonLibs, TestLibs.AndroidLibs, Arrays.asList(TestLibs.Mockito3_0, TestLibs.JUnit4_12, TestLibs.Robolectric3, TestLibs.Guava));
    }
}
