...
public class Robolectric3MockitoQuickSettingsTests extends QuickSettingsTestBase {

    private static final String TestDataDir = "src/test/data/java/robolectric/Robolectric3MockitoQuickSettingsTests";

    public Robolectric3MockitoQuickSettingsTests(@NotNull final QuickSettingsTestInfo quickSettingsTestInfo) {
    ...
    public static Collection<QuickSettingsTestInfo> testParameters() {
        ...
        for (final File testGroupDir : rootTestDir.listFiles()) {
            quickSettingsTestInfos.addAll(QuickSettingsTestInfoCreator.createTestsForGroup(TestDataDir, testGroupDir, "MyClassTest.java"));
        }
    ...
    protected LightProjectDescriptor getProjectDescriptor() {
        return new SquaretestProjectDescriptor(TestLibs.CommonLibs, TestLibs.AndroidLibs, Arrays.asList(TestLibs.Mockito3_0, TestLibs.JUnit4_12, TestLibs.Robolectric3, TestLibs.Guava));
    }
}
