...
public class JUnit4MockitoSpringUUIDTests extends DefaultTemplateUUIDTestBase {
    ...
    private static final String TestDataDir = "src/test/data/java/junit4/spring/JUnit4MockitoSpringUUIDTests";
    ...
    protected LightProjectDescriptor getProjectDescriptor() {
        return new SquaretestProjectDescriptor(TestLibs.CommonLibs, Arrays.asList(TestLibs.JUnit4_12, TestLibs.Mockito3_0, TestLibs.Guava), TestLibs.SpringFrameworkLibs, TestLibs.JakartaValidationLibs, TestLibs.JacksonLibs);
    }
}
