 ...
 *
 */
package javatests.junit4.spring.mockitovariants;
...
public class MockitoRunnerDisabledTests extends QuickSettingsTestBase {
    ...
    private static final String TestDataDir = "src/test/data/java/junit4/spring/mockitovariants/MockitoRunnerDisabled";
