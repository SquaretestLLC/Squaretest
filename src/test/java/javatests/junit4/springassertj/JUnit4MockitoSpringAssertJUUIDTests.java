 ...
 *
 */
package javatests.junit4.springassertj;
...
public class JUnit4MockitoSpringAssertJUUIDTests extends DefaultTemplateUUIDTestBase {
    ...
    private static final String TestDataDir = "src/test/data/java/junit4/springassertj/JUnit4MockitoSpringAssertJUUIDTests";
    ...
    protected LightProjectDescriptor getProjectDescriptor() {
        return new SquaretestProjectDescriptor(TestLibs.CommonLibs, Arrays.asList(TestLibs.JUnit4_12, TestLibs.AssertJ, TestLibs.Mockito3_0, TestLibs.Guava), TestLibs.SpringFrameworkLibs, TestLibs.JakartaValidationLibs, TestLibs.JacksonLibs);
    }
}
