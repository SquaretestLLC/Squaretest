 ...
 *
 */
package javatests.junit4.springassertj.java17;
...
public class JUnit4MockitoSpringAssertJTestMethodGeneratorTests extends TestMethodGeneratorTestBase {

    private static final String TestDataDir = "src/test/data/java/junit4/springassertj/java17/JUnit4MockitoSpringAssertJTestMethodGenerator";
