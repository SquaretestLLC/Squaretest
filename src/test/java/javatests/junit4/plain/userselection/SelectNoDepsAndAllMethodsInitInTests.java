 ...
 *
 */
package javatests.junit4.plain.userselection;
...
public class SelectNoDepsAndAllMethodsInitInTests extends DefaultTemplateTestBase {
    ...
    private static final String TestDataDir = "src/test/data/java/junit4/plain/userselection/SelectNoDepsAndAllMethodsInitInTests";
    private static final String TemplateName = "SQTJ-JUnit4Mockito.java";
