 ...
 *
 */
package javatests.junit4.assertj;
...
public class JUnit4MockitoAssertJTests extends DefaultTemplateTestBase {
    ...
    private static final String TestDataDir = "src/test/data/java/junit4/assertj/JUnit4MockitoAssertJTests";
    ...
    protected LightProjectDescriptor getProjectDescriptor() {
        return new SquaretestProjectDescriptor(TestLibs.CommonLibs, Arrays.asList(TestLibs.JUnit4_12, TestLibs.AssertJ, TestLibs.Mockito3_0, TestLibs.Guava));
    }
}
