 ...
 *
 */
package javatests.junit4.assertj.java17;
...
public class JUnit4MockitoAssertJTestMethodGeneratorTests extends TestMethodGeneratorTestBase {

    private static final String TestDataDir = "src/test/data/java/junit4/assertj/java17/JUnit4MockitoAssertJTestMethodGenerator";
