...
public class Robolectric3MockitoTests extends DefaultTemplateTestBase {

    private static final String TestDataDir = "src/test/data/groovy/robolectric/Robolectric3MockitoTests";
    private static final String TemplateName = "SQTG-Robolectric3Mockito.groovy";

    public Robolectric3MockitoTests(@NotNull final DefaultTemplateTestInfo defaultTemplateTestInfo) {
