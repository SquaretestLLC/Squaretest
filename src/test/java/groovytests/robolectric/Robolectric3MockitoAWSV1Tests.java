...
public class Robolectric3MockitoAWSV1Tests extends Robolectric3MockitoTests {

    private static final String TestDataDir = "src/test/data/groovy/robolectric/Robolectric3MockitoAWSV1Tests";
    ...
    protected LightProjectDescriptor getProjectDescriptor() {
        return new SquaretestProjectDescriptor(TestLibs.AndroidLibs, TestLibs.CommonLibs, TestLibs.AWSV1Libs, Arrays.asList(TestLibs.Mockito3_0, TestLibs.JUnit4_12, TestLibs.Robolectric3, TestLibs.Guava));
    }
}