 ...
 *
 */
package groovytests.robolectric;
...
public class Robolectric3JUnit413MockitoTests extends DefaultTemplateTestBase {

    private static final String TestDataDir = "src/test/data/groovy/robolectric/Robolectric3JUnit413MockitoTests";
    private static final String TemplateName = "SQTG-Robolectric3Mockito.groovy";

    public Robolectric3JUnit413MockitoTests(@NotNull final DefaultTemplateTestInfo defaultTemplateTestInfo) {
    ...
    protected LightProjectDescriptor getProjectDescriptor() {
        return new SquaretestProjectDescriptor(TestLibs.AndroidLibs, TestLibs.CommonLibs, Arrays.asList(TestLibs.Mockito3_0, TestLibs.JUnit4_13, TestLibs.Robolectric3, TestLibs.Guava));
    }
}
