...
public class OldMockitoTests extends DefaultTemplateTestBase {
    ...
    private static final String TestDataDir = "src/test/data/groovy/robolectric/mockitovariants/OldMockito";
    ...
    protected LightProjectDescriptor getProjectDescriptor() {
        return new SquaretestProjectDescriptor(TestLibs.CommonLibs, Arrays.asList(TestLibs.Robolectric3, TestLibs.Guava, TestLibs.Mockito1_10));
    }
}
