...
public class TestNGMockitoAWSV1Tests extends TestNGMockitoTests {

    private static final String TestDataDir = "src/test/data/groovy/testng/TestNGMockitoAWSV1Tests";
    private static final String TemplateName = "SQTG-TestNGMockito.groovy";

    public TestNGMockitoAWSV1Tests(@NotNull final DefaultTemplateTestInfo defaultTemplateTestInfo) {
    ...
    protected LightProjectDescriptor getProjectDescriptor() {
        return new SquaretestProjectDescriptor(TestLibs.CommonLibs, TestLibs.AWSV1Libs, Arrays.asList(TestLibs.Mockito3_0, TestLibs.TestNG6_8, TestLibs.Guava));
    }
}