...
public class Mockito37Tests extends DefaultTemplateTestBase {
    ...
    private static final String TestDataDir = "src/test/data/groovy/testng/mockitovariants/Mockito37Tests";
    ...
    protected LightProjectDescriptor getProjectDescriptor() {
        return new SquaretestProjectDescriptor(TestLibs.CommonLibs, Arrays.asList(TestLibs.TestNG6_8, TestLibs.Mockito3_7, TestLibs.Guava));
    }
}
