...
public class NoMockitoTests extends DefaultTemplateTestBase {
    ...
    private static final String TestDataDir = "src/test/data/groovy/testng/mockitovariants/NoMockito";
    ...
    protected LightProjectDescriptor getProjectDescriptor() {
        return new SquaretestProjectDescriptor(TestLibs.CommonLibs, Arrays.asList(TestLibs.TestNG6_8, TestLibs.Guava));
    }
}