 ...
 *
 */
package groovytests.testng.mockitovariants.mockito37AndExtension;
...
public class Mockito37AndExtensionTests extends DefaultTemplateTestBase {
    private static final String TestDataDir = "src/test/data/groovy/testng/mockitovariants/Mockito37AndExtension/Mockito37AndExtension";
    ...
    protected LightProjectDescriptor getProjectDescriptor() {
        return new SquaretestProjectDescriptor(TestLibs.CommonLibs, TestLibs.JacksonLibs, Arrays.asList(TestLibs.JodaTime, TestLibs.SwaggerAnnotationsV1,  TestLibs.SquaretestSuperTypes, TestLibs.Guava, TestLibs.Mockito3_7, TestLibs.TestNG7_7, TestLibs.TestNGMockitoExtension));
    }
}
