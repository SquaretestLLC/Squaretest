 ...
 *
 */
package groovytests.testng.mockitovariants.mockito37AndExtension.userselection;
...
public class SelectNoDepsAndAllMethodsInitInTests extends DefaultTemplateTestBase {
    ...
    private static final String TestDataDir = "src/test/data/groovy/testng/mockitovariants/Mockito37AndExtension/userselection/SelectNoDepsAndAllMethodsInitInTests";
