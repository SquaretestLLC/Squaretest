 ...
 *
 */
package groovytests.testng.mockitovariants;
...
public class MockitoExtensionTests extends DefaultTemplateTestBase {
    ...
    private static final String TestDataDir = "src/test/data/groovy/testng/mockitovariants/MockitoExtension";
    ...
    protected LightProjectDescriptor getProjectDescriptor() {
        return new SquaretestProjectDescriptor(TestLibs.CommonLibs, TestLibs.JacksonLibs, Arrays.asList(TestLibs.JodaTime, TestLibs.SwaggerAnnotationsV1,  TestLibs.SquaretestSuperTypes, TestLibs.Mockito3_0, TestLibs.TestNG7_7, TestLibs.TestNGMockitoExtension, TestLibs.Guava));
    }
}
