...
public class NoTestNGMockitoTests extends DefaultTemplateTestBase {

    private static final String TestDataDir = "src/test/data/groovy/testng/NoTestNGMockitoTests";
    private static final String TemplateName = "SQTG-TestNGMockito.groovy";

    public NoTestNGMockitoTests(@NotNull final DefaultTemplateTestInfo defaultTemplateTestInfo) {
