...
public class TestNGMockitoQuickSettingsTests extends QuickSettingsTestBase {

    private static final String TestDataDir = "src/test/data/groovy/testng/TestNGMockitoQuickSettingsTests";

    public TestNGMockitoQuickSettingsTests(@NotNull final QuickSettingsTestInfo quickSettingsTestInfo) {
