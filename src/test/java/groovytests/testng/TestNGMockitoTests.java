...
public class TestNGMockitoTests extends DefaultTemplateTestBase {

    private static final String TestDataDir = "src/test/data/groovy/testng/TestNGMockitoTests";
    private static final String TemplateName = "SQTG-TestNGMockito.groovy";

    public TestNGMockitoTests(@NotNull final DefaultTemplateTestInfo defaultTemplateTestInfo) {
    ...
    protected LightProjectDescriptor getProjectDescriptor() {
        return new SquaretestProjectDescriptor(TestLibs.CommonLibs, Arrays.asList(TestLibs.Mockito3_0, TestLibs.TestNG6_8, TestLibs.Guava));
    }
