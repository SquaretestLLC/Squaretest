...
public class TestNG73MockitoTests extends DefaultTemplateTestBase {

    private static final String TestDataDir = "src/test/data/groovy/testng/TestNG73MockitoTests";
    private static final String TemplateName = "SQTG-TestNGMockito.groovy";

    public TestNG73MockitoTests(@NotNull final DefaultTemplateTestInfo defaultTemplateTestInfo) {
    ...
    protected LightProjectDescriptor getProjectDescriptor() {
        return new SquaretestProjectDescriptor(TestLibs.CommonLibs, Arrays.asList(TestLibs.TestNG7_3, TestLibs.Mockito3_0, TestLibs.Guava));
    }
