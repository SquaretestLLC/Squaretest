...
public class JUnit413MockitoTests extends DefaultTemplateTestBase {

    private static final String TestDataDir = "src/test/data/groovy/junit4/plain/JUnit413MockitoTests";
    private static final String TemplateName = "SQTG-JUnit4Mockito.groovy";

    public JUnit413MockitoTests(@NotNull final DefaultTemplateTestInfo defaultTemplateTestInfo) {
    ...
    protected LightProjectDescriptor getProjectDescriptor() {
        return new SquaretestProjectDescriptor(TestLibs.CommonLibs, Arrays.asList(TestLibs.Mockito3_0, TestLibs.JUnit4_13, TestLibs.Guava));
    }
}
