 ...
 *
 */
package groovytests.junit4.plain.userselection;
...
public class SelectNoDepsAndAllMethodsInitInTests extends DefaultTemplateTestBase {
    ...
    private static final String TestDataDir = "src/test/data/groovy/junit4/plain/userselection/SelectNoDepsAndAllMethodsInitInTests";
    private static final String TemplateName = "SQTG-JUnit4Mockito.groovy";
