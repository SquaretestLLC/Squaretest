...
public class JUnit4MockitoQuickSettingsTests extends QuickSettingsTestBase {

    private static final String TestDataDir = "src/test/data/groovy/junit4/plain/JUnit4MockitoQuickSettingsTests";

    public JUnit4MockitoQuickSettingsTests(@NotNull final QuickSettingsTestInfo quickSettingsTestInfo) {
