...
public class Mockito37RunnerDisabledTests extends QuickSettingsTestBase {
    ...
    private static final String TestDataDir = "src/test/data/groovy/junit4/plain/mockitovariants/Mockito37RunnerDisabled";
    ...
    protected LightProjectDescriptor getProjectDescriptor() {
        return new SquaretestProjectDescriptor(TestLibs.CommonLibs, Arrays.asList(TestLibs.JUnit4_12, TestLibs.Mockito3_7, TestLibs.Guava));
    }
}
