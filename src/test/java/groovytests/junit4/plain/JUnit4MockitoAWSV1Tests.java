 ...
 *
 */
package groovytests.junit4.plain;
...
public class JUnit4MockitoAWSV1Tests extends JUnit4MockitoTests {

    private static final String TestDataDir = "src/test/data/groovy/junit4/plain/JUnit4MockitoAWSV1Tests";
    private static final String TemplateName = "SQTG-JUnit4Mockito.groovy";

    public JUnit4MockitoAWSV1Tests(@NotNull final DefaultTemplateTestInfo defaultTemplateTestInfo) {
    ...
    protected LightProjectDescriptor getProjectDescriptor() {
        return new SquaretestProjectDescriptor(TestLibs.CommonLibs, TestLibs.AWSV1Libs, Arrays.asList(TestLibs.Mockito3_0, TestLibs.JUnit4_12, TestLibs.Guava));
    }
}