 ...
 *
 */
package groovytests.junit4.assertj;
...
public class JUnit4MockitoAssertJTests extends DefaultTemplateTestBase {

    private static final String TestDataDir = "src/test/data/groovy/junit4/assertj/JUnit4MockitoAssertJTests";
    private static final String TemplateName = "SQTG-JUnit4MockitoAssertJ.groovy";

    public JUnit4MockitoAssertJTests(@NotNull final DefaultTemplateTestInfo defaultTemplateTestInfo) {
    ...
    protected LightProjectDescriptor getProjectDescriptor() {
        return new SquaretestProjectDescriptor(TestLibs.CommonLibs, Arrays.asList(TestLibs.Mockito3_0, TestLibs.AssertJ, TestLibs.JUnit4_12, TestLibs.Guava));
    }
}