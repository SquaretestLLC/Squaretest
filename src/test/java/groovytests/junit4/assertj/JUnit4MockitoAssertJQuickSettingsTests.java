...
public class JUnit4MockitoAssertJQuickSettingsTests extends QuickSettingsTestBase {

    private static final String TestDataDir = "src/test/data/groovy/junit4/assertj/JUnit4MockitoAssertJQuickSettingsTests";

    public JUnit4MockitoAssertJQuickSettingsTests(@NotNull final QuickSettingsTestInfo quickSettingsTestInfo) {
