 ...
 *
 */
package groovytests.junit4.springassertj;

import basetests.DefaultTemplateUUIDTestBase;
...
public class JUnit4MockitoSpringAssertJUUIDTests extends DefaultTemplateUUIDTestBase {

    private static final String TestDataDir = "src/test/data/groovy/junit4/springassertj/JUnit4MockitoSpringAssertJUUIDTests";
    private static final String TemplateName = "SQTG-JUnit4MockitoSpringAssertJ.groovy";

    public JUnit4MockitoSpringAssertJUUIDTests(@NotNull final DefaultTemplateTestInfo defaultTemplateTestInfo) {
    ...
    protected LightProjectDescriptor getProjectDescriptor() {
        return new SquaretestProjectDescriptor(TestLibs.CommonLibs, TestLibs.SpringFrameworkLibs, TestLibs.JakartaValidationLibs, TestLibs.JacksonLibs, Arrays.asList(TestLibs.Mockito3_0, TestLibs.AssertJ, TestLibs.JUnit4_12, TestLibs.Guava));
    }
}
