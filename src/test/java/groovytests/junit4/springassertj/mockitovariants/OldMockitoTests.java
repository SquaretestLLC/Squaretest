 ...
 *
 */
package groovytests.junit4.springassertj.mockitovariants;
...
public class OldMockitoTests extends DefaultTemplateTestBase {

    private static final String TestDataDir = "src/test/data/groovy/junit4/springassertj/mockitovariants/OldMockito";
    private static final String TemplateName = "SQTG-JUnit4MockitoSpringAssertJ.groovy";

    public OldMockitoTests(@NotNull final DefaultTemplateTestInfo defaultTemplateTestInfo) {
    ...
    protected LightProjectDescriptor getProjectDescriptor() {
        return new SquaretestProjectDescriptor(Arrays.asList(TestLibs.Guava, TestLibs.RxJava2, TestLibs.Mockito1_10, TestLibs.BeansLib, TestLibs.LombokLib, TestLibs.JUnit4_12, TestLibs.AssertJ));
    }
}
