...
public class Mockito37RunnerDisabledTests extends QuickSettingsTestBase {
    ...
    private static final String TestDataDir = "src/test/data/groovy/junit4/springassertj/mockitovariants/Mockito37RunnerDisabled";
    ...
    protected LightProjectDescriptor getProjectDescriptor() {
        return new SquaretestProjectDescriptor(TestLibs.CommonLibs, TestLibs.SpringFrameworkLibs, TestLibs.JacksonLibs, Arrays.asList(TestLibs.JUnit4_12, TestLibs.Mockito3_7, TestLibs.Guava, TestLibs.AssertJ));
    }
}
