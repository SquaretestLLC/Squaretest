...
public class NoMockitoTests extends DefaultTemplateTestBase {

    private static final String TestDataDir = "src/test/data/groovy/junit4/springassertj/mockitovariants/NoMockito";
    private static final String TemplateName = "SQTG-JUnit4MockitoSpringAssertJ.groovy";

    public NoMockitoTests(@NotNull final DefaultTemplateTestInfo defaultTemplateTestInfo) {
    ...
    protected LightProjectDescriptor getProjectDescriptor() {
        return new SquaretestProjectDescriptor(Arrays.asList(TestLibs.Guava, TestLibs.RxJava2, TestLibs.BeansLib, TestLibs.LombokLib, TestLibs.JUnit4_12, TestLibs.AssertJ));
    }
}