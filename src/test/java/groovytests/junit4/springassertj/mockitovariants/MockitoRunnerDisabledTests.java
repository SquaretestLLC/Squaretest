...
public class MockitoRunnerDisabledTests extends QuickSettingsTestBase {

    private static final String TestDataDir = "src/test/data/groovy/junit4/springassertj/mockitovariants/MockitoRunnerDisabled";

    public MockitoRunnerDisabledTests(@NotNull final QuickSettingsTestInfo quickSettingsTestInfo) {
    ...
    protected LightProjectDescriptor getProjectDescriptor() {
        return new SquaretestProjectDescriptor(TestLibs.CommonLibs, TestLibs.SpringFrameworkLibs, TestLibs.JacksonLibs, Arrays.asList(TestLibs.JUnit4_12, TestLibs.Mockito3_0, TestLibs.Guava, TestLibs.AssertJ));
    }
}
