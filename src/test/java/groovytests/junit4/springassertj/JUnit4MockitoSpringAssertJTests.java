...
public class JUnit4MockitoSpringAssertJTests extends DefaultTemplateTestBase {

    private static final String TestDataDir = "src/test/data/groovy/junit4/springassertj/JUnit4MockitoSpringAssertJTests";
    private static final String TemplateName = "SQTG-JUnit4MockitoSpringAssertJ.groovy";

    public JUnit4MockitoSpringAssertJTests(@NotNull final DefaultTemplateTestInfo defaultTemplateTestInfo) {
