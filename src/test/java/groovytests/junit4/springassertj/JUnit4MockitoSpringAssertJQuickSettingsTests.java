...
public class JUnit4MockitoSpringAssertJQuickSettingsTests extends QuickSettingsTestBase {

    private static final String TestDataDir = "src/test/data/groovy/junit4/springassertj/JUnit4MockitoSpringAssertJQuickSettingsTests";

    public JUnit4MockitoSpringAssertJQuickSettingsTests(@NotNull final QuickSettingsTestInfo quickSettingsTestInfo) {
    ...
    protected LightProjectDescriptor getProjectDescriptor() {
        return new SquaretestProjectDescriptor(TestLibs.CommonLibs, Arrays.asList(TestLibs.Mockito3_0, TestLibs.JUnit4_12, TestLibs.SquaretestSuperTypes, TestLibs.Guava, TestLibs.AssertJ));
    }
}
