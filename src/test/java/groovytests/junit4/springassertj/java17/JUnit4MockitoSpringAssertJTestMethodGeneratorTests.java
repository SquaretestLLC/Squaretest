 ...
 *
 */
package groovytests.junit4.springassertj.java17;
...
public class JUnit4MockitoSpringAssertJTestMethodGeneratorTests extends GroovyTestMethodGeneratorTestBase {

    private static final String TestDataDir = "src/test/data/groovy/junit4/springassertj/java17/JUnit4MockitoSpringAssertJTestMethodGenerator";

    public JUnit4MockitoSpringAssertJTestMethodGeneratorTests(@NotNull final String testCaseDirName) {
