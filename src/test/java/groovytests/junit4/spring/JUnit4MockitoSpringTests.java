...
public class JUnit4MockitoSpringTests extends DefaultTemplateTestBase {

    private static final String TestDataDir = "src/test/data/groovy/junit4/spring/JUnit4MockitoSpringTests";
    private static final String TemplateName = "SQTG-JUnit4MockitoSpring.groovy";

    public JUnit4MockitoSpringTests(@NotNull final DefaultTemplateTestInfo defaultTemplateTestInfo) {
