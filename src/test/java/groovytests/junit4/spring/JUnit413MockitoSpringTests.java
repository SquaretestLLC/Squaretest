...
public class JUnit413MockitoSpringTests extends DefaultTemplateTestBase {

    private static final String TestDataDir = "src/test/data/groovy/junit4/spring/JUnit413MockitoSpringTests";
    private static final String TemplateName = "SQTG-JUnit4MockitoSpring.groovy";

    public JUnit413MockitoSpringTests(@NotNull final DefaultTemplateTestInfo defaultTemplateTestInfo) {
    ...
    protected LightProjectDescriptor getProjectDescriptor() {
        return new SquaretestProjectDescriptor(TestLibs.CommonLibs, TestLibs.SpringFrameworkLibs, TestLibs.JakartaValidationLibs, TestLibs.JacksonLibs, Arrays.asList(TestLibs.Mockito3_0, TestLibs.JUnit4_13, TestLibs.Guava));
    }
}
