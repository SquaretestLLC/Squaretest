 ...
 *
 */
package groovytests.junit4.spring;
...
public class JUnit4MockitoSpringUUIDTests extends DefaultTemplateUUIDTestBase {

    private static final String TestDataDir = "src/test/data/groovy/junit4/spring/JUnit4MockitoSpringUUIDTests";
    private static final String TemplateName = "SQTG-JUnit4MockitoSpring.groovy";

    public JUnit4MockitoSpringUUIDTests(@NotNull final DefaultTemplateTestInfo defaultTemplateTestInfo) {
    ...
    protected LightProjectDescriptor getProjectDescriptor() {
        return new SquaretestProjectDescriptor(TestLibs.CommonLibs, TestLibs.SpringFrameworkLibs, TestLibs.JakartaValidationLibs, TestLibs.JacksonLibs, Arrays.asList(TestLibs.Mockito3_0, TestLibs.JUnit4_12, TestLibs.Guava));
    }
}
