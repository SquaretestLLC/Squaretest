 ...
 *
 */
package groovytests.junit4.spring.userselection;
...
public class SelectNoDepsAndAllMethodsInitInTests extends DefaultTemplateTestBase {
    ...
    private static final String TestDataDir = "src/test/data/groovy/junit4/spring/userselection/SelectNoDepsAndAllMethodsInitInTests";
    private static final String TemplateName = "SQTG-JUnit4MockitoSpring.groovy";
