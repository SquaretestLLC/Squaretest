 ...
 *
 */
package groovytests.junit4.spring.mockitovariants;
...
public class OldMockitoTests extends DefaultTemplateTestBase {
    ...
    private static final String TestDataDir = "src/test/data/groovy/junit4/spring/mockitovariants/OldMockito";
    ...
    protected LightProjectDescriptor getProjectDescriptor() {
        return new SquaretestProjectDescriptor(Arrays.asList(TestLibs.Guava, TestLibs.RxJava2, TestLibs.Mockito1_10, TestLibs.BeansLib, TestLibs.LombokLib, TestLibs.JUnit4_12));
    }
}
