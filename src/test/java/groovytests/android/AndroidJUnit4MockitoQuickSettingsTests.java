...
public class AndroidJUnit4MockitoQuickSettingsTests extends QuickSettingsTestBase {
    ...
    private static final String TestDataDir = "src/test/data/groovy/android/AndroidJUnit4MockitoQuickSettingsTests";
    ...
    protected LightProjectDescriptor getProjectDescriptor() {
        return new SquaretestProjectDescriptor(TestLibs.AndroidLibs, TestLibs.CommonLibs, Arrays.asList(TestLibs.Mockito3_0, TestLibs.JUnit4_12, TestLibs.Guava));
    }
}
