 ...
 *
 */
package groovytests.junit5.spring.java17;
...
public class JUnit5MockitoSpringTestMethodGeneratorTests extends GroovyTestMethodGeneratorTestBase {

    private static final String TestDataDir = "src/test/data/groovy/junit5/spring/java17/JUnit5MockitoSpringTestMethodGenerator";

    public JUnit5MockitoSpringTestMethodGeneratorTests(@NotNull final String testCaseDirName) {
