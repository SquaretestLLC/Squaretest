...
public class SelectAllDepsAndMethodsTests extends DefaultTemplateTestBase {
    ...
    private static final String TestDataDir = "src/test/data/groovy/junit5/spring/mockitovariants/Mockito37AndExtension/userselection/SelectAllDepsAndMethods";
