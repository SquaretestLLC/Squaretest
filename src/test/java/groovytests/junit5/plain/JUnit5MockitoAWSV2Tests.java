...
public class JUnit5MockitoAWSV2Tests extends JUnit5MockitoTests {
    ...
    private static final String TestDataDir = "src/test/data/groovy/junit5/plain/JUnit5MockitoAWSV2Tests";
    ...
    protected LightProjectDescriptor getProjectDescriptor() {
        return new SquaretestProjectDescriptor(TestLibs.CommonLibs, TestLibs.AWSV2Libs, Arrays.asList(TestLibs.Mockito3_0, TestLibs.JUnit5_7, TestLibs.Guava));
    }
}