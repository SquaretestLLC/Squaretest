 ...
 *
 */
package groovytests.junit5.plain;
...
public class JUnit5MockitoGoogleCloudTests extends JUnit5MockitoTests {

    private static final String TestDataDir = "src/test/data/groovy/junit5/plain/JUnit5MockitoGoogleCloudTests";
    private static final String TemplateName = "SQTG-JUnit5Mockito.groovy";

    public JUnit5MockitoGoogleCloudTests(@NotNull final DefaultTemplateTestInfo defaultTemplateTestInfo) {
    ...
    protected LightProjectDescriptor getProjectDescriptor() {
        return new SquaretestProjectDescriptor(TestLibs.CommonLibs, TestLibs.GoogleCloudLibs, Arrays.asList(TestLibs.Mockito3_0, TestLibs.JUnit5_7, TestLibs.Guava));
    }
}
