...
public class JUnit5MockitoAWSV1Tests extends JUnit5MockitoTests {
    ...
    private static final String TestDataDir = "src/test/data/groovy/junit5/plain/JUnit5MockitoAWSV1Tests";
    ...
    protected LightProjectDescriptor getProjectDescriptor() {
        return new SquaretestProjectDescriptor(TestLibs.CommonLibs, TestLibs.AWSV1Libs, Arrays.asList(TestLibs.Mockito3_0, TestLibs.JUnit5_7, TestLibs.Guava));
    }
}