 ...
 *
 */
package groovytests.junit5.plain.mockitovariants;
...
public class MockitoExtensionTests extends DefaultTemplateTestBase {
    ...
    private static final String TestDataDir = "src/test/data/groovy/junit5/plain/mockitovariants/MockitoExtension";
    ...
    protected LightProjectDescriptor getProjectDescriptor() {
        return new SquaretestProjectDescriptor(TestLibs.CommonLibs, TestLibs.JacksonLibs, Arrays.asList(TestLibs.JodaTime, TestLibs.SwaggerAnnotationsV1,  TestLibs.SquaretestSuperTypes, TestLibs.Mockito3_0, TestLibs.JUnit5_7, TestLibs.JUnit5MockitoExtension, TestLibs.Guava));
    }
}
