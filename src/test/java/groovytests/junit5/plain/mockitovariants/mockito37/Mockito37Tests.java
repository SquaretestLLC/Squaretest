 ...
 *
 */
package groovytests.junit5.plain.mockitovariants.mockito37;
...
public class Mockito37Tests extends DefaultTemplateTestBase {
    ...
    private static final String TestDataDir = "src/test/data/groovy/junit5/plain/mockitovariants/Mockito37/Mockito37";
    ...
    protected LightProjectDescriptor getProjectDescriptor() {
        return new SquaretestProjectDescriptor(TestLibs.CommonLibs, TestLibs.JacksonLibs, Arrays.asList(TestLibs.JodaTime, TestLibs.SwaggerAnnotationsV1,  TestLibs.SquaretestSuperTypes, TestLibs.Guava, TestLibs.Mockito3_7, TestLibs.JUnit5_7));
    }
}
