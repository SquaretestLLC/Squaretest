 ...
 *
 */
package groovytests.junit5.plain.java17;
...
public class JUnit5TestMethodGeneratorTests extends GroovyTestMethodGeneratorTestBase {

    private static final String TestDataDir = "src/test/data/groovy/junit5/plain/java17/JUnit5TestMethodGenerator";

    public JUnit5TestMethodGeneratorTests(@NotNull final String testCaseDirName) {
