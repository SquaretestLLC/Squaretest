...
public class JUnit5MockitoQuickSettingsTests extends QuickSettingsTestBase {

    private static final String TestDataDir = "src/test/data/groovy/junit5/plain/JUnit5MockitoQuickSettingsTests";

    public JUnit5MockitoQuickSettingsTests(@NotNull final QuickSettingsTestInfo quickSettingsTestInfo) {
