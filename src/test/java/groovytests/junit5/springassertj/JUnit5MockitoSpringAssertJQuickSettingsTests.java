...
public class JUnit5MockitoSpringAssertJQuickSettingsTests extends QuickSettingsTestBase {

    private static final String TestDataDir = "src/test/data/groovy/junit5/springassertj/JUnit5MockitoSpringAssertJQuickSettingsTests";

    public JUnit5MockitoSpringAssertJQuickSettingsTests(@NotNull final QuickSettingsTestInfo quickSettingsTestInfo) {
    ...
    protected LightProjectDescriptor getProjectDescriptor() {
        return new SquaretestProjectDescriptor(TestLibs.CommonLibs, Arrays.asList(TestLibs.Mockito3_0, TestLibs.JUnit5_7, TestLibs.SquaretestSuperTypes, TestLibs.Guava, TestLibs.AssertJ));
    }
}
