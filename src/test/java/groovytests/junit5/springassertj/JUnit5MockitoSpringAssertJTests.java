...
public class JUnit5MockitoSpringAssertJTests extends DefaultTemplateTestBase {

    private static final String TestDataDir = "src/test/data/groovy/junit5/springassertj/JUnit5MockitoSpringAssertJTests";
    private static final String TemplateName = "SQTG-JUnit5MockitoSpringAssertJ.groovy";

    public JUnit5MockitoSpringAssertJTests(@NotNull final DefaultTemplateTestInfo defaultTemplateTestInfo) {
