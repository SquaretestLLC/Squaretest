 ...
 *
 */
package groovytests.junit5.springassertj;
...
public class JUnit5MockitoSpringAssertJUUIDTests extends DefaultTemplateUUIDTestBase {

    private static final String TestDataDir = "src/test/data/groovy/junit5/springassertj/JUnit5MockitoSpringAssertJUUIDTests";
    private static final String TemplateName = "SQTG-JUnit5MockitoSpringAssertJ.groovy";

    public JUnit5MockitoSpringAssertJUUIDTests(@NotNull final DefaultTemplateTestInfo defaultTemplateTestInfo) {
    ...
    protected LightProjectDescriptor getProjectDescriptor() {
        return new SquaretestProjectDescriptor(TestLibs.CommonLibs, TestLibs.SpringFrameworkLibs, TestLibs.JakartaValidationLibs, TestLibs.JacksonLibs, Arrays.asList(TestLibs.Mockito3_0, TestLibs.AssertJ, TestLibs.JUnit5_7, TestLibs.Guava));
    }
}
