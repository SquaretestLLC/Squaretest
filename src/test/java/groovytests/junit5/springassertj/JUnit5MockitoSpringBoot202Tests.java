...
public class JUnit5MockitoSpringBoot202Tests extends DefaultTemplateTestBase {

    private static final String TestDataDir = "src/test/data/groovy/junit5/springassertj/JUnit5MockitoSpringBoot202AssertJTests";
    private static final String TemplateName = "SQTG-JUnit5MockitoSpringAssertJ.groovy";

    public JUnit5MockitoSpringBoot202Tests(@NotNull final DefaultTemplateTestInfo defaultTemplateTestInfo) {
