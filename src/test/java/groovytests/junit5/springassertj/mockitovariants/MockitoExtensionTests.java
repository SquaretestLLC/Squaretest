 ...
 *
 */
package groovytests.junit5.springassertj.mockitovariants;
...
public class MockitoExtensionTests extends DefaultTemplateTestBase {

    private static final String TestDataDir = "src/test/data/groovy/junit5/springassertj/mockitovariants/MockitoExtension";
    private static final String TemplateName = "SQTG-JUnit5MockitoSpringAssertJ.groovy";

    public MockitoExtensionTests(@NotNull final DefaultTemplateTestInfo defaultTemplateTestInfo) {
