 ...
 *
 */
package groovytests.junit5.springassertj.mockitovariants.mockito37;
...
public class Mockito37Tests extends DefaultTemplateTestBase {

    private static final String TestDataDir = "src/test/data/groovy/junit5/springassertj/mockitovariants/Mockito37/Mockito37";
    private static final String TemplateName = "SQTG-JUnit5MockitoSpringAssertJ.groovy";

    public Mockito37Tests(@NotNull final DefaultTemplateTestInfo defaultTemplateTestInfo) {
