...
public class NoMockitoTests extends DefaultTemplateTestBase {
    ...
    private static final String TestDataDir = "src/test/data/groovy/junit5/springassertj/mockitovariants/NoMockito";
    ...
    protected LightProjectDescriptor getProjectDescriptor() {
        return new SquaretestProjectDescriptor(Arrays.asList(TestLibs.Guava, TestLibs.RxJava2, TestLibs.BeansLib, TestLibs.LombokLib, TestLibs.JUnit5_7, TestLibs.AssertJ));
    }
}