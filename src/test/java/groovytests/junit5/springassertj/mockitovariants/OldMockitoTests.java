...
public class OldMockitoTests extends DefaultTemplateTestBase {
    ...
    private static final String TestDataDir = "src/test/data/groovy/junit5/springassertj/mockitovariants/OldMockito";
    ...
    protected LightProjectDescriptor getProjectDescriptor() {
        return new SquaretestProjectDescriptor(Arrays.asList(TestLibs.Guava, TestLibs.RxJava2, TestLibs.Mockito1_10, TestLibs.BeansLib, TestLibs.LombokLib, TestLibs.JUnit5_7, TestLibs.AssertJ));
    }
}
