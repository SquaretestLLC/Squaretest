...
public class SelectAllDepsAndFieldsTests extends DefaultTemplateTestBase {
    ...
    private static final String TestDataDir = "src/test/data/groovy/junit5/springassertj/mockitovariants/Mockito37AndExtension/userselection/SelectAllDepsAndFields";
    ...
    protected UnitTestGenerator createUnitTestGenerator(final ConfigInfo configInfo) {
        return UnitTestGeneratorCreator.createGroovyUnitTestGenerator(myFixture.getProject(), myFixture.getModule(), configInfo, new SelectAllDepsUiUtils());
    }
