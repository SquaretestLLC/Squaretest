 ...
 *
 */
package groovytests.junit5.springassertj.mockitovariants.mockito37AndExtension;
...
public class Mockito37AndExtensionTests extends DefaultTemplateTestBase {

    private static final String TestDataDir = "src/test/data/groovy/junit5/springassertj/mockitovariants/Mockito37AndExtension/Mockito37AndExtension";
    private static final String TemplateName = "SQTG-JUnit5MockitoSpringAssertJ.groovy";

    public Mockito37AndExtensionTests(@NotNull final DefaultTemplateTestInfo defaultTemplateTestInfo) {
