...
public class SelectAllDepsAndMethodsTests extends DefaultTemplateTestBase {
    ...
    private static final String TestDataDir = "src/test/data/groovy/junit5/springassertj/mockitovariants/Mockito37AndExtension/userselection/SelectAllDepsAndMethods";
    ...
    protected UnitTestGenerator createUnitTestGenerator(final ConfigInfo configInfo) {
        return UnitTestGeneratorCreator.createGroovyUnitTestGenerator(myFixture.getProject(), myFixture.getModule(), configInfo, new SelectAllDepsAndMethodsUiUtils());
    }
