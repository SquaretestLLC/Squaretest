...
public class SelectAllDepsAndFieldsTests extends DefaultTemplateTestBase {
    ...
    private static final String TestDataDir = "src/test/data/groovy/junit5/assertj/mockitovariants/Mockito37AndExtension/userselection/SelectAllDepsAndFields";
