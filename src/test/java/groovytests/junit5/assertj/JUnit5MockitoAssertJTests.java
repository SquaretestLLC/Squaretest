 ...
 *
 */
package groovytests.junit5.assertj;
...
public class JUnit5MockitoAssertJTests extends DefaultTemplateTestBase {

    private static final String TestDataDir = "src/test/data/groovy/junit5/assertj/JUnit5MockitoAssertJTests";
    private static final String TemplateName = "SQTG-JUnit5MockitoAssertJ.groovy";

    public JUnit5MockitoAssertJTests(@NotNull final DefaultTemplateTestInfo defaultTemplateTestInfo) {
    ...
    protected LightProjectDescriptor getProjectDescriptor() {
        return new SquaretestProjectDescriptor(TestLibs.CommonLibs, Arrays.asList(TestLibs.Mockito3_0, TestLibs.AssertJ, TestLibs.JUnit5_7, TestLibs.Guava));
    }
}
