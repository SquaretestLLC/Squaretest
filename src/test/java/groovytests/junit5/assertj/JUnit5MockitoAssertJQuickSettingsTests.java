...
public class JUnit5MockitoAssertJQuickSettingsTests extends QuickSettingsTestBase {

    private static final String TestDataDir = "src/test/data/groovy/junit5/assertj/JUnit5MockitoAssertJQuickSettingsTests";

    public JUnit5MockitoAssertJQuickSettingsTests(@NotNull final QuickSettingsTestInfo quickSettingsTestInfo) {
    ...
    protected LightProjectDescriptor getProjectDescriptor() {
        return new SquaretestProjectDescriptor(TestLibs.CommonLibs, Arrays.asList(TestLibs.Mockito3_0, TestLibs.JUnit5_7, TestLibs.AssertJ, TestLibs.SquaretestSuperTypes, TestLibs.Guava));
    }
}
