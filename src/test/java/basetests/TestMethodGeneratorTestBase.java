...
public abstract class TestMethodGeneratorTestBase extends SQTestBase {
     ...
     */
    public TestMethodGeneratorTestBase(@NotNull final String testCaseDirName) {
        super();
    ...
    public void testRenderTestClassToInMemoryFile() throws Throwable {
        ...
        runTestRunnable(() -> {
            ...
            final TemplateInfo templateInfo = new TemplateInfo(templateProvider, getTemplate());

            // Run the test.
            final List<PsiMethod> generatedMethods;
            try {
                generatedMethods = testMethodGenerator.runTemplateAndReturnTestMethods(templateInfo.getFileTemplate());
