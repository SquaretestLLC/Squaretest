...
public abstract class GroovyTestMethodGeneratorCustomTemplateTestBase extends TestMethodGeneratorCustomTemplateTestBase {
    public GroovyTestMethodGeneratorCustomTemplateTestBase(final @NotNull String testCaseDirName) {
