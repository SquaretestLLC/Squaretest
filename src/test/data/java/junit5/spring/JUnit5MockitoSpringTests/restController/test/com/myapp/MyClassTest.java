...
class MyClassTest {
    ...
    @Test
    void testGetFavoriteBarFromCookieWithResponseEntitys() throws Exception {
        // Setup
        // Configure BarService.getAllBars(...).
        final BarBean barBean = new BarBean();
        barBean.setId(0L);
        ...
        // Run the test and verify the results
        mockMvc.perform(get("/data/favoriteBarWithResponseEntitys")
                        .cookie(new Cookie("favoriteBarId", "id"))
                        .accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(content().json("{}", true));
    ...
    @Test
    void testGetFavoriteBarFromCookieWithResponseEntitys_BarServiceReturnsNoItems() throws Exception {
        // Setup
        when(mockBarService.getAllBars()).thenReturn(Collections.emptyList());
    ...
    @Test
    void testGetFavoriteBarFromCookieWithResponseEntitys_BarServiceThrowsIOException() throws Exception {
        // Setup
        when(mockBarService.getAllBars()).thenThrow(IOException.class);
