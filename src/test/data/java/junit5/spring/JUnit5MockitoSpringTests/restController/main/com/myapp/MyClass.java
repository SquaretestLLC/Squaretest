...
public class MyClass {
    ...
    @GetMapping("/favoriteBarWithResponseEntitys")
    public ResponseEntity<List<BarBean>> getFavoriteBarFromCookieWithResponseEntitys(@CookieValue(name="favoriteBarId") final String id) throws InvalidBarDataIdException {
        final List<BarBean> barBeans = barService.getAllBars();
        this.metricsService.recordMetric("getFavoriteBarFromCookie success");
        return new ResponseEntity<>(barBeans, HttpStatus.OK);
    }
