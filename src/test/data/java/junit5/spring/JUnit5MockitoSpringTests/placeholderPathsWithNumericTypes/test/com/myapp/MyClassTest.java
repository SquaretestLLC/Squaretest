...
class MyClassTest {
    ...
    @Test
    void testGreetingWithPath() throws Exception {
        // Setup
    ...
    @Test
    void testGreetingWithPrimitivePath() throws Exception {
        // Setup
        // Run the test and verify the results
    ...
    @Test
    void testGreetingWithDoublePath() throws Exception {
        // Setup
        // Run the test and verify the results
    ...
    @Test
    void testGreetingWithFloatPath() throws Exception {
        // Setup
        // Run the test and verify the results
