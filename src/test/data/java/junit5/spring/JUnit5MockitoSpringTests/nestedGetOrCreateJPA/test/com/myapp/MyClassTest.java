...
class MyClassTest {
    ...
    void testGetOrCreateAlphaData1_AlphaServiceFindByIdReturnsAbsent() {
        ...
        final AlphaData s = new AlphaData();
        s.setId("id");
        ...
        s.setDeltaData(deltaData6);
        when(mockAlphaService.save(s)).thenReturn(alphaData1);
    ...
    void testGetOrCreateAlphaData1_BetaServiceFindByIdReturnsAbsent() {
        ...
        final BetaData s = new BetaData();
        s.setId("id");
        s.setCreateDate(LocalDate.of(2020, 1, 1));
        s.setDescription("description");
        final GammaData gammaData6 = new GammaData();
        gammaData6.setId("id");
        s.setGammaData(gammaData6);
        when(mockBetaService.save(s)).thenReturn(betaData3);
        ...
        deltaData5.setEpsilonData(epsilonData4);
        alphaData1.setDeltaData(deltaData5);
        final AlphaData s1 = new AlphaData();
        s1.setId("id");
        final BetaData betaData5 = new BetaData();
        betaData5.setId("id");
        ...
        s1.setBetaData(betaData5);
        final DeltaData deltaData6 = new DeltaData();
        deltaData6.setId("id");
        final EpsilonData epsilonData5 = new EpsilonData();
        epsilonData5.setId("id");
        deltaData6.setEpsilonData(epsilonData5);
        s1.setDeltaData(deltaData6);
        when(mockAlphaService.save(s1)).thenReturn(alphaData1);
    ...
    void testGetOrCreateAlphaData1_GammaServiceFindByIdReturnsAbsent() {
        ...
        final GammaData s = new GammaData();
        s.setId("id");
        s.setCreateDate(LocalDate.of(2020, 1, 1));
        s.setDescription("description");
        when(mockGammaService.save(s)).thenReturn(gammaData3);
        ...
        final BetaData s1 = new BetaData();
        s1.setId("id");
        s1.setCreateDate(LocalDate.of(2020, 1, 1));
        s1.setDescription("description");
        final GammaData gammaData5 = new GammaData();
        gammaData5.setId("id");
        s1.setGammaData(gammaData5);
        when(mockBetaService.save(s1)).thenReturn(betaData3);
        ...
        deltaData5.setEpsilonData(epsilonData4);
        alphaData1.setDeltaData(deltaData5);
        final AlphaData s2 = new AlphaData();
        s2.setId("id");
        final BetaData betaData5 = new BetaData();
        betaData5.setId("id");
        final GammaData gammaData7 = new GammaData();
        ...
        s2.setBetaData(betaData5);
        final DeltaData deltaData6 = new DeltaData();
        deltaData6.setId("id");
        final EpsilonData epsilonData5 = new EpsilonData();
        epsilonData5.setId("id");
        deltaData6.setEpsilonData(epsilonData5);
        s2.setDeltaData(deltaData6);
        when(mockAlphaService.save(s2)).thenReturn(alphaData1);
    ...
    void testGetOrCreateAlphaData1_DeltaServiceFindByIdReturnsAbsent() {
        ...
        final DeltaData s = new DeltaData();
        s.setId("id");
        s.setCreateDate(LocalDate.of(2020, 1, 1));
        s.setDescription("description");
        final EpsilonData epsilonData6 = new EpsilonData();
        epsilonData6.setId("id");
        s.setEpsilonData(epsilonData6);
        when(mockDeltaService.save(s)).thenReturn(deltaData3);
    ...
    void testGetOrCreateAlphaData1_EpsilonServiceFindByIdReturnsAbsent() {
        ...
        final EpsilonData s = new EpsilonData();
        s.setId("id");
        s.setCreateDate(LocalDate.of(2020, 1, 1));
        s.setDescription("description");
        when(mockEpsilonService.save(s)).thenReturn(epsilonData3);
        ...
        final DeltaData s1 = new DeltaData();
        s1.setId("id");
        s1.setCreateDate(LocalDate.of(2020, 1, 1));
        s1.setDescription("description");
        final EpsilonData epsilonData5 = new EpsilonData();
        epsilonData5.setId("id");
        s1.setEpsilonData(epsilonData5);
        when(mockDeltaService.save(s1)).thenReturn(deltaData3);
        ...
        gammaData5.setId("id");
        betaData6.setGammaData(gammaData5);
        s2.setBetaData(betaData6);
        final DeltaData deltaData5 = new DeltaData();
        deltaData5.setId("id");
        final EpsilonData epsilonData7 = new EpsilonData();
        epsilonData7.setId("id");
        deltaData5.setEpsilonData(epsilonData7);
        s2.setDeltaData(deltaData5);
        when(mockAlphaService.save(s2)).thenReturn(alphaData1);
