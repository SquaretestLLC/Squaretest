...
public abstract class MyClass implements Comparable<MyClass> {
    ...
    */
    /** Log tag. */
    private static final String LOG = MyClass.class.getSimpleName();
    /**
     ...
     */
    public static final MyClass EMPTY = new HierarchicalUri(null, Part.NULL,
            PathPart.EMPTY, Part.NULL, Part.NULL);
    /**
     * Do not seal the class.
     */
    MyClass() {}
    /**
     ...
     * returned as {@code tel:xxx-xxx-xxxx} and {@code https://example.com/path/to/item/} is
     * returned as {@code https://example.com/...}.
     ...
     */
    public static MyClass parse(String uriString) {
     ...
     */
    public static MyClass fromFile(File file) {
        if (file == null) {
    ...
    private static class StringUri extends AbstractHierarchicalUri {
        ...
        static MyClass readFrom(String parcel) {
            return new StringUri(parcel);
        }
        public int describeContents() {
            return 0;
        }
        public void writeToParcel(String parcel, int flags) {
        }
     ...
     * Opaque URI.
     */
    private static class OpaqueUri extends MyClass {
        /** Used in parcelling. */
     ...
     */
    private abstract static class AbstractHierarchicalUri extends MyClass {
        public String getLastPathSegment() {
     ...
     *
     * <p>Use {@link MyClass#buildUpon()} to obtain a builder representing an existing URI.
     */
     ...
     */
    public MyClass normalizeScheme() {
        String scheme = getScheme();
     ...
     */
    public static void writeToParcel(String out, MyClass uri) {
    }
    ...
    static abstract class AbstractPart {
        ...
        final void writeTo(String parcel) {
    ...
    static class Part extends AbstractPart {
        ...
        static Part readFrom(String parcel) {
    ...
    static class PathPart extends AbstractPart {
        ...
        static PathPart readFrom(String parcel) {
            int representation = parcel.length();
            switch (representation) {
                case REPRESENTATION_ENCODED:
                    return fromEncoded(parcel);
                case REPRESENTATION_DECODED:
                    return fromDecoded(parcel);
                default:
     ...
     */
    public static MyClass withAppendedPath(MyClass baseUri, String pathSegment) {
        Builder builder = baseUri.buildUpon();
        builder = builder.appendEncodedPath(pathSegment);
        return builder.build();
    }
    /**
     * If this {@link MyClass} is {@code file://}, then resolve and return its
     ...
     * @hide
     */
    public MyClass getCanonicalUri() {
        if ("file".equals(getScheme())) {
            ...
            return MyClass.fromFile(new File(canonicalPath));
        } else {
            return this;
        }
    }
     ...
     * @hide
     */
    public boolean isPathPrefixMatch(MyClass prefix) {
