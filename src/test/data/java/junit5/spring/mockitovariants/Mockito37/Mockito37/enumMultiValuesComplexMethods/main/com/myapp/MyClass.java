...
public enum MyClass {
    ...
    PRIMARY(Executors.newSingleThreadExecutor(), null, 10L),
    SECONDARY(Executors.newSingleThreadExecutor(), null, 10L);
    ...
    // Static methods
    public static MyClass getPrimary() {
        return MyClass.PRIMARY;
    }

    public static long safeGetHostConnectionCount(String host) {
        return 0L;
    }

    public static long getHostConnectionCount(String host) throws IOException {
        return 0L;
    }

    public static void safeGetHostConnectionCount(String host, MutableLong out) {
        out.setValue(0L);
    }

    public static void getHostConnectionCount(String host, MutableLong out) throws IOException {
        out.setValue(0L);
    }
}
