...
class MyClassTest {
    ...
    @Test
    void testDetectDocumentText_ImageAnnotatorClientThrowsApiException() {
        // Setup
        when(mockClient.batchAnnotateImages(Arrays.asList(AnnotateImageRequest.newBuilder()
                .setImage(Image.newBuilder()
                        .setContent(ByteString.copyFrom("content".getBytes()))
        ...
        // Run the test
        assertThrows(ApiException.class, () -> myClassUnderTest.detectDocumentText("filePath"));
    }
    ...
    @Test
    void testDetectDocumentTextGcs_ImageAnnotatorClientThrowsApiException() {
        // Setup
        when(mockClient.batchAnnotateImages(Arrays.asList(AnnotateImageRequest.newBuilder()
                .setImage(Image.newBuilder()
                        .setContent(ByteString.copyFrom("content".getBytes()))
        ...
        // Run the test
        assertThrows(ApiException.class, () -> myClassUnderTest.detectDocumentTextGcs("gcsPath"));
    }
    ...
    @Test
    void testDetectDocumentsGcs_ImageAnnotatorClientThrowsApiException() {
        // Setup
        when(mockClient.asyncBatchAnnotateFilesAsync(Arrays.asList(AsyncAnnotateFileRequest.newBuilder()
                .setInputConfig(InputConfig.newBuilder()
                        .setGcsSource(GcsSource.newBuilder()
