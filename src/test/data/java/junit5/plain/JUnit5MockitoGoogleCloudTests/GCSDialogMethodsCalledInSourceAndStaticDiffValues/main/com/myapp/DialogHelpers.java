...
public class DialogHelpers {
    private static final double OtherPitch = 9999.5;
    private static final double GainVolume = OtherPitch + 1.5;
    public static DetectIntentRequest createRequest(final String param) {
        final DetectIntentRequest request = DetectIntentRequest.newBuilder()
                ...
                .setQueryInput(QueryInput.newBuilder()
                        ...
                        .setAudio(AudioInput.newBuilder()
                                .setConfig(InputAudioConfig.newBuilder()
                                        .setAudioEncoding(AudioEncoding.AUDIO_ENCODING_MULAW)
                                        .setSampleRateHertz(0)
                                        .setEnableWordInfo(false)
                                        .addPhraseHints("value")
                                        .setModel("value")
                                        .setModelVariant(SpeechModelVariant.USE_STANDARD)
                ...
                .setOutputAudioConfig(OutputAudioConfig.newBuilder()
                        .setAudioEncoding(OutputAudioEncoding.OUTPUT_AUDIO_ENCODING_MP3_64_KBPS)
                        .setSampleRateHertz(9999)
                        .setSynthesizeSpeechConfig(SynthesizeSpeechConfig.newBuilder()
                                .setSpeakingRate(9999.0)
                                .setPitch(OtherPitch)
                                ...
                                .setVoice(VoiceSelectionParams.newBuilder()
                                        ...
                                        .setSsmlGender(SsmlVoiceGender.SSML_VOICE_GENDER_MALE)
