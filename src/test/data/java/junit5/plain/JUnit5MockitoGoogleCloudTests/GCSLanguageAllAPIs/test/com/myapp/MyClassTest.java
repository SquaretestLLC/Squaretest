...
class MyClassTest {
    ...
    @Test
    void testTryAnalyzeSentiment1() throws Exception {
        // Setup
        // Configure LanguageServiceClient.analyzeSentiment(...).
        final AnalyzeSentimentResponse analyzeSentimentResponse = AnalyzeSentimentResponse.newBuilder().build();
    ...
    void testTryAnalyzeSentiment1_LanguageServiceClientThrowsApiException() {
        ...
        // Run the test
        assertThrows(ApiException.class, () -> myClassUnderTest.tryAnalyzeSentiment1());
    }

    @Test
    void testTryAnalyzeSentiment2() throws Exception {
        // Setup
        // Configure LanguageServiceClient.analyzeSentiment(...).
        final AnalyzeSentimentResponse analyzeSentimentResponse = AnalyzeSentimentResponse.newBuilder().build();
    ...
    void testTryAnalyzeSentiment2_LanguageServiceClientThrowsApiException() {
        ...
        // Run the test
        assertThrows(ApiException.class, () -> myClassUnderTest.tryAnalyzeSentiment2());
    }

    @Test
    void testTryAnalyzeSentiment3() throws Exception {
        // Setup
        // Configure LanguageServiceClient.analyzeSentiment(...).
        final AnalyzeSentimentResponse analyzeSentimentResponse = AnalyzeSentimentResponse.newBuilder().build();
    ...
    void testTryAnalyzeSentiment3_LanguageServiceClientThrowsApiException() {
        ...
        // Run the test
        assertThrows(ApiException.class, () -> myClassUnderTest.tryAnalyzeSentiment3());
    }
    ...
    void testTryAnalyzeSentimentCallable() {
        ...
        final UnaryCallable<AnalyzeSentimentRequest, AnalyzeSentimentResponse> analyzeSentimentRequestAnalyzeSentimentResponseUnaryCallable = new UnaryCallable<AnalyzeSentimentRequest, AnalyzeSentimentResponse>() {
            @Override
            public ApiFuture<AnalyzeSentimentResponse> futureCall(final AnalyzeSentimentRequest request, final ApiCallContext context) {
                final SettableApiFuture<AnalyzeSentimentResponse> settableApiFuture = SettableApiFuture.create();
    ...
    @Test
    void testTryAnalyzeEntities1() throws Exception {
        // Setup
        // Configure LanguageServiceClient.analyzeEntities(...).
        final AnalyzeEntitiesResponse analyzeEntitiesResponse = AnalyzeEntitiesResponse.newBuilder().build();
    ...
    void testTryAnalyzeEntities1_LanguageServiceClientThrowsApiException() {
        ...
        // Run the test
        assertThrows(ApiException.class, () -> myClassUnderTest.tryAnalyzeEntities1());
    }

    @Test
    void testTryAnalyzeEntities2() throws Exception {
        // Setup
        // Configure LanguageServiceClient.analyzeEntities(...).
        final AnalyzeEntitiesResponse analyzeEntitiesResponse = AnalyzeEntitiesResponse.newBuilder().build();
    ...
    void testTryAnalyzeEntities2_LanguageServiceClientThrowsApiException() {
        ...
        // Run the test
        assertThrows(ApiException.class, () -> myClassUnderTest.tryAnalyzeEntities2());
    }

    @Test
    void testTryAnalyzeEntities3() throws Exception {
        // Setup
        // Configure LanguageServiceClient.analyzeEntities(...).
        final AnalyzeEntitiesResponse analyzeEntitiesResponse = AnalyzeEntitiesResponse.newBuilder().build();
    ...
    void testTryAnalyzeEntities3_LanguageServiceClientThrowsApiException() {
        ...
        // Run the test
        assertThrows(ApiException.class, () -> myClassUnderTest.tryAnalyzeEntities3());
    }
    ...
    void testTryAnalyzeEntitiesCallable() {
        ...
        final UnaryCallable<AnalyzeEntitiesRequest, AnalyzeEntitiesResponse> analyzeEntitiesRequestAnalyzeEntitiesResponseUnaryCallable = new UnaryCallable<AnalyzeEntitiesRequest, AnalyzeEntitiesResponse>() {
            @Override
            public ApiFuture<AnalyzeEntitiesResponse> futureCall(final AnalyzeEntitiesRequest request, final ApiCallContext context) {
                final SettableApiFuture<AnalyzeEntitiesResponse> settableApiFuture = SettableApiFuture.create();
    ...
    @Test
    void testTryAnalyzeEntitySentiment1() throws Exception {
        // Setup
        // Configure LanguageServiceClient.analyzeEntitySentiment(...).
        final AnalyzeEntitySentimentResponse analyzeEntitySentimentResponse = AnalyzeEntitySentimentResponse.newBuilder().build();
    ...
    void testTryAnalyzeEntitySentiment1_LanguageServiceClientThrowsApiException() {
        ...
        // Run the test
        assertThrows(ApiException.class, () -> myClassUnderTest.tryAnalyzeEntitySentiment1());
    }

    @Test
    void testTryAnalyzeEntitySentiment2() throws Exception {
        // Setup
        // Configure LanguageServiceClient.analyzeEntitySentiment(...).
        final AnalyzeEntitySentimentResponse analyzeEntitySentimentResponse = AnalyzeEntitySentimentResponse.newBuilder().build();
        when(mockLanguageServiceClient.analyzeEntitySentiment(Document.newBuilder().build()))
    ...
    void testTryAnalyzeEntitySentiment2_LanguageServiceClientThrowsApiException() {
        ...
        // Run the test
        assertThrows(ApiException.class, () -> myClassUnderTest.tryAnalyzeEntitySentiment2());
    }

    @Test
    void testTryAnalyzeEntitySentiment3() throws Exception {
        // Setup
        // Configure LanguageServiceClient.analyzeEntitySentiment(...).
        final AnalyzeEntitySentimentResponse analyzeEntitySentimentResponse = AnalyzeEntitySentimentResponse.newBuilder().build();
    ...
    void testTryAnalyzeEntitySentiment3_LanguageServiceClientThrowsApiException() {
        ...
        // Run the test
        assertThrows(ApiException.class, () -> myClassUnderTest.tryAnalyzeEntitySentiment3());
    }
    ...
    void testTryAnalyzeEntitySentimentCallable() {
        ...
        final UnaryCallable<AnalyzeEntitySentimentRequest, AnalyzeEntitySentimentResponse> analyzeEntitySentimentRequestAnalyzeEntitySentimentResponseUnaryCallable = new UnaryCallable<AnalyzeEntitySentimentRequest, AnalyzeEntitySentimentResponse>() {
            @Override
            public ApiFuture<AnalyzeEntitySentimentResponse> futureCall(final AnalyzeEntitySentimentRequest request, final ApiCallContext context) {
                final SettableApiFuture<AnalyzeEntitySentimentResponse> settableApiFuture = SettableApiFuture.create();
    ...
    @Test
    void testTryAnalyzeSyntax1() throws Exception {
        // Setup
        // Configure LanguageServiceClient.analyzeSyntax(...).
        final AnalyzeSyntaxResponse analyzeSyntaxResponse = AnalyzeSyntaxResponse.newBuilder().build();
    ...
    void testTryAnalyzeSyntax1_LanguageServiceClientThrowsApiException() {
        ...
        // Run the test
        assertThrows(ApiException.class, () -> myClassUnderTest.tryAnalyzeSyntax1());
    }

    @Test
    void testTryAnalyzeSyntax2() throws Exception {
        // Setup
        // Configure LanguageServiceClient.analyzeSyntax(...).
        final AnalyzeSyntaxResponse analyzeSyntaxResponse = AnalyzeSyntaxResponse.newBuilder().build();
    ...
    void testTryAnalyzeSyntax2_LanguageServiceClientThrowsApiException() {
        ...
        // Run the test
        assertThrows(ApiException.class, () -> myClassUnderTest.tryAnalyzeSyntax2());
    }

    @Test
    void testTryAnalyzeSyntax3() throws Exception {
        // Setup
        // Configure LanguageServiceClient.analyzeSyntax(...).
        final AnalyzeSyntaxResponse analyzeSyntaxResponse = AnalyzeSyntaxResponse.newBuilder().build();
    ...
    void testTryAnalyzeSyntax3_LanguageServiceClientThrowsApiException() {
        ...
        // Run the test
        assertThrows(ApiException.class, () -> myClassUnderTest.tryAnalyzeSyntax3());
    }
    ...
    void testTryAnalyzeSyntaxCallable() {
        ...
        final UnaryCallable<AnalyzeSyntaxRequest, AnalyzeSyntaxResponse> analyzeSyntaxRequestAnalyzeSyntaxResponseUnaryCallable = new UnaryCallable<AnalyzeSyntaxRequest, AnalyzeSyntaxResponse>() {
            @Override
            public ApiFuture<AnalyzeSyntaxResponse> futureCall(final AnalyzeSyntaxRequest request, final ApiCallContext context) {
                final SettableApiFuture<AnalyzeSyntaxResponse> settableApiFuture = SettableApiFuture.create();
    ...
    @Test
    void testTryClassifyText1() throws Exception {
        // Setup
        // Configure LanguageServiceClient.classifyText(...).
        final ClassifyTextResponse classifyTextResponse = ClassifyTextResponse.newBuilder().build();
    ...
    void testTryClassifyText1_LanguageServiceClientThrowsApiException() {
        ...
        // Run the test
        assertThrows(ApiException.class, () -> myClassUnderTest.tryClassifyText1());
    }

    @Test
    void testTryClassifyText2() throws Exception {
        // Setup
        // Configure LanguageServiceClient.classifyText(...).
        final ClassifyTextResponse classifyTextResponse = ClassifyTextResponse.newBuilder().build();
    ...
    void testTryClassifyText2_LanguageServiceClientThrowsApiException() {
        ...
        // Run the test
        assertThrows(ApiException.class, () -> myClassUnderTest.tryClassifyText2());
    }
    ...
    void testTryClassifyTextCallable() {
        ...
        final UnaryCallable<ClassifyTextRequest, ClassifyTextResponse> classifyTextRequestClassifyTextResponseUnaryCallable = new UnaryCallable<ClassifyTextRequest, ClassifyTextResponse>() {
            @Override
            public ApiFuture<ClassifyTextResponse> futureCall(final ClassifyTextRequest request, final ApiCallContext context) {
                final SettableApiFuture<ClassifyTextResponse> settableApiFuture = SettableApiFuture.create();
    ...
    @Test
    void testTryAnnotateText1() throws Exception {
        // Setup
        // Configure LanguageServiceClient.annotateText(...).
        final AnnotateTextResponse annotateTextResponse = AnnotateTextResponse.newBuilder().build();
    ...
    void testTryAnnotateText1_LanguageServiceClientThrowsApiException() {
        ...
        // Run the test
        assertThrows(ApiException.class, () -> myClassUnderTest.tryAnnotateText1());
    }

    @Test
    void testTryAnnotateText2() throws Exception {
        // Setup
        // Configure LanguageServiceClient.annotateText(...).
        final AnnotateTextResponse annotateTextResponse = AnnotateTextResponse.newBuilder().build();
        when(mockLanguageServiceClient.annotateText(Document.newBuilder().build(),
    ...
    void testTryAnnotateText2_LanguageServiceClientThrowsApiException() {
        ...
        // Run the test
        assertThrows(ApiException.class, () -> myClassUnderTest.tryAnnotateText2());
    }

    @Test
    void testTryAnnotateText3() throws Exception {
        // Setup
        // Configure LanguageServiceClient.annotateText(...).
        final AnnotateTextResponse annotateTextResponse = AnnotateTextResponse.newBuilder().build();
    ...
    void testTryAnnotateText3_LanguageServiceClientThrowsApiException() {
        ...
        // Run the test
        assertThrows(ApiException.class, () -> myClassUnderTest.tryAnnotateText3());
    }
    ...
    void testTryAnnotateTextCallable() {
        ...
        final UnaryCallable<AnnotateTextRequest, AnnotateTextResponse> annotateTextRequestAnnotateTextResponseUnaryCallable = new UnaryCallable<AnnotateTextRequest, AnnotateTextResponse>() {
            @Override
            public ApiFuture<AnnotateTextResponse> futureCall(final AnnotateTextRequest request, final ApiCallContext context) {
                final SettableApiFuture<AnnotateTextResponse> settableApiFuture = SettableApiFuture.create();
    ...
    @Test
    void testTryAwaitTermination_LanguageServiceClientThrowsInterruptedException() throws Exception {
        // Setup
