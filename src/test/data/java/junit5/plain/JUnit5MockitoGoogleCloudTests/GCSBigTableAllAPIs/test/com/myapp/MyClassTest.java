...
class MyClassTest {
    ...
    void testTryExists1_BigtableDataClientThrowsApiException() {
        ...
        // Run the test
        assertThrows(ApiException.class, () -> myClassUnderTest.tryExists1());
    }
    ...
    void testTryExists2_BigtableDataClientThrowsApiException() {
        ...
        // Run the test
        assertThrows(ApiException.class, () -> myClassUnderTest.tryExists2());
    }
    ...
    void testTryReadRow1_BigtableDataClientThrowsApiException() {
        ...
        // Run the test
        assertThrows(ApiException.class, () -> myClassUnderTest.tryReadRow1());
    }
    ...
    void testTryReadRow2_BigtableDataClientThrowsApiException() {
        ...
        // Run the test
        assertThrows(ApiException.class, () -> myClassUnderTest.tryReadRow2());
    }
    ...
    void testTryReadRow3_BigtableDataClientThrowsApiException() {
        ...
        // Run the test
        assertThrows(ApiException.class, () -> myClassUnderTest.tryReadRow3());
    }
    ...
    void testTryReadRow4_BigtableDataClientThrowsApiException() {
        ...
        // Run the test
        assertThrows(ApiException.class, () -> myClassUnderTest.tryReadRow4());
    }
    ...
    void testTrySampleRowKeys_BigtableDataClientThrowsApiException() {
        ...
        // Run the test
        assertThrows(ApiException.class, () -> myClassUnderTest.trySampleRowKeys());
    }
    ...
    void testTryMutateRow_BigtableDataClientThrowsApiException() {
        ...
        // Run the test
        assertThrows(ApiException.class, () -> myClassUnderTest.tryMutateRow());
    }
    ...
    void testTryBulkMutateRows_BigtableDataClientThrowsApiException() {
        ...
        // Run the test
        assertThrows(ApiException.class, () -> myClassUnderTest.tryBulkMutateRows());
    }
    ...
    void testTryBulkMutateRows_BigtableDataClientThrowsMutateRowsException() {
        ...
        // Run the test
        assertThrows(MutateRowsException.class, () -> myClassUnderTest.tryBulkMutateRows());
    }
    ...
    void testTryCheckAndMutateRow_BigtableDataClientThrowsApiException() {
        ...
        // Run the test
        assertThrows(ApiException.class, () -> myClassUnderTest.tryCheckAndMutateRow());
    }
    ...
    void testTryReadModifyWriteRow_BigtableDataClientThrowsApiException() {
        ...
        // Run the test
        assertThrows(ApiException.class, () -> myClassUnderTest.tryReadModifyWriteRow());
    }
