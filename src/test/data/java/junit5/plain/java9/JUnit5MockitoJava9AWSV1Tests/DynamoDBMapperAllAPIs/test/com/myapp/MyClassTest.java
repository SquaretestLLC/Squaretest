...
class MyClassTest {
    ...
    void testTryMarshallIntoObject() {
        ...
        storedOrder.setNumberOfUsers(0);
        storedOrder.setDeliveryEmailAddress("deliveryEmailAddress");
        when(mockDynamoDBMapper.marshallIntoObject(eq(StoredOrder.class),
                eq(Map.ofEntries(Map.entry("value", new AttributeValue("s")))),
                any(DynamoDBMapperConfig.class))).thenReturn(storedOrder);
    ...
    void testTryMarshallIntoObjects() {
        ...
        storedOrder.setNumberOfUsers(0);
        storedOrder.setDeliveryEmailAddress("deliveryEmailAddress");
        final List<StoredOrder> storedOrders = List.of(storedOrder);
        when(mockDynamoDBMapper.marshallIntoObjects(eq(StoredOrder.class),
                eq(List.of(Map.ofEntries(Map.entry("value", new AttributeValue("s"))))),
    ...
    void testTryTransactionLoad() {
        ...
        when(mockDynamoDBMapper.transactionLoad(any(TransactionLoadRequest.class),
                any(DynamoDBMapperConfig.class))).thenReturn(List.of("value"));
    ...
    void testTryBatchWrite_DynamoDBMapperReturnsFailure() {
        ...
        final List<DynamoDBMapper.FailedBatch> failedBatches = List.of(failedBatch);
        when(mockDynamoDBMapper.batchWrite(any(Iterable.class), any(Iterable.class),
    ...
    void testTryBatchLoad() {
        // Setup
        // Configure DynamoDBMapper.batchLoad(...).
        final Map<String, List<Object>> stringListMap = Map.ofEntries(Map.entry("value", List.of("value")));
    ...
    void testTryBatchLoad1() {
        ...
        // Configure DynamoDBMapper.batchLoad(...).
        final Map<String, List<Object>> stringListMap = Map.ofEntries(Map.entry("value", List.of("value")));
        when(mockDynamoDBMapper.batchLoad(eq(Map.ofEntries(Map.entry(String.class, List.of(new KeyPair()
                .withHashKey("hashKey")
                .withRangeKey("rangeKey"))))), any(DynamoDBMapperConfig.class))).thenReturn(stringListMap);
    ...
    void testTryBatchLoad1_DynamoDBMapperThrowsAmazonDynamoDBException() {
        ...
        when(mockDynamoDBMapper.batchLoad(eq(Map.ofEntries(Map.entry(String.class, List.of(new KeyPair()
                .withHashKey("hashKey")
                .withRangeKey("rangeKey"))))), any(DynamoDBMapperConfig.class)))
                .thenThrow(AmazonDynamoDBException.class);
    ...
    void testTryScanPage() {
        ...
        storedOrderScanResultPage.setResults(List.of());
    ...
    void testTryQueryPage() {
        ...
        storedOrderQueryResultPage.setResults(List.of());
