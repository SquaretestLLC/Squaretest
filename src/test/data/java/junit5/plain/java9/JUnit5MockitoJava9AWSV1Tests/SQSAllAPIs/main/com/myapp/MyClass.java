...
public class MyClass {
    ...
    public void tryAddPermission() {
        final AddPermissionRequest request = new AddPermissionRequest("queueUrl", "label", List.of(), List.of());
    ...
    public void tryChangeMessageVisibilityBatch() {
        final ChangeMessageVisibilityBatchRequest request = new ChangeMessageVisibilityBatchRequest("queueUrl", List.of());
    ...
    public void tryChangeMessageVisibilityBatch1() {
        final List<ChangeMessageVisibilityBatchRequestEntry> entries = List.of();
    ...
    public void tryDeleteMessageBatch() {
        final DeleteMessageBatchRequest request = new DeleteMessageBatchRequest("queueUrl", List.of());
        final DeleteMessageBatchResult result = amazonSQSClient.deleteMessageBatch(request);
    }

    public void tryDeleteMessageBatch1() {
        final List<DeleteMessageBatchRequestEntry> entries = List.of();
    ...
    public void tryGetQueueAttributes() {
        final GetQueueAttributesRequest request = new GetQueueAttributesRequest("queueUrl", List.of());
        final GetQueueAttributesResult result = amazonSQSClient.getQueueAttributes(request);
    }

    public void tryGetQueueAttributes1() {
        final List<String> attributeNames = List.of();
    ...
    public void trySendMessageBatch() {
        final SendMessageBatchRequest request = new SendMessageBatchRequest("queueUrl", List.of());
        final SendMessageBatchResult result = amazonSQSClient.sendMessageBatch(request);
    }

    public void trySendMessageBatch1() {
        final List<SendMessageBatchRequestEntry> entries = List.of();
    ...
    public void tryUntagQueue() {
        final UntagQueueRequest request = new UntagQueueRequest("queueUrl", List.of());
        final UntagQueueResult result = amazonSQSClient.untagQueue(request);
    }

    public void tryUntagQueue1() {
        final List<String> tagKeys = List.of();
