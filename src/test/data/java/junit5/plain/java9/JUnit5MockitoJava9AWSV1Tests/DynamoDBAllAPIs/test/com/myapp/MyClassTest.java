...
class MyClassTest {
    ...
    void testTryBatchGetItem() {
        ...
        final BatchGetItemResult batchGetItemResult = new BatchGetItemResult().withResponses(
                Map.of("TableName1", List.of(
                                Map.ofEntries(
                                        Map.entry("PrimaryKey1", new AttributeValue().withS("PrimaryKeyValue1")),
                                        Map.entry("KeyName2", new AttributeValue().withS("Value2"))
                                )),
                        "TableName2", List.of(
                                Map.ofEntries(
                                        Map.entry("PrimaryKey2", new AttributeValue().withS("PrimaryKeyValue2")),
                                        Map.entry("KeyName2", new AttributeValue().withS("Value2"))
                                )
                        )
                )
        );
        when(mockAmazonDynamoDBClient.batchGetItem(new BatchGetItemRequest().withRequestItems(Map.of(
                "TableName1", new KeysAndAttributes().withKeys(
                        Map.of("PrimaryKey", new AttributeValue().withS("PrimaryKeyValue1"))),
    ...
    void testTryBatchGetItem1() {
        ...
        when(mockAmazonDynamoDBClient.batchGetItem(Map.ofEntries(Map.entry("value", new KeysAndAttributes().withKeys(
                        Map.of("PrimaryKey", new AttributeValue().withS("PrimaryKeyValue1"))))),
                "returnConsumedCapacity")).thenReturn(batchGetItemResult);
    ...
    void testTryBatchGetItem1_AmazonDynamoDBClientReturnsNoItems() {
        ...
        when(mockAmazonDynamoDBClient.batchGetItem(Map.ofEntries(Map.entry("value", new KeysAndAttributes().withKeys(
                        Map.of("PrimaryKey", new AttributeValue().withS("PrimaryKeyValue1"))))),
                "returnConsumedCapacity")).thenReturn(new BatchGetItemResult());
    ...
    void testTryBatchGetItem1_AmazonDynamoDBClientThrowsProvisionedThroughputExceededException() {
        ...
        when(mockAmazonDynamoDBClient.batchGetItem(Map.ofEntries(Map.entry("value", new KeysAndAttributes().withKeys(
                        Map.of("PrimaryKey", new AttributeValue().withS("PrimaryKeyValue1"))))),
                "returnConsumedCapacity")).thenThrow(ProvisionedThroughputExceededException.class);
    ...
    void testTryBatchGetItem1_AmazonDynamoDBClientThrowsResourceNotFoundException() {
        ...
        when(mockAmazonDynamoDBClient.batchGetItem(Map.ofEntries(Map.entry("value", new KeysAndAttributes().withKeys(
                        Map.of("PrimaryKey", new AttributeValue().withS("PrimaryKeyValue1"))))),
                "returnConsumedCapacity")).thenThrow(ResourceNotFoundException.class);
    ...
    void testTryBatchGetItem1_AmazonDynamoDBClientThrowsRequestLimitExceededException() {
        ...
        when(mockAmazonDynamoDBClient.batchGetItem(Map.ofEntries(Map.entry("value", new KeysAndAttributes().withKeys(
                        Map.of("PrimaryKey", new AttributeValue().withS("PrimaryKeyValue1"))))),
                "returnConsumedCapacity")).thenThrow(RequestLimitExceededException.class);
    ...
    void testTryBatchGetItem1_AmazonDynamoDBClientThrowsInternalServerErrorException() {
        ...
        when(mockAmazonDynamoDBClient.batchGetItem(Map.ofEntries(Map.entry("value", new KeysAndAttributes().withKeys(
                        Map.of("PrimaryKey", new AttributeValue().withS("PrimaryKeyValue1"))))),
                "returnConsumedCapacity")).thenThrow(InternalServerErrorException.class);
    ...
    void testTryBatchWriteItem() {
        // Setup
        when(mockAmazonDynamoDBClient.batchWriteItem(new BatchWriteItemRequest(Map.of("TableName", List.of(
    ...
    void testTryBatchWriteItem1() {
        // Setup
        when(mockAmazonDynamoDBClient.batchWriteItem(Map.ofEntries(
                Map.entry("value", List.of(new WriteRequest().withPutRequest(new PutRequest().withItem(Map.ofEntries(
                        Map.entry("PrimaryKeyName", new AttributeValue().withS("PrimaryKeyValue")))
                ))))))).thenReturn(new BatchWriteItemResult());
    ...
    void testTryCreateGlobalTable() {
        ...
        request.setReplicationGroup(List.of(replica));
    ...
    void testTryCreateTable() {
        ...
        when(mockAmazonDynamoDBClient.createTable(new CreateTableRequest("tableName",
                List.of(new KeySchemaElement("attributeName", "keyType"))))).thenReturn(createTableResult);
    ...
    void testTryCreateTable_AmazonDynamoDBClientThrowsResourceInUseException() {
        // Setup
        when(mockAmazonDynamoDBClient.createTable(new CreateTableRequest("tableName",
                List.of(new KeySchemaElement("attributeName", "keyType"))))).thenThrow(ResourceInUseException.class);
    ...
    void testTryCreateTable_AmazonDynamoDBClientThrowsLimitExceededException() {
        // Setup
        when(mockAmazonDynamoDBClient.createTable(new CreateTableRequest("tableName",
                List.of(new KeySchemaElement("attributeName", "keyType"))))).thenThrow(LimitExceededException.class);
    ...
    void testTryCreateTable_AmazonDynamoDBClientThrowsInternalServerErrorException() {
        // Setup
        when(mockAmazonDynamoDBClient.createTable(new CreateTableRequest("tableName",
                List.of(new KeySchemaElement("attributeName", "keyType")))))
                .thenThrow(InternalServerErrorException.class);
    ...
    void testTryCreateTable1() {
        ...
        // Configure AmazonDynamoDBClient.createTable(...).
        final CreateTableResult createTableResult = new CreateTableResult();
        when(mockAmazonDynamoDBClient.createTable(List.of(new AttributeDefinition("attributeName", "attributeType")),
                "tableName", List.of(new KeySchemaElement("attributeName", "keyType")),
    ...
    void testTryDeleteItem1() {
        ...
        // Configure AmazonDynamoDBClient.deleteItem(...).
        final DeleteItemResult deleteItemResult = new DeleteItemResult();
        when(mockAmazonDynamoDBClient.deleteItem("tableName",
                Map.ofEntries(Map.entry("value", new AttributeValue("s"))))).thenReturn(deleteItemResult);
    ...
    void testTryDeleteItem1_AmazonDynamoDBClientThrowsProvisionedThroughputExceededException() {
        // Setup
        when(mockAmazonDynamoDBClient.deleteItem("tableName",
                Map.ofEntries(Map.entry("value", new AttributeValue("s")))))
                .thenThrow(ProvisionedThroughputExceededException.class);
    ...
    void testTryDeleteItem1_AmazonDynamoDBClientThrowsResourceNotFoundException() {
        // Setup
        when(mockAmazonDynamoDBClient.deleteItem("tableName",
                Map.ofEntries(Map.entry("value", new AttributeValue("s"))))).thenThrow(ResourceNotFoundException.class);
    ...
    void testTryDeleteItem2() {
        ...
        final DeleteItemResult deleteItemResult = new DeleteItemResult();
        when(mockAmazonDynamoDBClient.deleteItem("tableName",
                Map.ofEntries(Map.entry("value", new AttributeValue("s"))), "returnValues"))
    ...
    void testTryGetItem1() {
        ...
        when(mockAmazonDynamoDBClient.getItem("tableName",
                Map.ofEntries(Map.entry("value", new AttributeValue("s"))))).thenReturn(getItemResult);
    ...
    void testTryGetItem1_AmazonDynamoDBClientReturnsNoItem() {
        // Setup
        when(mockAmazonDynamoDBClient.getItem("tableName",
                Map.ofEntries(Map.entry("value", new AttributeValue("s"))))).thenReturn(new GetItemResult());
    ...
    void testTryGetItem2() {
        ...
        when(mockAmazonDynamoDBClient.getItem("tableName", Map.ofEntries(Map.entry("value", new AttributeValue("s"))),
                false)).thenReturn(getItemResult);
    ...
    void testTryGetItem2_AmazonDynamoDBClientReturnsNoItem() {
        // Setup
        when(mockAmazonDynamoDBClient.getItem("tableName", Map.ofEntries(Map.entry("value", new AttributeValue("s"))),
                false)).thenReturn(new GetItemResult());
    ...
    void testTryGetItem2_AmazonDynamoDBClientThrowsProvisionedThroughputExceededException() {
        // Setup
        when(mockAmazonDynamoDBClient.getItem("tableName", Map.ofEntries(Map.entry("value", new AttributeValue("s"))),
                false)).thenThrow(ProvisionedThroughputExceededException.class);
    ...
    void testTryGetItem2_AmazonDynamoDBClientThrowsResourceNotFoundException() {
        // Setup
        when(mockAmazonDynamoDBClient.getItem("tableName", Map.ofEntries(Map.entry("value", new AttributeValue("s"))),
                false)).thenThrow(ResourceNotFoundException.class);
    ...
    void testTryGetItem2_AmazonDynamoDBClientThrowsRequestLimitExceededException() {
        // Setup
        when(mockAmazonDynamoDBClient.getItem("tableName", Map.ofEntries(Map.entry("value", new AttributeValue("s"))),
                false)).thenThrow(RequestLimitExceededException.class);
    ...
    void testTryGetItem2_AmazonDynamoDBClientThrowsInternalServerErrorException() {
        // Setup
        when(mockAmazonDynamoDBClient.getItem("tableName", Map.ofEntries(Map.entry("value", new AttributeValue("s"))),
                false)).thenThrow(InternalServerErrorException.class);
    ...
    void testTryPutItem() {
        ...
        when(mockAmazonDynamoDBClient.putItem(new PutItemRequest("TableName", Map.ofEntries(
                Map.entry("PrimaryKeyName", new AttributeValue().withS("PrimaryKeyValue")),
                Map.entry("KeyName2", new AttributeValue().withS("Value2"))
    ...
    void testTryPutItem1() {
        ...
        // Configure AmazonDynamoDBClient.putItem(...).
        final PutItemResult putItemResult = new PutItemResult();
        when(mockAmazonDynamoDBClient.putItem("tableName",
                Map.ofEntries(Map.entry("value", new AttributeValue("s"))))).thenReturn(putItemResult);
    ...
    void testTryPutItem2() {
        ...
        // Configure AmazonDynamoDBClient.putItem(...).
        final PutItemResult putItemResult = new PutItemResult();
        when(mockAmazonDynamoDBClient.putItem("tableName", Map.ofEntries(Map.entry("value", new AttributeValue("s"))),
    ...
    void testTryScan1() {
        ...
        when(mockAmazonDynamoDBClient.scan("tableName", List.of("value"))).thenReturn(scanResult);
    ...
    void testTryScan1_AmazonDynamoDBClientReturnsNoItems() {
        // Setup
        when(mockAmazonDynamoDBClient.scan("tableName", List.of("value"))).thenReturn(new ScanResult());
    ...
    void testTryScan1_AmazonDynamoDBClientThrowsProvisionedThroughputExceededException() {
        // Setup
        when(mockAmazonDynamoDBClient.scan("tableName", List.of("value")))
                .thenThrow(ProvisionedThroughputExceededException.class);
    ...
    void testTryScan1_AmazonDynamoDBClientThrowsResourceNotFoundException() {
        // Setup
        when(mockAmazonDynamoDBClient.scan("tableName", List.of("value"))).thenThrow(ResourceNotFoundException.class);
    ...
    void testTryScan2() {
        ...
        final Map<String, Condition> scanFilter = Map.ofEntries(Map.entry("value", condition));
    ...
    void testTryScan3() {
        ...
        final Condition condition = new Condition();
        final Map<String, Condition> scanFilter = Map.ofEntries(Map.entry("value", condition));
        when(mockAmazonDynamoDBClient.scan("tableName", List.of("value"), scanFilter)).thenReturn(scanResult);
    ...
    void testTryScan3_AmazonDynamoDBClientReturnsNoItems() {
        ...
        final Condition condition = new Condition();
        final Map<String, Condition> scanFilter = Map.ofEntries(Map.entry("value", condition));
        when(mockAmazonDynamoDBClient.scan("tableName", List.of("value"), scanFilter)).thenReturn(new ScanResult());
    ...
    void testTryScan3_AmazonDynamoDBClientThrowsProvisionedThroughputExceededException() {
        ...
        final Condition condition = new Condition();
        final Map<String, Condition> scanFilter = Map.ofEntries(Map.entry("value", condition));
        when(mockAmazonDynamoDBClient.scan("tableName", List.of("value"), scanFilter))
                .thenThrow(ProvisionedThroughputExceededException.class);
    ...
    void testTryTransactGetItems() {
        ...
        itemResponse.setItem(Map.ofEntries(Map.entry("value", new AttributeValue("s"))));
        transactGetItemsResult.setResponses(List.of(itemResponse));
        when(mockAmazonDynamoDBClient.transactGetItems(new TransactGetItemsRequest().withTransactItems(
                new TransactGetItem().withGet(new Get()
                        ...
                        .withKey(Map.of("PrimaryKeyName", new AttributeValue().withS("PrimaryKeyValue")))
                ),
                new TransactGetItem().withGet(new Get()
                        .withTableName("TableName2")
                        .withKey(Map.of("PrimaryKeyName2", new AttributeValue().withS("PrimaryKeyValue2")))
                )
    ...
    void testTryTransactWriteItems() {
        ...
        when(mockAmazonDynamoDBClient.transactWriteItems(new TransactWriteItemsRequest().withTransactItems(
                new TransactWriteItem().withPut(new Put()
                        .withTableName("TableName")
                        .withItem(Map.of("PrimaryKeyName", new AttributeValue().withS("PrimaryKeyValue")))
    ...
    void testTryUpdateGlobalTable() {
        ...
        request.setReplicaUpdates(List.of(replicaUpdate));
    ...
    void testTryUpdateGlobalTableSettings() {
        ...
        request.setGlobalTableGlobalSecondaryIndexSettingsUpdate(
                List.of(globalTableGlobalSecondaryIndexSettingsUpdate));
        final ReplicaSettingsUpdate replicaSettingsUpdate = new ReplicaSettingsUpdate();
        request.setReplicaSettingsUpdate(List.of(replicaSettingsUpdate));
    ...
    void testTryUpdateItem() {
        ...
        updateItemResult.setAttributes(Map.ofEntries(Map.entry("value", new AttributeValue("s"))));
        when(mockAmazonDynamoDBClient.updateItem(
                new UpdateItemRequest("tableName", Map.ofEntries(Map.entry("value", new AttributeValue("s"))),
                        Map.ofEntries(Map.entry("value", new AttributeValueUpdate())), "returnValues")))
    ...
    void testTryUpdateItem1() {
        ...
        final UpdateItemResult updateItemResult = new UpdateItemResult();
        updateItemResult.setAttributes(Map.ofEntries(Map.entry("value", new AttributeValue("s"))));
        when(mockAmazonDynamoDBClient.updateItem("tableName",
                Map.ofEntries(Map.entry("value", new AttributeValue("s"))),
                Map.ofEntries(Map.entry("value", new AttributeValueUpdate())))).thenReturn(updateItemResult);
    ...
    void testTryUpdateItem1_AmazonDynamoDBClientThrowsConditionalCheckFailedException() {
        ...
        when(mockAmazonDynamoDBClient.updateItem("tableName",
                Map.ofEntries(Map.entry("value", new AttributeValue("s"))),
                Map.ofEntries(Map.entry("value", new AttributeValueUpdate()))))
                .thenThrow(ConditionalCheckFailedException.class);
    ...
    void testTryGetCachedResponseMetadata() {
        // Setup
        // Configure AmazonDynamoDBClient.getCachedResponseMetadata(...).
