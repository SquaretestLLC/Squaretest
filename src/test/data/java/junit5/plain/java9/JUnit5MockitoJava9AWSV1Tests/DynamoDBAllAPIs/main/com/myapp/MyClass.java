...
public class MyClass {
    ...
    public void tryScan1() {
        final List<String> attributesToGet = List.of();
    ...
    public void tryTransactGetItems() {
        ...
        request.setTransactItems(List.of());
    ...
    public void tryUpdateGlobalTable() {
        ...
        request.setGlobalTableName("globalTableName");
        request.setReplicaUpdates(List.of());
    ...
    public void tryUpdateGlobalTableSettings() {
        ...
        request.setGlobalTableGlobalSecondaryIndexSettingsUpdate(List.of());
        request.setReplicaSettingsUpdate(List.of());
