...
public class MyClass {
    ...
    public void tryListNextBatchOfVersions() {
        ...
        previousVersionListing.setVersionSummaries(List.of());
        previousVersionListing.setCommonPrefixes(List.of());
    ...
    public void trySetBucketLifecycleConfiguration() {
        final BucketLifecycleConfiguration bucketLifecycleConfiguration = new BucketLifecycleConfiguration(List.of());
    ...
    public void trySetBucketCrossOriginConfiguration() {
        final BucketCrossOriginConfiguration bucketCrossOriginConfiguration = new BucketCrossOriginConfiguration(List.of());
    ...
    public void trySetBucketTaggingConfiguration() {
        final BucketTaggingConfiguration bucketTaggingConfiguration = new BucketTaggingConfiguration(List.of());
    ...
    public void tryCompleteMultipartUpload() {
        final CompleteMultipartUploadRequest completeMultipartUploadRequest = new CompleteMultipartUploadRequest("bucketName", "key", "uploadId", List.of());
