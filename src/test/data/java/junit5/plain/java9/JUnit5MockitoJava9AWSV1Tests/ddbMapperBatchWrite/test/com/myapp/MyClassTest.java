...
class MyClassTest {
    ...
    void testPutOrders1() {
        ...
        final List<Order> objectsToWrite = List.of(order1);
        when(mockDynamoDBMapper.batchWrite(objectsToWrite, List.of("value"))).thenReturn(Collections.emptyList());
    ...
    void testPutOrders1_DynamoDBMapperReturnsFailure() {
        ...
        order1.setProducts(List.of(product1));
        final List<Order> objectsToWrite = List.of(order1);
        when(mockDynamoDBMapper.batchWrite(objectsToWrite, List.of("value"))).thenReturn(failedBatches);
    ...
    void testPutOrders1_DynamoDBMapperThrowsAmazonDynamoDBException() {
        ...
        order1.setProducts(List.of(product1));
        final List<Order> objectsToWrite = List.of(order1);
        when(mockDynamoDBMapper.batchWrite(objectsToWrite, List.of("value"))).thenThrow(AmazonDynamoDBException.class);
    ...
    void testPutOrders2() {
        ...
        product1.setId("id");
        order1.setProducts(List.of(product1));
        final List<Order> objectsToSave = List.of(order1);
    ...
    void testPutOrders3() {
        ...
        final Product product1 = new Product();
        product1.setId("id");
        objectsToSave.setProducts(List.of(product1));
        when(mockDynamoDBMapper.batchSave(objectsToSave)).thenReturn(Collections.emptyList());
    ...
    void testPutOrders4() {
        ...
        final Product product = new Product();
        product.setId("id");
        orders.setProducts(List.of(product));
