...
class MyClassTest {
    ...
    void testTryAddPermission() {
        // Setup
        when(mockAmazonSQSClient.addPermission(
                new AddPermissionRequest("queueUrl", "label", List.of("value"), List.of("value"))))
    ...
    void testTryAddPermission1() {
        // Setup
        when(mockAmazonSQSClient.addPermission("queueUrl", "label", List.of("value"), List.of("value")))
                .thenReturn(new AddPermissionResult());
    ...
    void testTryChangeMessageVisibilityBatch() {
        ...
        when(mockAmazonSQSClient.changeMessageVisibilityBatch(new ChangeMessageVisibilityBatchRequest("queueUrl",
                List.of(new ChangeMessageVisibilityBatchRequestEntry("id", "receiptHandle")))))
    ...
    void testTryDeleteMessageBatch() {
        ...
        when(mockAmazonSQSClient.deleteMessageBatch(new DeleteMessageBatchRequest("queueUrl",
                List.of(new DeleteMessageBatchRequestEntry("id", "receiptHandle")))))
    ...
    void testTryGetQueueAttributes() {
        ...
        when(mockAmazonSQSClient.getQueueAttributes(
                new GetQueueAttributesRequest("queueUrl", List.of("value")))).thenReturn(getQueueAttributesResult);
    ...
    void testTryGetQueueAttributes_AmazonSQSClientThrowsInvalidAttributeNameException() {
        // Setup
        when(mockAmazonSQSClient.getQueueAttributes(
                new GetQueueAttributesRequest("queueUrl", List.of("value"))))
    ...
    void testTryGetQueueAttributes1() {
        ...
        // Configure AmazonSQSClient.getQueueAttributes(...).
        final GetQueueAttributesResult getQueueAttributesResult = new GetQueueAttributesResult();
        when(mockAmazonSQSClient.getQueueAttributes("queueUrl", List.of("value"))).thenReturn(getQueueAttributesResult);
    ...
    void testTrySendMessageBatch() {
        ...
        when(mockAmazonSQSClient.sendMessageBatch(new SendMessageBatchRequest("queueUrl",
                List.of(new SendMessageBatchRequestEntry("id", "messageBody"))))).thenReturn(sendMessageBatchResult);
    ...
    void testTrySendMessageBatch_AmazonSQSClientThrowsTooManyEntriesInBatchRequestException() {
        // Setup
        when(mockAmazonSQSClient.sendMessageBatch(new SendMessageBatchRequest("queueUrl",
                List.of(new SendMessageBatchRequestEntry("id", "messageBody")))))
                .thenThrow(TooManyEntriesInBatchRequestException.class);
    ...
    void testTrySetQueueAttributes() {
        ...
        when(mockAmazonSQSClient.setQueueAttributes(
                new SetQueueAttributesRequest("queueUrl", Map.ofEntries(Map.entry("value", "value")))))
    ...
    void testTrySetQueueAttributes1() {
        // Setup
        when(mockAmazonSQSClient.setQueueAttributes("queueUrl", Map.ofEntries(Map.entry("value", "value"))))
                .thenReturn(new SetQueueAttributesResult());
    ...
    void testTryTagQueue() {
        // Setup
        when(mockAmazonSQSClient.tagQueue(
                new TagQueueRequest("queueUrl", Map.ofEntries(Map.entry("value", "value")))))
    ...
    void testTryTagQueue1() {
        // Setup
        when(mockAmazonSQSClient.tagQueue("queueUrl", Map.ofEntries(Map.entry("value", "value"))))
                .thenReturn(new TagQueueResult());
    ...
    void testTryUntagQueue() {
        // Setup
        when(mockAmazonSQSClient.untagQueue(new UntagQueueRequest("queueUrl", List.of("value"))))
    ...
    void testTryUntagQueue1() {
        // Setup
        when(mockAmazonSQSClient.untagQueue("queueUrl", List.of("value"))).thenReturn(new UntagQueueResult());
    ...
    void testTryGetCachedResponseMetadata() {
        // Setup
        // Configure AmazonSQSClient.getCachedResponseMetadata(...).
