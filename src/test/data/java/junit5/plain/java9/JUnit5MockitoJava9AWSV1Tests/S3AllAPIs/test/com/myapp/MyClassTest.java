...
class MyClassTest {
    ...
    void testTryListNextBatchOfVersions() {
        ...
        versionListing.setVersionSummaries(List.of(s3VersionSummary));
        versionListing.setCommonPrefixes(List.of("value"));
    ...
    void testTryListObjectsV2() {
        ...
        s3ObjectSummary.setBucketName("bucketName");
        s3ObjectSummary.setKey("key");
        listObjectsV2Result.getObjectSummaries().addAll(List.of(s3ObjectSummary));
    ...
    void testTryListBuckets() {
        // Setup
        when(mockAmazonS3Client.listBuckets(any(ListBucketsRequest.class))).thenReturn(List.of(new Bucket("name")));
    ...
    void testTryListBuckets1() {
        // Setup
        when(mockAmazonS3Client.listBuckets()).thenReturn(List.of(new Bucket("name")));
    ...
    void testTryDeleteObjects() {
        ...
        final DeleteObjectsResult deleteObjectsResult = new DeleteObjectsResult(List.of(deletedObject), false);
    ...
    void testTryGetBucketTaggingConfiguration() {
        ...
        final BucketTaggingConfiguration bucketTaggingConfiguration = new BucketTaggingConfiguration(
                List.of(new TagSet(Map.ofEntries(Map.entry("value", "value")))));
    ...
    void testTryGetCachedResponseMetadata() {
        ...
        final S3ResponseMetadata s3ResponseMetadata = new S3ResponseMetadata(
    ...
    void testTryListBucketAnalyticsConfigurations() {
        ...
        listBucketAnalyticsConfigurationsResult.setAnalyticsConfigurationList(List.of(analyticsConfiguration));
    ...
    void testTryListBucketInventoryConfigurations() {
        ...
        listBucketInventoryConfigurationsResult.setInventoryConfigurationList(List.of(inventoryConfiguration));
