...
class MyClassTest {
    ...
    void testGetBigData2() {
        // Setup
        when(mockFooService.getBigData2("id")).thenReturn(List.of());
    ...
    void testGetBigData4() {
        // Setup
        when(mockFooService.getBigData4("id")).thenReturn(Optional.of(List.of()));
    ...
    void testGetBigData6() {
        ...
        final List<BigDataOtherOption> bigDataOtherOptions = List.of(BigDataOtherOption.builder().build());
    ...
    void testGetBigData8() {
        ...
        final Optional<List<BigDataOtherOption>> bigDataOtherOptions = Optional.of(
                List.of(BigDataOtherOption.builder().build()));
    ...
    void testGetBigData9_FooServiceReturnsFailure() {
        // Setup
        when(mockFooService.getBigData9("id")).thenReturn(CompletableFuture.failedFuture(new Exception("message")));
    ...
    void testGetBigData10_FooServiceReturnsFailure() {
        // Setup
        // Configure FooService.getBigData10(...).
        final CompletableFuture<List<BigDataNoOptions>> listCompletableFuture = CompletableFuture.failedFuture(
