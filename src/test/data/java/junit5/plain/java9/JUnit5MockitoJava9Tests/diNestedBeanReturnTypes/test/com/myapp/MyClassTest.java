...
class MyClassTest {
    ...
    void testCreateNonBeanFoos() {
        ...
        final Optional<List<Foo<FooData>>> foos = Optional.of(
                List.of(new Foo<>(new FooData("purchaseId", "licenseName", new OtherData("dataName")))));
    ...
    void testCreateNonBeanFooWithEquals() {
        // Setup
        final Optional<List<FooWithEquals<FooDataWithEquals>>> expectedResult = Optional.of(List.of(new FooWithEquals<>(
                new FooDataWithEquals("purchaseId", "licenseName", new OtherData("dataName")))));

        // Configure FooCreator.createNonBeanFooWithEquals(...).
        final Optional<List<FooWithEquals<FooDataWithEquals>>> fooWithEquals = Optional.of(List.of(new FooWithEquals<>(
                new FooDataWithEquals("purchaseId", "licenseName", new OtherData("dataName")))));
    ...
    void testCreateBeanFoos() {
        ...
        final Optional<List<Foo<Bean>>> foos = Optional.of(List.of(new Foo<>(bean)));
    ...
    void testCreateBeanFooWithEquals() {
        ...
        final Optional<List<FooWithEquals<BeanWithEquals>>> expectedResult = Optional.of(
                List.of(new FooWithEquals<>(beanWithEquals)));
        ...
        final Optional<List<FooWithEquals<BeanWithEquals>>> fooWithEquals = Optional.of(
                List.of(new FooWithEquals<>(beanWithEquals1)));
    ...
    void testCreateBeanFooWithoutEquals() {
        ...
        bean.setFooData(fooData);
        bean.setTheString("theString");
        final Optional<List<FooWithEquals<Bean>>> fooWithEquals = Optional.of(List.of(new FooWithEquals<>(bean)));
    ...
    void testCreateBeanInsideNestedLists() {
        ...
        bean.setFooData(fooData);
        bean.setTheString("theString");
        final List<List<Bean>> lists = List.of(List.of(bean));
    ...
    void testCreateBeanWithEqualsInsideNestedLists1() {
        ...
        beanWithEquals.setFooData(fooData);
        beanWithEquals.setTheString("theString");
        final List<List<BeanWithEquals>> expectedResult = List.of(List.of(beanWithEquals));
    ...
    void testGetNestedTypesThatOverrideEquals() {
        ...
        beanWithEquals.setFooData(fooData);
        beanWithEquals.setTheString("theString");
        final Map<String, Map<String, FooWithEquals<BeanWithEquals>>> expectedResult = Map.ofEntries(
                Map.entry("value", Map.ofEntries(Map.entry("value", new FooWithEquals<>(beanWithEquals)))));
