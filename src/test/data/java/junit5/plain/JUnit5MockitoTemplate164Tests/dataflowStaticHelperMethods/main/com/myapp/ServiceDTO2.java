...
import com.myapp.dataflowConstructorAndBeans.ServiceDTO2Helpers;
...
public class ServiceDTO2 {
    ...
    public static ServiceDTO2 fromResponse(final ServiceResponse2 serviceResponse2) {
        final List<ServiceDTO2.ServiceDTO2Part> parts = ServiceDTO2Helpers.createDtoPartList2(serviceResponse2.getServiceResponse2Parts());
        final ServiceDTO2 ret = new ServiceDTO2();
        ret.setServiceDTO2CreatedDate(serviceResponse2.getServiceResponse2CreatedDate());
        ret.setServiceDTO2Id(serviceResponse2.getServiceResponse2Id());
        ret.setServiceDTO2LongValue(serviceResponse2.getServiceResponse2LongValue());
        ret.setServiceDTO2Name(serviceResponse2.getServiceResponse2Name());
