...
class MyClassTest {
    ...
    void testConvertBean() {
        ...
        theBean.setId(0);
        theBean.setFooData(new FooData("purchaseId", "licenseName", new OtherData("dataName")));
        theBean.setTheString("theString");
        theBean.setTheInt(0);
        theBean.setValue(false);
        theBean.setOtherValue(false);

        // Configure BeanFixer.convertBean(...).
        final OtherBean otherBean = new OtherBean();
        otherBean.setOurData(new FooData("purchaseId", "licenseName", new OtherData("dataName")));
        otherBean.setOurStr("ourStr");
        otherBean.setOurInt(0);
        otherBean.setOurValue(false);
        otherBean.setOurOtherValue(false);
    ...
    void testStoreBeanWithSameFieldName() {
        ...
        beanWithSameMethodFieldNames.fooData(new FooData("purchaseId", "licenseName", new OtherData("dataName")));
        beanWithSameMethodFieldNames.theString("theString");
        beanWithSameMethodFieldNames.theInt(0);
        beanWithSameMethodFieldNames.value(false);
        beanWithSameMethodFieldNames.otherValue(false);
    ...
    void testStoreBeanWithObjectMethods() {
        ...
        beanWithObjectMethods.setOurData(new FooData("purchaseId", "licenseName", new OtherData("dataName")));
        beanWithObjectMethods.setOurStr("ourStr");
        beanWithObjectMethods.setOurInt(0);
        beanWithObjectMethods.setOurValue(false);
        beanWithObjectMethods.setOurOtherValue(false);
    ...
    void testStoreBeanWithAltBooleans() {
        ...
        beanWithAltBooleans.setFoxtrot(false);
        beanWithAltBooleans.setIsGolf(false);
        beanWithAltBooleans.setIsHotel(false);
