...
class MyClassTest {
    ...
    void testGetFooData() {
        ...
        final InnerBeanSubDTO innerBeanSubDTO = new InnerBeanSubDTO();
        innerBeanSubDTO.setId(0L);
        innerBeanSubDTO.setCreateDate(new GregorianCalendar(2020, Calendar.JANUARY, 1).getTime());
        innerBeanSubDTO.setName("name");
        innerBeanSubDTO.setValue1("value1");
        innerBeanSubDTO.setValue2("value2");
        innerBeanSubDTO.setValue3("value3");
        innerBeanSubDTO.setValue4("value4");
        innerBeanSubDTO.setValue5("value5");
        innerBeanSubDTO.setValue6("value6");
        innerBeanSubDTO.setValue7("value7");
        expectedResult.setInnerBeanSubDTO(innerBeanSubDTO);
