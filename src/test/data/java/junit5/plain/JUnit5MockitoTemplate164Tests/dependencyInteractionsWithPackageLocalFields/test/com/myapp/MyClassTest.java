...
class MyClassTest {
    ...
    void setUp() {
        ...
        myClassUnderTest.executorService = MoreExecutors.newDirectExecutorService();
    ...
    void testGetAllUsersSync() {
        // Setup
        when(myClassUnderTest.userServiceAdapter.getUsers()).thenReturn(Arrays.asList(new User()));
