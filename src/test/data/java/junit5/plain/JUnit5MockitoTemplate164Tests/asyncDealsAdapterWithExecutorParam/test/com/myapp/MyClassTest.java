...
class MyClassTest {
    ...
    @Test
    void testGetDealsWithExecParam() throws Exception {
        // Setup
        final Executor paramExecutor = MoreExecutors.directExecutor();
        ...
        // Run the test
        final CompletableFuture<List<DisplayDeal>> result = myClassUnderTest.getDealsWithExecParam("userId",
                paramExecutor);
    ...
    @Test
    void testGetDealsWithExecParam_DealsServiceClientThrowsServiceException() throws Exception {
        // Setup
        final Executor paramExecutor = MoreExecutors.directExecutor();
        when(mockDealsService.getDeals(any(GetDealsRequest.class))).thenThrow(ServiceException.class);
    ...
    @Test
    void testGetDealsWithExecParam_DealsServiceClientThrowsNetworkException() throws Exception {
        // Setup
        final Executor paramExecutor = MoreExecutors.directExecutor();
        when(mockDealsService.getDeals(any(GetDealsRequest.class))).thenThrow(NetworkException.class);
