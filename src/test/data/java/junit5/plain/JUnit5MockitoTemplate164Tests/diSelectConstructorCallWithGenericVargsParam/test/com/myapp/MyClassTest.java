...
class MyClassTest {
    ...
    void testMakeFoo1() {
        ...
        simpleBeans.setMyAddressLine1("myAddressLine1");
        simpleBeans.setMyAddressLine2("myAddressLine2");
        simpleBeans.setMyZipCode("myZipCode");
        simpleBeans.setMyCountry("myCountry");
        simpleBeans.setMyCurrency(Currency.getInstance("USD"));
