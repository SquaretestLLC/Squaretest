...
class MyClassTest {
    ...
    void testGetSubFooFullDataForFooId() {
        ...
        final Foo foo = new Foo("id", "name", Arrays.asList(new SubFoo("subFooIdParam", "subFooValueParam")));
        ...
        when(mockFooService.getSubFooById("subFooIdParam")).thenReturn(subFooFullData);
