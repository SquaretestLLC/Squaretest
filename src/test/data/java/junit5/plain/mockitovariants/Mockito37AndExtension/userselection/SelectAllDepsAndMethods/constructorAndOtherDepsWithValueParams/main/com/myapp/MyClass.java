...
public class MyClass {
    ...
    @Autowired
    public void setDeltaService(DeltaService value) {
        Log.info("setDeltaService called");
        this.deltaService = value;
    }

    public void setFooService(FooService value) {
        Log.info("setFooService called");
        this.fooService = value;
    }

    public static void setEpsilonService(EpsilonService value) {
        MyClass.epsilonService = value;
    }
}
