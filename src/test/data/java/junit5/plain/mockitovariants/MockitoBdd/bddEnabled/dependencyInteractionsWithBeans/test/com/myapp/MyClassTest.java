...
class MyClassTest {
    ...
    void testConvertBean() {
        ...
        given(mockBeanConverter.convertBean(any(Bean.class))).willReturn(otherBean);
    ...
    void testConvertDefaultObjectAnonInnerClass() {
        ...
        otherBean.setOurData(data);
        otherBean.setOurStr("ourStr");
        given(mockBeanConverter.convertObject(any(Object.class))).willReturn(otherBean);
    ...
    void testCreateGenericBean() {
        ...
        given(mockBeanConverter.createGenericBean(any(Bean.class))).willReturn(bean);
    ...
    void testCreateGenericBeanWithAnonInnerClass() {
        // Setup
        given(mockBeanConverter.createGenericBean(any(Bean.class))).willReturn(null);
    ...
    void testCreateGenericBeanWithLocalClass() {
        ...
        // Verify the results
        then(mockBeanConverter).should().createGenericBean(any(PhoneNumber.class));
    }

    @Test
    void testCreateGenericBeanWithLocalClass1() {
        // Setup
        given(mockBeanConverter.createGenericBean(any(PhoneNumber.class))).willReturn(null);
    ...
    void testMakeBeanWithClass_LocalClass() {
        // Setup
        given(mockBeanConverter.createGenericBeanWithClass(PhoneNumber.class)).willReturn(null);
    ...
    void testMakeBeanWithClass_InnerInstanceClass() {
        ...
        given(mockBeanConverter.createGenericBeanWithClass(MyClass.PhoneNumberInstance.class))
                .willReturn(mockPhoneNumberInstance);
    ...
    void testMakeBeanWithClass_InnerStaticClass() {
        ...
        given(mockBeanConverter.createGenericBeanWithClass(MyClass.PhoneNumberStatic.class))
                .willReturn(phoneNumberStatic1);
    ...
    void testMakeBeanWithClass_AnonClass() {
        ...
        // Verify the results
        then(mockBeanConverter).should().createGenericBeanWithClass(Bean.class);
    }

    @Test
    void testMakeBeanWithClass_AnonClass1() {
        // Setup
        given(mockBeanConverter.createGenericBeanWithClass(Bean.class)).willReturn(null);
    ...
    void testMakeBeanWithClass_LambdaClass() {
        ...
        // Verify the results
        then(mockBeanConverter).should().createGenericBeanWithClass(Supplier.class);
    }

    @Test
    void testMakeBeanWithClass_LambdaClass1() {
        // Setup
        given(mockBeanConverter.createGenericBeanWithClass(Supplier.class)).willReturn(() -> null);
