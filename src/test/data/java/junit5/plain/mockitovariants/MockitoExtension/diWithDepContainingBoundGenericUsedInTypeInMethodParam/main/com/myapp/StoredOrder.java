...
//    }
    ...
    @DynamoDbAttribute(value = LICENSE_NAME)
    ...
    @DynamoDbAttribute(value = LICENSE_TYPE)
    ...
    @DynamoDbAttribute(value = NUMBER_OF_USERS)
    ...
    @DynamoDbAttribute(value = DELIVERY_EMAIL_ADDRESS)
    ...
    @DynamoDbAttribute(value = LICENSE_TEXT)
    ...
    @DynamoDbAttribute(value = CREATOR_NAME)
    ...
    @DynamoDbAttribute(value = LOAN_DOCUMENT_S3_Path)
