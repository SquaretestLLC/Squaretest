...
class MyClassTest {
    ...
    void setUp() {
        initMocks(this);
        myClassUnderTest = new MyClass(mockSessionsClient, SpeechModelVariant.SPEECH_MODEL_VARIANT_UNSPECIFIED, 0);
    }
    ...
    void testTryDetectIntent() {
        ...
        // Run the test
        myClassUnderTest.tryDetectIntent(AudioEncoding.AUDIO_ENCODING_UNSPECIFIED, 0.0);
