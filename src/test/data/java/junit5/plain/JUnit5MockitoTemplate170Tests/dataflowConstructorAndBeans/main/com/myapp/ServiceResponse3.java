...
public class ServiceResponse3 {
    ...
    private final List<ServiceResponse3.ServiceResponse3Part> serviceResponse3Parts;
    private final Date serviceResponse3CreatedDate;
    private final long serviceResponse3LongValue;

    public ServiceResponse3(String serviceResponse3Id, String serviceResponse3Name, List<ServiceResponse3.ServiceResponse3Part> serviceResponse3Parts, Date serviceResponse3CreatedDate, long serviceResponse3LongValue) {
    ...
    public List<ServiceResponse3.ServiceResponse3Part> getServiceResponse3Parts() {
