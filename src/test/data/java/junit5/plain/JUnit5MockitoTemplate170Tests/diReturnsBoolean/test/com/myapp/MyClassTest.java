...
class MyClassTest {
    ...
    @Test
    void testIsValid1_FooServiceReturnsFailure() {
        // Setup
    ...
    @Test
    void testIsValid2_FooServiceReturnsFailure() {
        // Setup
        when(mockFooService.isValid("data")).thenReturn(false);
    ...
    @Test
    void testIsValid3_FooServiceReturnsFailure() {
        // Setup
        when(mockFooService.isValid("data")).thenReturn(false);
    ...
    @Test
    void testExists_FooServiceReturnsFailure() {
        // Setup
    ...
    @Test
    void testValidate1_FooServiceReturnsFailure() {
        // Setup
        when(mockFooService.isValid("data")).thenReturn(false);
    ...
    @Test
    void testValidate2_FooServiceReturnsFailure() {
        // Setup
        when(mockFooService.isValid("data")).thenReturn(false);
    ...
    @Test
    void testValidate3_FooServiceReturnsFailure() {
        // Setup
        when(mockFooService.isValid("data")).thenReturn(true);
    ...
    @Test
    void testCreateFoo1_FooServiceIsValidReturnsFailure() {
        // Setup
        when(mockFooService.isValid("data")).thenReturn(false);
    ...
    @Test
    void testCreateFoo3_FooServiceIsValidReturnsFailure() {
        // Setup
        when(mockFooService.isValid("data")).thenReturn(false);
    ...
    @Test
    void testCreateFoo3_FooServiceShouldThrowInvalidFooReturnsFailure() {
        // Setup
        when(mockFooService.isValid("data")).thenReturn(false);
    ...
    @Test
    void testCreateFoo4_FooServiceExistsReturnsFailure() {
        // Setup
        when(mockFooService.exists("data")).thenReturn(true);
    ...
    @Test
    void testCreateFoo5_FooServiceExistsReturnsFailure() {
        // Setup
        when(mockFooService.exists("data")).thenReturn(true);
    ...
    @Test
    void testCreateFoo6_FooServiceShouldRecordCreateReturnsFailure() {
        // Setup
    ...
    @Test
    void testGetFoo1_FooServiceIsValidReturnsFailure() {
        // Setup
        when(mockFooService.getFoo1("id")).thenReturn("result");
        when(mockFooService.isValid("data")).thenReturn(false);
    ...
    @Test
    void testCheckCanCreate1_FooServiceExistsReturnsFailure() {
        // Setup
        when(mockFooService.getFoo1("id")).thenReturn("result");
        when(mockFooService.exists("data")).thenReturn(true);
    ...
    @Test
    void testGetFoo2_FooServiceShouldThrowReturnsFailure() {
        // Setup
        when(mockFooService.getFoo1("id")).thenThrow(FooNotFoundException.class);
    ...
    @Test
    void testGetFoo3_FooServiceShouldRecordOldFooReturnsFailure() {
        // Setup
        when(mockFooService.getFoo1("id")).thenReturn("result");
    ...
    @Test
    void testGetFoo4_FooServiceShouldRecordOldFooReturnsFailure() {
        // Setup
        when(mockFooService.isValidId("id")).thenReturn(false);
        when(mockFooService.getFoo1("id")).thenReturn("result");
        when(mockFooService.shouldRecordOldFoo("id")).thenReturn(true);
    ...
    @Test
    void testGetFoo5_FooServiceShouldRecordOldFooReturnsFailure() {
        // Setup
        when(mockFooService.isValidId("id")).thenReturn(false);
        when(mockFooService.getFoo1("id")).thenReturn("result");
        when(mockFooService.shouldRecordOldFoo("id")).thenReturn(true);
    ...
    @Test
    void testGetFoo8_FooServiceShouldRecordOldFooReturnsFailure() {
        // Setup
        when(mockFooService.isValidId("id")).thenReturn(false);
        when(mockFooService.getFoo1("id")).thenReturn("hello");
        when(mockFooService.shouldRecordOldFoo("id")).thenReturn(true);
