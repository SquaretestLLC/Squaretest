...
class MyClassTest {
    ...
    @Test
    void testContains1() {
        assertFalse(MyClass.contains("seq", "searchSeq"));
    }

    @Test
    void testContains2() {
        assertFalse(MyClass.contains("seq", 0));
    }

    @Test
    void testContainsAny1() {
        assertFalse(MyClass.containsAny("cs", 'a'));
    }

    @Test
    void testContainsAny2() {
        assertFalse(MyClass.containsAny("cs", "searchChars"));
    }

    @Test
    void testContainsAny3() {
        assertFalse(MyClass.containsAny("cs", "searchCharSequences"));
    }

    @Test
    void testContainsIgnoreCase() {
        assertFalse(MyClass.containsIgnoreCase("str", "searchStr"));
    }

    @Test
    void testContainsNone1() {
        assertFalse(MyClass.containsNone("cs", 'a'));
    }

    @Test
    void testContainsNone2() {
        assertFalse(MyClass.containsNone("cs", "invalidChars"));
    }

    @Test
    void testContainsOnly1() {
        assertFalse(MyClass.containsOnly("cs", 'a'));
    }

    @Test
    void testContainsOnly2() {
        assertFalse(MyClass.containsOnly("cs", "validChars"));
    }

    @Test
    void testContainsWhitespace() {
        assertFalse(MyClass.containsWhitespace("seq"));
    }
    ...
    @Test
    void testEndsWith1() {
        assertFalse(MyClass.endsWith("str", "suffix"));
    }

    @Test
    void testEndsWithAny() {
        assertFalse(MyClass.endsWithAny("sequence", "searchStrings"));
    }

    @Test
    void testEndsWithIgnoreCase() {
        assertFalse(MyClass.endsWithIgnoreCase("str", "suffix"));
    }

    @Test
    void testEquals() {
        assertFalse(MyClass.equals("cs1", "cs2"));
    }

    @Test
    void testEqualsAny() {
        assertFalse(MyClass.equalsAny("string", "searchStrings"));
    }

    @Test
    void testEqualsAnyIgnoreCase() {
        assertFalse(MyClass.equalsAnyIgnoreCase("string", "searchStrings"));
    }

    @Test
    void testEqualsIgnoreCase() {
        assertFalse(MyClass.equalsIgnoreCase("cs1", "cs2"));
    }
    ...
    @Test
    void testIsAllBlank() {
        assertFalse(MyClass.isAllBlank("css"));
    }

    @Test
    void testIsAllEmpty() {
        assertFalse(MyClass.isAllEmpty("css"));
    }

    @Test
    void testIsAllLowerCase() {
        assertFalse(MyClass.isAllLowerCase("cs"));
    }

    @Test
    void testIsAllUpperCase() {
        assertFalse(MyClass.isAllUpperCase("cs"));
    }

    @Test
    void testIsAlpha() {
        assertFalse(MyClass.isAlpha("cs"));
    }

    @Test
    void testIsAlphanumeric() {
        assertFalse(MyClass.isAlphanumeric("cs"));
    }

    @Test
    void testIsAlphanumericSpace() {
        assertFalse(MyClass.isAlphanumericSpace("cs"));
    }

    @Test
    void testIsAlphaSpace() {
        assertFalse(MyClass.isAlphaSpace("cs"));
    }

    @Test
    void testIsAnyBlank() {
        assertFalse(MyClass.isAnyBlank("css"));
    }

    @Test
    void testIsAnyEmpty() {
        assertFalse(MyClass.isAnyEmpty("css"));
    }

    @Test
    void testIsAsciiPrintable() {
        assertFalse(MyClass.isAsciiPrintable("cs"));
    }

    @Test
    void testIsBlank() {
        assertFalse(MyClass.isBlank("cs"));
    }
    ...
    void testIsMixedCase() {
        assertFalse(MyClass.isMixedCase("cs"));
    }

    @Test
    void testIsNoneBlank() {
        assertFalse(MyClass.isNoneBlank("css"));
    }

    @Test
    void testIsNoneEmpty() {
        assertFalse(MyClass.isNoneEmpty("css"));
    }

    @Test
    void testIsNotBlank() {
        assertFalse(MyClass.isNotBlank("cs"));
    }

    @Test
    void testIsNotEmpty() {
        assertFalse(MyClass.isNotEmpty("cs"));
    }

    @Test
    void testIsNumeric() {
        assertFalse(MyClass.isNumeric("cs"));
    }

    @Test
    void testIsNumericSpace() {
        assertFalse(MyClass.isNumericSpace("cs"));
    }

    @Test
    void testIsWhitespace() {
        assertFalse(MyClass.isWhitespace("cs"));
    }
    ...
    void testStartsWith1() {
        assertFalse(MyClass.startsWith("str", "prefix"));
    }

    @Test
    void testStartsWithAny() {
        assertFalse(MyClass.startsWithAny("sequence", "searchStrings"));
    }

    @Test
    void testStartsWithIgnoreCase() {
        assertFalse(MyClass.startsWithIgnoreCase("str", "prefix"));
    }
