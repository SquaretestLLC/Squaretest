...
public class MyClass {
     ...
     * @deprecated This feature will be removed in Lang 4.0, use {@link MyClass#removeEnd(String, String)} instead
     */
    @Deprecated
     ...
     * @see MyClass#defaultString(String, String)
     */
     ...
     * @see MyClass#endsWith(CharSequence, CharSequence)
   ...
   public static String replaceIgnoreCase(final String text, final String searchString, final String replacement) {
     ...
     * @see MyClass#startsWith(CharSequence, CharSequence)
     * @return {@code true} if the input {@code sequence} is {@code null} AND no {@code searchStrings} are provided, or
     ...
     * @deprecated use {@link MyClass#toEncodedString(byte[], Charset)} instead of String constants in your code
     * @since 3.1
     */
    @Deprecated
