...
class MyClassTest {
    ...
    void testDeleteOrders() {
        ...
        // Verify the results
        verify(mockDynamoDBMapper).delete(eq(new StoredOrder()), any(DynamoDBDeleteExpression.class),
    ...
    void testDeleteOrders_DynamoDBMapperThrowsAmazonDynamoDBException() {
        // Setup
        doThrow(AmazonDynamoDBException.class).when(mockDynamoDBMapper).delete(eq(new StoredOrder()),
    ...
    void testBatchDeleteObjects() {
        // Setup
        when(mockDynamoDBMapper.batchDelete(new StoredOrder())).thenReturn(Collections.emptyList());

        // Run the test
        myClassUnderTest.batchDeleteObjects();

        // Verify the results
        verify(mockDynamoDBMapper).batchDelete(new StoredOrder());
    }

    @Test
    void testBatchDeleteObjects_DynamoDBMapperReturnsFailure() {
        // Setup
        when(mockDynamoDBMapper.batchDelete(new StoredOrder()))
                .thenReturn(Arrays.asList(new DynamoDBMapper.FailedBatch()));
    ...
    void testBatchDeleteObjects_DynamoDBMapperThrowsAmazonDynamoDBException() {
        // Setup
        when(mockDynamoDBMapper.batchDelete(new StoredOrder())).thenThrow(AmazonDynamoDBException.class);
    ...
    void testBatchDeleteObjectsWithList() {
        // Setup
        when(mockDynamoDBMapper.batchDelete(Arrays.asList(new StoredOrder()))).thenReturn(Collections.emptyList());

        // Run the test
        myClassUnderTest.batchDeleteObjectsWithList();

        // Verify the results
        verify(mockDynamoDBMapper).batchDelete(Arrays.asList(new StoredOrder()));
    }

    @Test
    void testBatchDeleteObjectsWithList_DynamoDBMapperReturnsFailure() {
        // Setup
        when(mockDynamoDBMapper.batchDelete(Arrays.asList(new StoredOrder())))
                .thenReturn(Arrays.asList(new DynamoDBMapper.FailedBatch()));
    ...
    void testBatchDeleteObjectsWithList_DynamoDBMapperThrowsAmazonDynamoDBException() {
        // Setup
        when(mockDynamoDBMapper.batchDelete(Arrays.asList(new StoredOrder()))).thenThrow(AmazonDynamoDBException.class);
