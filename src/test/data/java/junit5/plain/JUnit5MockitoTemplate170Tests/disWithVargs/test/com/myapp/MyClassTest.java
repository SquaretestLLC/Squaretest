...
class MyClassTest {
    ...
    void testGetFoos3() {
        ...
        // Configure FooService.getFoos1(...).
        final List<FooData> fooData = Arrays.asList(new FooData("id", "name", FooStatus.Creating));
        when(mockFooService.getFoos1(eq("id1"))).thenReturn(fooData);
    ...
    void testGetFoos3_FooServiceReturnsNoItems() {
        // Setup
        when(mockFooService.getFoos1(eq("id1"))).thenReturn(Collections.emptyList());
    ...
    void testGetFoos9() {
        ...
        // Configure FooService.getFoos2(...).
        final List<FooData> fooData = Arrays.asList(new FooData("id", "name", FooStatus.Creating));
        when(mockFooService.getFoos2(eq("prefix"), eq(FooStatus.Creating))).thenReturn(fooData);
    ...
    void testGetFoos9_FooServiceReturnsNoItems() {
        // Setup
        when(mockFooService.getFoos2(eq("prefix"), eq(FooStatus.Creating))).thenReturn(Collections.emptyList());
    ...
    void testStoreFoo4() {
        ...
        // Verify the results
        verify(mockFooService).storeFoos1(eq(new FooData("id", "name", FooStatus.Creating)));
    }
    ...
    void testStoreFoo7() {
        ...
        // Verify the results
        verify(mockFooService).storeFoos2(eq(new FooData("id", "name", FooStatus.Creating)),
                eq(new FooData("id", "name", FooStatus.Creating)));
    }
