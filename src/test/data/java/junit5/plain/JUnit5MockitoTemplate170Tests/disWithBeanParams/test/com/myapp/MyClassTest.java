...
class MyClassTest {
    ...
    void testStoreFooData1() {
        ...
        when(mockMainFooService.storeFoo1(new FooData())).thenReturn(fooData1);

        // Run the test
        myClassUnderTest.storeFooData1(fooData);

        // Verify the results
        verify(mockMainFooService).storeFoo1(new FooData());
    }
    ...
    void testStoreFooData1_FooServiceThrowsFooServiceException() {
        ...
        when(mockMainFooService.storeFoo1(new FooData())).thenThrow(FooServiceException.class);
    ...
    void testStoreFooData2() {
        ...
        when(mockMainFooService.storeFoo2(Arrays.asList(new FooData()))).thenReturn(fooData2);

        // Run the test
        myClassUnderTest.storeFooData2(fooData);

        // Verify the results
        verify(mockMainFooService).storeFoo2(Arrays.asList(new FooData()));
    }
    ...
    void testStoreFooData2_FooServiceThrowsFooServiceException() {
        ...
        fooData1.setName("name");
        final List<FooData> fooData = Arrays.asList(fooData1);
        when(mockMainFooService.storeFoo2(Arrays.asList(new FooData()))).thenThrow(FooServiceException.class);
    ...
    void testStoreFooData4() {
        ...
        when(mockMainFooService.storeFoo2(Arrays.asList(new FooData()))).thenReturn(fooData3);
    ...
    void testStoreFooData4_FooServiceReturnsNoItems() {
        ...
        fooData1.setName("name");
        final List<FooData> fooData = Arrays.asList(fooData1);
        when(mockMainFooService.storeFoo2(Arrays.asList(new FooData()))).thenReturn(Collections.emptyList());
    ...
    void testStoreFooData5() {
        ...
        when(mockMainFooService.storeFooDataOpt(new FooData())).thenReturn(fooData1);

        // Run the test
        myClassUnderTest.storeFooData5(fooData);

        // Verify the results
        verify(mockMainFooService).storeFooDataOpt(new FooData());
    }
    ...
    void testStoreFooData5_FooServiceThrowsFooServiceException() {
        ...
        when(mockMainFooService.storeFooDataOpt(new FooData())).thenThrow(FooServiceException.class);
    ...
    void testStoreFooData6() {
        ...
        when(mockMainFooService.storeFooDataOpt(new FooData())).thenReturn(fooData2);
    ...
    void testStoreFooData6_FooServiceReturnsAbsent() {
        ...
        when(mockMainFooService.storeFooDataOpt(new FooData())).thenReturn(Optional.empty());
    ...
    void testStoreFooData7() {
        ...
        when(mockMainFooService.storeFooDataFuture(new FooData())).thenReturn(fooDataCompletableFuture);

        // Run the test
        myClassUnderTest.storeFooData7(fooData);

        // Verify the results
        verify(mockMainFooService).storeFooDataFuture(new FooData());
    }

    @Test
    void testStoreFooData7_FooServiceReturnsFailure() {
        // Setup
        final FooData fooData = new FooData();
        fooData.setId("id");
        fooData.setName("name");
    ...
    void testStoreFooData7_FooServiceThrowsFooServiceException() {
        ...
        when(mockMainFooService.storeFooDataFuture(new FooData())).thenThrow(FooServiceException.class);
    ...
    void testStoreFooData9() throws Exception {
        ...
        when(mockMainFooService.storeFooDataStream(new FooData())).thenReturn(spyInputStream);
    ...
    void testStoreFooData9_FooServiceThrowsFooServiceException() {
        ...
        when(mockMainFooService.storeFooDataStream(new FooData())).thenThrow(FooServiceException.class);
