...
public class InnerBeanData {
    private long id;
    private Date createDate;
    private String name;
    private InnerBeanSubData innerBeanSubData;
    ...
    public InnerBeanSubData getInnerBeanSubData() {
        return innerBeanSubData;
    }

    public void setInnerBeanSubData(final InnerBeanSubData innerBeanSubData) {
        this.innerBeanSubData = innerBeanSubData;
    }
