...
class MyClassTest {
    ...
    void testStoreFooData1() {
        ...
        when(mockMainFooService.storeFoo1(any(SearchParams.class), eq(new FooData()))).thenReturn(fooData1);

        // Run the test
        myClassUnderTest.storeFooData1(fooData);

        // Verify the results
        verify(mockMainFooService).storeFoo1(any(SearchParams.class), eq(new FooData()));
    }
    ...
    void testStoreFooData1_FooServiceThrowsFooServiceException() {
        ...
        when(mockMainFooService.storeFoo1(any(SearchParams.class), eq(new FooData())))
    ...
    void testStoreFooData2() {
        ...
        when(mockMainFooService.storeFoo2(any(SearchParams.class), eq(Arrays.asList(new FooData()))))
                .thenReturn(fooData2);
        ...
        // Verify the results
        verify(mockMainFooService).storeFoo2(any(SearchParams.class), eq(Arrays.asList(new FooData())));
    }
    ...
    void testStoreFooData5() {
        ...
        when(mockMainFooService.storeFooDataOpt(any(SearchParams.class), eq(new FooData()))).thenReturn(fooData1);

        // Run the test
        myClassUnderTest.storeFooData5(fooData);

        // Verify the results
        verify(mockMainFooService).storeFooDataOpt(any(SearchParams.class), eq(new FooData()));
    }
    ...
    void testStoreFooData5_FooServiceThrowsFooServiceException() {
        ...
        when(mockMainFooService.storeFooDataOpt(any(SearchParams.class), eq(new FooData())))
                .thenThrow(FooServiceException.class);
    ...
    void testStoreFooData6() {
        ...
        when(mockMainFooService.storeFooDataOpt(any(SearchParams.class), eq(new FooData()))).thenReturn(fooData2);
    ...
    void testStoreFooData7() {
        ...
        when(mockMainFooService.storeFooDataFuture(any(SearchParams.class), eq(new FooData())))
        ...
        // Verify the results
        verify(mockMainFooService).storeFooDataFuture(any(SearchParams.class), eq(new FooData()));
    }
    ...
    void testStoreFooData9() throws Exception {
        ...
        when(mockMainFooService.storeFooDataStream(any(SearchParams.class), eq(new FooData())))
                .thenReturn(spyInputStream);
