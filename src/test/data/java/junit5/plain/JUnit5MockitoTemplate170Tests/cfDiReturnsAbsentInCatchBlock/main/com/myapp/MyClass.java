...
public class MyClass {
    ...
    public MyClass(
            ...
            final DefaultOrderService defaultOrderService, final MetricService metricService) {
        this.orderService = orderService;
        this.defaultOrderService = defaultOrderService;
        this.metricService = metricService;
    }

    public Optional<Order> getOrderWithId2(final String orderId) {
        try {
            ...
            return defaultOrderService.getDefaultOrder(orderId);
        }
    }
}
