...
class MyClassTest {
    ...
    void testTransferOrder1() {
        ...
        // Configure OrderService.putOrder(...).
        final Order order1 = new Order("orderId", "description", Arrays.asList("value"));
        when(mockAltOrderService.putOrder(any(Order.class))).thenReturn(order1);
    ...
    void testTransferOrder4() {
        ...
        // Configure OrderService.getOrderWithId1(...).
        final Order order2 = new Order("orderId", "description", Arrays.asList("value"));
        when(mockAltOrderService.getOrderWithId1("orderId")).thenReturn(order2);
    ...
    void testTransferOrder6_OrderServiceReturnsNull() {
        ...
        // Configure OrderService.putOrder(...).
        final Order order = new Order("orderId", "description", Arrays.asList("value"));
        when(mockAltOrderService.putOrder(any(Order.class))).thenReturn(order);
