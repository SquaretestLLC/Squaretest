...
public class MyClass {
    ...
    public List<Order> getOrders2(final String searchCriteria) {
        final List<Order> orders1 = orderService.getOrders1(searchCriteria);
        return Optional.fromNullable(orders1).or(Collections.emptyList());
    }

    public List<Order> getOrders3(final String searchCriteria) {
        final Optional<List<Order>> orders1 = Optional.fromNullable(orderService.getOrders1(searchCriteria));
        return orders1.or(List.of());
    }

    public List<Order> getOrders4(final String searchCriteria) {
        final List<Order> orders1 = orderService.getOrders1(searchCriteria);
        return Optional.fromNullable(orders1).or((List<Order>) null);
    }
    ...
    public List<Order> getOrders8(final String searchCriteria) {
        ...
        return Optional.fromNullable(ordersHelper2).or(Collections.emptyList());
    }
    ...
    public List<Order> getOrders9(final String searchCriteria) {
        ...
        return Optional.fromNullable(ordersHelper3).or(List.of());
    }
    ...
    public List<Order> getOrders10(final String searchCriteria) {
        final Optional<List<Order>> ordersHelper4 = Optional.fromNullable(getOrdersHelper4(searchCriteria));
        return ordersHelper4.or((List<Order>) null);
    }
    ...
    public boolean orderExists1(final String searchCriteria) {
        final List<Order> orders1 = orderService.getOrders1(searchCriteria);
        return Optional.fromNullable(orders1).or(Collections.emptyList()).isEmpty();
    }
