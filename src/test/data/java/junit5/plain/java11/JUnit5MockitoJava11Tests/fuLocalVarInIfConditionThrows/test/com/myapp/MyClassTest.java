...
class MyClassTest {
    ...
    void testGetOrder5_OrderServiceReturnsAbsent() {
        ...
        // Run the test
        assertThrows(NoSuchElementException.class, () -> myClassUnderTest.getOrder5("orderId"));
    }
    ...
    void testGetOrder6_OrderServiceReturnsAbsent() {
        ...
        // Run the test
        assertThrows(NoSuchElementException.class, () -> myClassUnderTest.getOrder6("orderId"));
    }
    ...
    void testGetOrder7_OrderServiceReturnsAbsent() {
        ...
        // Run the test
        assertThrows(NoSuchElementException.class, () -> myClassUnderTest.getOrder7("orderId"));
    }
