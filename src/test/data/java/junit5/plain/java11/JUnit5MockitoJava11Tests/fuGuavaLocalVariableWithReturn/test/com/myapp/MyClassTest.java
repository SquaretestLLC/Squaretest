...
class MyClassTest {
    ...
    void testGetOrderWithId2_OrderServiceReturnsNull() {
        ...
        // Run the test
        assertThrows(IllegalStateException.class, () -> myClassUnderTest.getOrderWithId2("orderId"));
    }
    ...
    void testGetOrderWithId11_OrderServiceGetOrderWithId2ReturnsNull() {
        ...
        // Run the test
        assertThrows(IllegalStateException.class, () -> myClassUnderTest.getOrderWithId11("orderId"));
    }
    ...
    void testGetOrderDescription2_OrderServiceReturnsNull() {
        ...
        // Run the test
        assertThrows(IllegalStateException.class, () -> myClassUnderTest.getOrderDescription2("orderId"));
        verify(mockMetricService).recordMetricHitInBothCases("orderId");
    }
    ...
    void testGetOrderDescription9_OrderServiceReturnsNull() {
        ...
        // Run the test
        assertThrows(IllegalStateException.class, () -> myClassUnderTest.getOrderDescription9("orderId"));
    }
