...
public class MyClass {
    ...
    public Order tryCreate1(final Order order) {
        ...
        if (orderService.getOrderWithId1(orderId) != null) throw new OrderAlreadyExistsException(orderId);
    ...
    public Order tryCreate2(final Order order) {
        final String orderId = order.getOrderId();
        if (Optional.fromNullable(orderService.getOrderWithId1(orderId)).isPresent())
    ...
    public Order updateOrder1(final Order order) {
        final String orderId = order.getOrderId();
        if (orderService.getOrderWithId1(orderId) == null) throw new OrderNotFoundException(orderId);
