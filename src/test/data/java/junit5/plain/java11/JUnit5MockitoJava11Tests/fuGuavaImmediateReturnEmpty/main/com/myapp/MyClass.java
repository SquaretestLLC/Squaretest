...
public class MyClass {
    ...
    public List<Order> getOrders2(final String searchCriteria) {
        return Optional.fromNullable(orderService.getOrders1(searchCriteria)).or(Collections.emptyList());
    }

    public List<Order> getOrders3(final String searchCriteria) {
        return Optional.fromNullable(orderService.getOrders1(searchCriteria)).or(List.of());
    }

    public List<Order> getOrders4(final String searchCriteria) {
        return Optional.fromNullable(orderService.getOrders1(searchCriteria)).or((List<Order>) null);
    }
    ...
    public List<Order> getOrders8(final String searchCriteria) {
        return Optional.fromNullable(getOrdersHelper2(searchCriteria)).or(Collections.emptyList());
    }
    ...
    public List<Order> getOrders9(final String searchCriteria) {
        return Optional.fromNullable(getOrdersHelper3(searchCriteria)).or(List.of());
    }
    ...
    public List<Order> getOrders10(final String searchCriteria) {
        return Optional.fromNullable(getOrdersHelper4(searchCriteria)).or((List<Order>) null);
    }
    ...
    public boolean orderExists1(final String searchCriteria) {
        return Optional.fromNullable(orderService.getOrders1(searchCriteria)).or(Collections.emptyList()).isEmpty();
    }
