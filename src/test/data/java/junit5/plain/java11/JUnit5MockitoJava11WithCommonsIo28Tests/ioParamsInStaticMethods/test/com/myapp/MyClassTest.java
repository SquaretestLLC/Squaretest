...
class MyClassTest {
    ...
    void testClose1_EmptyCloseable() throws Exception {
        // Setup
        final Closeable closeable = InputStream.nullInputStream();
    ...
    void testClose1_BrokenCloseable() {
        // Setup
        final Closeable closeable = new BrokenInputStream();
    ...
    void testClose2_EmptyCloseables() throws Exception {
        // Setup
        final Closeable closeables = InputStream.nullInputStream();
    ...
    void testClose2_BrokenCloseables() {
        // Setup
        final Closeable closeables = new BrokenInputStream();
    ...
    void testCloseQuietly6_EmptyInput() {
        // Setup
        final Reader input = Reader.nullReader();
    ...
    void testCloseQuietly6_BrokenInput() {
        // Setup
        final Reader input = new BrokenReader();
    ...
    void testCloseQuietly10_BrokenOutput() {
        // Setup
        final Writer output = new BrokenWriter();
    ...
    void testContentEquals1_EmptyInput1() throws Exception {
        // Setup
        final InputStream input1 = InputStream.nullInputStream();
        final InputStream input2 = new ByteArrayInputStream("content".getBytes());
    ...
    void testContentEquals1_BrokenInput1() {
        // Setup
        final InputStream input1 = new BrokenInputStream();
        final InputStream input2 = new ByteArrayInputStream("content".getBytes());
    ...
    void testContentEquals1_EmptyInput2() throws Exception {
        // Setup
        final InputStream input1 = new ByteArrayInputStream("content".getBytes());
        final InputStream input2 = InputStream.nullInputStream();
    ...
    void testContentEquals1_BrokenInput2() {
        // Setup
        final InputStream input1 = new ByteArrayInputStream("content".getBytes());
        final InputStream input2 = new BrokenInputStream();
    ...
    void testContentEquals2_EmptyInput1() throws Exception {
        // Setup
        final Reader input1 = Reader.nullReader();
        final Reader input2 = new StringReader("content");
    ...
    void testContentEquals2_BrokenInput1() {
        // Setup
        final Reader input1 = new BrokenReader();
        final Reader input2 = new StringReader("content");
    ...
    void testContentEquals2_EmptyInput2() throws Exception {
        // Setup
        final Reader input1 = new StringReader("content");
        final Reader input2 = Reader.nullReader();
    ...
    void testContentEquals2_BrokenInput2() {
        // Setup
        final Reader input1 = new StringReader("content");
        final Reader input2 = new BrokenReader();
    ...
    void testWriteLines1() throws Exception {
        ...
        // Run the test
        MyClass.writeLines(List.of("value"), "lineEnding", output);
    ...
    void testWriteLines1_BrokenOutput() {
        ...
        // Run the test
        assertThrows(IOException.class, () -> MyClass.writeLines(List.of("value"), "lineEnding", output));
    }
    ...
    void testWriteLines2() throws Exception {
        ...
        // Run the test
        MyClass.writeLines(List.of("value"), "lineEnding", output, StandardCharsets.UTF_8);
    ...
    void testWriteLines3() throws Exception {
        ...
        // Run the test
        MyClass.writeLines(List.of("value"), "lineEnding", output, "UTF-8");
    ...
    void testWriteLines3_BrokenOutput() {
        ...
        // Run the test
        assertThrows(IOException.class, () -> MyClass.writeLines(List.of("value"), "lineEnding", output, "UTF-8"));
    }
    ...
    void testWriteLines4() throws Exception {
        ...
        // Run the test
        MyClass.writeLines(List.of("value"), "lineEnding", writer);
    ...
    void testWriteLines4_BrokenWriter() {
        ...
        // Run the test
        assertThrows(IOException.class, () -> MyClass.writeLines(List.of("value"), "lineEnding", writer));
    }
