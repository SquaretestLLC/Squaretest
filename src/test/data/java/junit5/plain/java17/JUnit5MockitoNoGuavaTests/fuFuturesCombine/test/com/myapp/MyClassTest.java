...
class MyClassTest {
    ...
    void setUp() {
        initMocks(this);
        myClassUnderTest = new MyClass(mockExecutorService, mockFooService, mockOldFooService, mockBarService,
    ...
    void testGetFooAndBar1_FooServiceReturnsFailure() {
        // Setup
        // Configure FooService.getFooByIdAsync1(...).
        final CompletableFuture<FooData> fooDataCompletableFuture = CompletableFuture.failedFuture(
    ...
    void testGetFooAndBar11_OldFooServiceReturnsFailure() {
        ...
        // Configure FooService.getFooByIdAsync1(...).
        final CompletableFuture<FooData> fooDataCompletableFuture1 = CompletableFuture.failedFuture(
                new Exception("message"));
        when(mockOldFooService.getFooByIdAsync1("fooId")).thenReturn(fooDataCompletableFuture1);
