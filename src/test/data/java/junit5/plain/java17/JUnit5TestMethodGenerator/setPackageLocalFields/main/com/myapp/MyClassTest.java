...
class MyClassTest {
    ...
    private ExecutorService directExecutorService = MoreExecutors.directExecutor();
    ...
    void setUp() {
        initMocks(this);
        myClass = new MyClass();
        // Test assign to output of constructor call.
        myClass.userServiceAdapter = new com.myapp.UserServiceAdapter();
        // Test assign to non-mocked field.
        myClass.executorService = directExecutorService;
        // Test inline mock.
        myClass.foo = mock(Foo.class);
        // Test assign mock field to this.
