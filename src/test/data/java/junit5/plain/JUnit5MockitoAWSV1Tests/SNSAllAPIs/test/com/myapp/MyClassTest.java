...
class MyClassTest {
    ...
    void testTryAddPermission() {
        // Setup
        when(mockAmazonSNSClient.addPermission(new AddPermissionRequest("topicArn", "label", Arrays.asList("value"),
    ...
    void testTryAddPermission_AmazonSNSClientThrowsInvalidParameterException() {
        // Setup
        when(mockAmazonSNSClient.addPermission(new AddPermissionRequest("topicArn", "label", Arrays.asList("value"),
                Arrays.asList("value")))).thenThrow(InvalidParameterException.class);
    ...
    void testTryAddPermission_AmazonSNSClientThrowsInternalErrorException() {
        // Setup
        when(mockAmazonSNSClient.addPermission(new AddPermissionRequest("topicArn", "label", Arrays.asList("value"),
                Arrays.asList("value")))).thenThrow(InternalErrorException.class);
    ...
    void testTryAddPermission_AmazonSNSClientThrowsAuthorizationErrorException() {
        // Setup
        when(mockAmazonSNSClient.addPermission(new AddPermissionRequest("topicArn", "label", Arrays.asList("value"),
                Arrays.asList("value")))).thenThrow(AuthorizationErrorException.class);
    ...
    void testTryAddPermission_AmazonSNSClientThrowsNotFoundException() {
        // Setup
        when(mockAmazonSNSClient.addPermission(new AddPermissionRequest("topicArn", "label", Arrays.asList("value"),
                Arrays.asList("value")))).thenThrow(NotFoundException.class);
    ...
    void testTryAddPermission1() {
        // Setup
        when(mockAmazonSNSClient.addPermission("topicArn", "label", Arrays.asList("value"),
                Arrays.asList("value"))).thenReturn(new AddPermissionResult());
    ...
    void testTryGetSMSAttributes() {
        ...
        request.setAttributes(Arrays.asList("value"));
