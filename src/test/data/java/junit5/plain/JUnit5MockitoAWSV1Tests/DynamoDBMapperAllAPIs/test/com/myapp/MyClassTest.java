...
class MyClassTest {
    ...
    @Test
    void testTryBatchLoad_AbstractDynamoDBMapperThrowsBatchGetItemException() {
        // Setup
        when(mockDynamoDBMapper.batchLoad(any(Iterable.class))).thenThrow(DynamoDBMapper.BatchGetItemException.class);

        // Run the test
        assertThrows(DynamoDBMapper.BatchGetItemException.class, () -> myClassUnderTest.tryBatchLoad());
    }
    ...
    @Test
    void testTryBatchLoad1_AbstractDynamoDBMapperThrowsBatchGetItemException() {
        // Setup
        when(mockDynamoDBMapper.batchLoad(any(Iterable.class), any(DynamoDBMapperConfig.class)))
                .thenThrow(DynamoDBMapper.BatchGetItemException.class);

        // Run the test
        assertThrows(DynamoDBMapper.BatchGetItemException.class, () -> myClassUnderTest.tryBatchLoad1());
    }
    ...
    @Test
    void testTryBatchLoad2_AbstractDynamoDBMapperThrowsBatchGetItemException() {
        // Setup
        when(mockDynamoDBMapper.batchLoad(new HashMap<>())).thenThrow(DynamoDBMapper.BatchGetItemException.class);

        // Run the test
        assertThrows(DynamoDBMapper.BatchGetItemException.class, () -> myClassUnderTest.tryBatchLoad2());
    }
    ...
    @Test
    void testTryBatchLoad3_AbstractDynamoDBMapperThrowsBatchGetItemException() {
        // Setup
        when(mockDynamoDBMapper.batchLoad(eq(new HashMap<>()), any(DynamoDBMapperConfig.class)))
                .thenThrow(DynamoDBMapper.BatchGetItemException.class);

        // Run the test
        assertThrows(DynamoDBMapper.BatchGetItemException.class, () -> myClassUnderTest.tryBatchLoad3());
    }
