...
public class MyClass {
    ...
    private static InnerBeanDTO convert(final FooData fooData) {
        ...
        // The setter call should be included. The calls on InnerBeanSubData should be excluded, though as they are
        // lower priority than the setters called in the source class.
        ret.setInnerBeanSubDTO(ConverterUtils.convert(innerFoo.getInnerBeanSubData()));
