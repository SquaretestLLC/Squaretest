...
class MyClassTest {
    ...
    @Test
    void testGetUserServiceAdapter() {
        assertEquals(mockUserServiceAdapter, myClassUnderTest.getUserServiceAdapter());
    }

    @Test
    void testGetExecutor() {
        final Executor result = myClassUnderTest.getExecutor();
    }

    @Test
    void testGetExecutorService() {
        final ExecutorService result = myClassUnderTest.getExecutorService();
    }
