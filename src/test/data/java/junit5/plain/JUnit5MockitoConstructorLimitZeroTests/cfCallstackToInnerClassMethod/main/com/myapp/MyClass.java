...
public class MyClass {
    ...
    public Order getOrderWithId1(final String orderId) throws NetworkException, ServiceException {
        return new Wrapper1(orderId).perform();
    }

    public Order getOrderWithId2(final String orderId) throws NetworkException, ServiceException {
        return new Wrapper2(orderId).perform();
    }

    public Order getOrderWithId3(final String orderId) throws NetworkException, ServiceException {
        return new Wrapper3(orderId).perform();
    }
    ...
    private class Wrapper1 {
        ...
        private Wrapper1(final String orderId) {
    ...
    private class Wrapper2 {
        ...
        private Wrapper2(final String orderId) {
            this.orderId = orderId;
        }
    ...
    private class Wrapper3 {
        ...
        private Wrapper3(final String orderId) {
            this.orderId = orderId;
        }
