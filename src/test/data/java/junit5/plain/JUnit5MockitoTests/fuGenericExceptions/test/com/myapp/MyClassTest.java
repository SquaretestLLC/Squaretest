...
class MyClassTest {
    ...
    @Mock
    private ExceptionService<Exception> mockExceptionService;
    @Mock
    private MetricService mockMetricService;

    private MyClass<String, Exception> myClassUnderTest;
    ...
    @Test
    void testGetFoo1_FooServiceReturnsNull() throws Exception {
        // Setup
