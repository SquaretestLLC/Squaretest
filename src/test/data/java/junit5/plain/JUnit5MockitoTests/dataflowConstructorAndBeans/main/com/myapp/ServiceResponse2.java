...
public class ServiceResponse2 {
    ...
    private final List<ServiceResponse2.ServiceResponse2Part> serviceResponse2Parts;
    private final Date serviceResponse2CreatedDate;
    private final long serviceResponse2LongValue;

    public ServiceResponse2(String serviceResponse2Id, String serviceResponse2Name, List<ServiceResponse2.ServiceResponse2Part> serviceResponse2Parts, Date serviceResponse2CreatedDate, long serviceResponse2LongValue) {
    ...
    public List<ServiceResponse2.ServiceResponse2Part> getServiceResponse2Parts() {
