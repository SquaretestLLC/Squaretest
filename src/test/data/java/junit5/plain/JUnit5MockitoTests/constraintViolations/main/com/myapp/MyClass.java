...
public class MyClass {
    ...
    public MyClass(
            final FooService fooService, final Validator validator,
    ...
    public void storeFoo1(final FooData fooData) throws FooServiceException {
        final Set<ConstraintViolation<FooData>> validateResult = validator.validate(fooData, FooData.class);
    ...
    private void throwFooDataValidationException(final Set<ConstraintViolation<FooData>> validateResult) throws FooDataValidationException {
