...
class MyClassTest {
    ...
    void testGetFooByIdNullable3_FooServiceGetFooByIdOptionalSameReturnsAbsent() {
        ...
        // Run the test
        assertThrows(IllegalArgumentException.class, () -> myClassUnderTest.getFooByIdNullable3(0L));
    }
    ...
    void testGetFooByIdNullable4_FooServiceGetFooByIdOptionalSameReturnsAbsent() {
        ...
        // Run the test
        assertThrows(IllegalArgumentException.class, () -> myClassUnderTest.getFooByIdNullable4(0L));
        verify(mockFooService).getFooByIdOptional(0L);
    }
    ...
    void testGetFooByIdNullable5_FooMapperReturnsNull() {
        ...
        // Run the test
        assertThrows(NoSuchElementException.class, () -> myClassUnderTest.getFooByIdNullable5(0L));
        verify(mockMetricsAdapter).recordMetricWithReturn("event");
    }
    ...
    void testGetFooByIdNullable6_FooMapperReturnsNull() {
        ...
        // Run the test
        assertThrows(NoSuchElementException.class, () -> myClassUnderTest.getFooByIdNullable6(0L));
    }
}
