...
public class MyClass {
    ...
    public Future<Order> getOrderWithId1(final String orderId) throws NetworkException, ServiceException {
        // Note: The assertThrows(..) statements will be incorrect. The purpose of the tests is to ensure
        // Squaretest doesn't crash. The user will need to fix the generated tests.
        final Supplier<Order> orderCallable1 = getOrderCallable1(orderId);
        return CompletableFuture.supplyAsync(orderCallable1, executorService);
    }
    public Future<Order> getOrderWithId2(final String orderId) throws NetworkException, ServiceException {
        final Supplier<Order> orderCallable2 = getOrderCallable2(orderId);
        return CompletableFuture.supplyAsync(orderCallable2, executorService);
    }
    public Future<Order> getOrderWithId3(final String orderId) throws NetworkException, ServiceException {
        final Supplier<Order> orderCallable3 = getOrderCallable3(orderId);
        return CompletableFuture.supplyAsync(orderCallable3, executorService);
    }
    public Future<Order> getOrderWithId4(final String orderId) throws NetworkException, ServiceException {
        final Supplier<Order> orderCallable4 = getOrderCallable4(orderId);
        return CompletableFuture.supplyAsync(orderCallable4, executorService);
    }
