...
class MyClassTest {
    ...
    void testPutFoo1() {
        ...
        when(mockFooService.putFoo1(fooData1)).thenReturn(Optional.absent());
    ...
    void testPutFoo6() {
        ...
        fooData1.setId("id");
        fooData1.setName("name");
        when(mockFooService.putFoo2(fooData1)).thenReturn(Optional.absent());
    ...
    void testPutFoo6_FooServiceReturnsError() {
        ...
        final Optional<ErrorInfo> errorInfoOptional = Optional.of(errorInfo);
        final FooData fooData1 = new FooData();
        fooData1.setId("id");
        fooData1.setName("name");
        when(mockFooService.putFoo2(fooData1)).thenReturn(errorInfoOptional);
    ...
    void testPutFoo11() {
        ...
        fooData1.setId("id");
        fooData1.setName("name");
        when(mockFooService.putFoo3(fooData1)).thenReturn(Optional.absent());
    ...
    void testPutFoo16() {
        ...
        fooData1.setId("id");
        fooData1.setName("name");
        when(mockFooService.putFoo4(fooData1)).thenReturn(Optional.absent());
    ...
    void testPutFoo16_FooServiceReturnsError() {
        ...
        errorInfo.setCode("code");
        errorInfo.setDescription("description");
        final Optional<FailureInfo> failureInfoOptional = Optional.of(new FailureInfo(Arrays.asList(errorInfo)));
        final FooData fooData1 = new FooData();
        fooData1.setId("id");
        fooData1.setName("name");
        when(mockFooService.putFoo4(fooData1)).thenReturn(failureInfoOptional);
    ...
    void testPutFoo21() {
        ...
        fooData1.setId("id");
        fooData1.setName("name");
        when(mockFooService.putFoo5(fooData1)).thenReturn(Optional.absent());
    ...
    void testPutFoo26() {
        ...
        fooData1.setId("id");
        fooData1.setName("name");
        when(mockFooService.putFoo6(fooData1)).thenReturn(Optional.absent());
