...
public class MyClass {
    ...
    public String putFoo1(final String id) {
        final BeanWithAllPackageLocalMethodsAndWithMethods bean = BeanWithAllPackageLocalMethodsAndWithMethods.makeBeanWithAllPackageLocalMethodsAndWithMethods(id);
