...
class MyClassTest {
    ...
    @Test
    void testNotEmpty3() {
        assertEquals(Arrays.asList("value"), MyClass.notEmpty(Arrays.asList("value"), "message", "values"));
        assertEquals(Collections.emptyList(), MyClass.notEmpty(Arrays.asList("value"), "message", "values"));
        assertThrows(NullPointerException.class, () -> MyClass.notEmpty(Arrays.asList("value"), "message", "values"));
        assertThrows(IllegalArgumentException.class,
                () -> MyClass.notEmpty(Arrays.asList("value"), "message", "values"));
    }

    @Test
    void testNotEmpty4() {
        assertEquals(Arrays.asList("value"), MyClass.notEmpty(Arrays.asList("value")));
        assertEquals(Collections.emptyList(), MyClass.notEmpty(Arrays.asList("value")));
        assertThrows(NullPointerException.class, () -> MyClass.notEmpty(Arrays.asList("value")));
        assertThrows(IllegalArgumentException.class, () -> MyClass.notEmpty(Arrays.asList("value")));
    }
    ...
    void testNoNullElements3() {
        assertEquals(Arrays.asList("value"), MyClass.noNullElements(Arrays.asList("value"), "message", "values"));
        assertEquals(Collections.emptyList(), MyClass.noNullElements(Arrays.asList("value"), "message", "values"));
        assertThrows(NullPointerException.class,
                () -> MyClass.noNullElements(Arrays.asList("value"), "message", "values"));
        assertThrows(IllegalArgumentException.class,
                () -> MyClass.noNullElements(Arrays.asList("value"), "message", "values"));
    }
    ...
    void testNoNullElements4() {
        assertEquals(Arrays.asList("value"), MyClass.noNullElements(Arrays.asList("value")));
        assertEquals(Collections.emptyList(), MyClass.noNullElements(Arrays.asList("value")));
        assertThrows(NullPointerException.class, () -> MyClass.noNullElements(Arrays.asList("value")));
        assertThrows(IllegalArgumentException.class, () -> MyClass.noNullElements(Arrays.asList("value")));
    }
    ...
    void testValidIndex3() {
        assertEquals(Arrays.asList("value"), MyClass.validIndex(Arrays.asList("value"), 0, "message", "values"));
        assertEquals(Collections.emptyList(), MyClass.validIndex(Arrays.asList("value"), 0, "message", "values"));
        assertThrows(NullPointerException.class,
                () -> MyClass.validIndex(Arrays.asList("value"), 0, "message", "values"));
        assertThrows(IndexOutOfBoundsException.class,
                () -> MyClass.validIndex(Arrays.asList("value"), 0, "message", "values"));
    }
    ...
    void testValidIndex4() {
        assertEquals(Arrays.asList("value"), MyClass.validIndex(Arrays.asList("value"), 0));
        assertEquals(Collections.emptyList(), MyClass.validIndex(Arrays.asList("value"), 0));
        assertThrows(NullPointerException.class, () -> MyClass.validIndex(Arrays.asList("value"), 0));
        assertThrows(IndexOutOfBoundsException.class, () -> MyClass.validIndex(Arrays.asList("value"), 0));
    }
