...
class MyClassTest {
    ...
    @Test
    void testDeleteFoo4_FooServiceCanDelete1ReturnsTrue() {
        // Setup
    ...
    @Test
    void testDeleteFoo5_FooServiceCanDelete1ReturnsTrue() {
        // Setup
        when(mockFooService.canDelete1("id")).thenReturn(true);
    ...
    @Test
    void testDeleteFirstFoo1_FooServiceCanDelete1ReturnsTrue() {
        // Setup
        // Configure FooService.getFoos2(...).
        final List<FooData> fooData = Arrays.asList(new FooData("id", "name", "otherId"));
        when(mockFooService.getFoos2(FooType.Type1)).thenReturn(fooData);
    ...
    @Test
    void testDeleteFirstFoo2_FooServiceCanDelete1ReturnsTrue() {
        // Setup
        // Configure FooService.getFoos2(...).
        final List<FooData> fooData = Arrays.asList(new FooData("id", "name", "otherId"));
        when(mockFooService.getFoos2(FooType.Type1)).thenReturn(fooData);
    ...
    @Test
    void testDeleteFirstFoo3_FooServiceCanDelete1ReturnsTrue() {
        // Setup
        // Configure FooService.getFoos2(...).
        final List<FooData> fooData = Arrays.asList(new FooData("id", "name", "otherId"));
        when(mockFooService.getFoos2(FooType.Type1)).thenReturn(fooData);
    ...
    @Test
    void testDeleteFirstFoo4_FooServiceCanDelete1ReturnsTrue() {
        // Setup
        // Configure FooService.getFoos2(...).
        final List<FooData> fooData = Arrays.asList(new FooData("id", "name", "otherId"));
        when(mockFooService.getFoos2(FooType.Type1)).thenReturn(fooData);
    ...
    @Test
    void testDeleteFirstFoo5_FooServiceCanDelete1ReturnsTrue() {
        // Setup
        // Configure FooService.getFoos2(...).
        final List<FooData> fooData = Arrays.asList(new FooData("id", "name", "otherId"));
        when(mockFooService.getFoos2(FooType.Type1)).thenReturn(fooData);
    ...
    @Test
    void testDeleteFirstFoo6_FooServiceCanDelete1ReturnsTrue() {
        // Setup
        // Configure FooService.getFoos2(...).
        final List<FooData> fooData = Arrays.asList(new FooData("id", "name", "otherId"));
        when(mockFooService.getFoos2(FooType.Type1)).thenReturn(fooData);
    ...
    @Test
    void testDeleteFirstFoo7_FooServiceCanDelete1ReturnsTrue() {
        // Setup
        // Configure FooService.getFoos2(...).
        final List<FooData> fooData = Arrays.asList(new FooData("id", "name", "otherId"));
        when(mockFooService.getFoos2(FooType.Type1)).thenReturn(fooData);
    ...
    @Test
    void testDeleteFirstFoo8_FooServiceCanDelete1ReturnsTrue() {
        // Setup
        // Configure FooService.getFoos2(...).
        final List<FooData> fooData = Arrays.asList(new FooData("id", "name", "otherId"));
        when(mockFooService.getFoos2(FooType.Type1)).thenReturn(fooData);
    ...
    @Test
    void testDeleteFirstFoo9_FooServiceCanDelete1ReturnsTrue() {
        // Setup
        // Configure FooService.getFoos2(...).
        final List<FooData> fooData = Arrays.asList(new FooData("id", "name", "otherId"));
        when(mockFooService.getFoos2(FooType.Type1)).thenReturn(fooData);
    ...
    @Test
    void testDeleteFirstFoo10_FooServiceCanDelete1ReturnsTrue() {
        // Setup
        // Configure FooService.getFoos2(...).
        final List<FooData> fooData = Arrays.asList(new FooData("id", "name", "otherId"));
        when(mockFooService.getFoos2(FooType.Type1)).thenReturn(fooData);
    ...
    @Test
    void testDeleteFirstFoo11_FooServiceCanDelete1ReturnsTrue() {
        // Setup
        // Configure FooService.getFoos2(...).
        final List<FooData> fooData = Arrays.asList(new FooData("id", "name", "otherId"));
        when(mockFooService.getFoos2(FooType.Type1)).thenReturn(fooData);
    ...
    @Test
    void testDeleteFirstFoo12_FooServiceCanDelete1ReturnsTrue() throws Exception {
        // Setup
        // Configure FooService.getFoos2(...).
        final List<FooData> fooData = Arrays.asList(new FooData("id", "name", "otherId"));
        when(mockFooService.getFoos2(FooType.Type1)).thenReturn(fooData);
    ...
    @Test
    void testDeleteFirstFoo13_FooServiceCanDelete1ReturnsTrue() throws Exception {
        // Setup
        // Configure FooService.getFoos2(...).
        final List<FooData> fooData = Arrays.asList(new FooData("id", "name", "otherId"));
        when(mockFooService.getFoos2(FooType.Type1)).thenReturn(fooData);
    ...
    @Test
    void testDeleteFirstFoo14_FooServiceCanDelete1ReturnsTrue() throws Exception {
        // Setup
        // Configure FooService.getFoos2(...).
        final List<FooData> fooData = Arrays.asList(new FooData("id", "name", "otherId"));
        when(mockFooService.getFoos2(FooType.Type1)).thenReturn(fooData);
    ...
    @Test
    void testDeleteFirstFoo15_FooServiceCanDelete1ReturnsTrue() throws Exception {
        // Setup
        // Configure FooService.getFoos2(...).
        final List<FooData> fooData = Arrays.asList(new FooData("id", "name", "otherId"));
        when(mockFooService.getFoos2(FooType.Type1)).thenReturn(fooData);
    ...
    @Test
    void testDeleteFirstFoo16_FooServiceCanDelete1ReturnsTrue() throws Exception {
        // Setup
        // Configure FooService.getFoos2(...).
        final List<FooData> fooData = Arrays.asList(new FooData("id", "name", "otherId"));
        when(mockFooService.getFoos2(FooType.Type1)).thenReturn(fooData);
    ...
    @Test
    void testDeleteFirstFoo17_FooServiceCanDelete1ReturnsTrue() throws Exception {
        // Setup
        // Configure FooService.getFoos2(...).
        final List<FooData> fooData = Arrays.asList(new FooData("id", "name", "otherId"));
        when(mockFooService.getFoos2(FooType.Type1)).thenReturn(fooData);
    ...
    @Test
    void testDeleteFirstFoo18_FooServiceCanDelete1ReturnsTrue() throws Exception {
        // Setup
        // Configure FooService.getFoos2(...).
        final List<FooData> fooData = Arrays.asList(new FooData("id", "name", "otherId"));
        when(mockFooService.getFoos2(FooType.Type1)).thenReturn(fooData);
