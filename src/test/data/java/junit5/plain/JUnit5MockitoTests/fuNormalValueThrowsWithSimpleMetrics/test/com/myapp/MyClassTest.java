...
class MyClassTest {
    ...
    void testStoreFoo1_ThrowsFooAlreadyExistsException() {
        ...
        final Optional<FooData> fooData1 = Optional.of(new FooData("fooId", "name"));
        when(mockFooService.getFooData1("fooId")).thenReturn(fooData1);

        // Configure OldService.getFooData1(...).
        final Optional<FooData> fooData2 = Optional.of(new FooData("fooId", "name"));
        when(mockOldService.getFooData1("fooId")).thenReturn(fooData2);

        // Run the test
        assertThrows(FooAlreadyExistsException.class, () -> myClassUnderTest.storeFoo1(fooData));
        verify(mockMetricService).recordStoreFooCalled("fooId");
        verify(mockMetricService).recordExistingFooCallReturned("fooId");
        verify(mockMetricService).recordStoreFooExistingFooFound("fooId");
    }
    ...
    void testStoreFoo1_FooServiceGetFooData1ReturnsAbsent() {
        // Setup
        final FooData fooData = new FooData("fooId", "name");
        when(mockFooService.getFooData1("fooId")).thenReturn(Optional.empty());

        // Configure OldService.getFooData1(...).
        final Optional<FooData> fooData1 = Optional.of(new FooData("fooId", "name"));
        when(mockOldService.getFooData1("fooId")).thenReturn(fooData1);
    ...
    void testStoreFoo1_OldServiceReturnsAbsent() throws Exception {
        ...
        when(mockFooService.getFooData1("fooId")).thenReturn(Optional.empty());
        when(mockOldService.getFooData1("fooId")).thenReturn(Optional.empty());
        ...
        verify(mockMetricService).recordStoreFooCalled("fooId");
        verify(mockMetricService).recordExistingFooCallReturned("fooId");
        verify(mockMetricService).recordActuallyStoringFoo("fooId");
    }
    ...
    void testStoreFoo2_ThrowsFooAlreadyExistsException() {
        ...
        verify(mockMetricService).recordStoreFooCalled("fooId");
        verify(mockMetricService).recordAuthorized("fooId");
        verify(mockMetricService).recordExistingFooCallReturned("fooId");
        verify(mockMetricService).recordStoreFooExistingFooFound("fooId");
    }
    ...
    void testStoreFoo2_AuthServiceReturnsNoItems() {
        ...
        verify(mockMetricService).recordStoreFooCalled("fooId");
        verify(mockMetricService).recordNotAuthorized("fooId");
    }
    ...
    void testStoreFoo3_ThrowsFooAlreadyExistsException() throws Exception {
        ...
        verify(mockMetricService).recordStoreFooCalled("fooId");
        verify(mockMetricService).recordCallingFooService("fooId");
        verify(mockMetricService).recordExistingFooCallReturned("fooId");
        verify(mockMetricService).recordStoreFooExistingFooFound("fooId");
    }
    ...
    void testStoreFoo3_FooServiceGetFooData2ThrowsFooNotFoundException() throws Exception {
        ...
        verify(mockMetricService).recordStoreFooCalled("fooId");
        verify(mockMetricService).recordCallingFooService("fooId");
        verify(mockMetricService).recordCallingOldFooService("fooId");
        verify(mockMetricService).recordExistingFooCallReturned("fooId");
        verify(mockMetricService).recordStoreFooExistingFooFound("fooId");
    }
    ...
    void testStoreFoo3_OldServiceThrowsFooNotFoundException() throws Exception {
        ...
        verify(mockMetricService).recordCallingFooService("fooId");
        verify(mockMetricService).recordCallingOldFooService("fooId");
        verify(mockMetricService).recordFooNotFound("fooId");
        verify(mockMetricService).recordExistingFooCallReturned("fooId");
        verify(mockMetricService).recordActuallyStoringFoo("fooId");
    }
    ...
    void testStoreFoo5_FooServiceGetFooData2ThrowsFooNotFoundException() throws Exception {
        ...
        verify(mockMetricService).recordStoreFooCalled("fooId");
        verify(mockMetricService).recordCallingFooService("fooId");
        verify(mockMetricService).recordFooNotFoundInFooService("fooId");
        verify(mockMetricService).recordCallingOldFooService("fooId");
        verify(mockMetricService).recordExistingFooCallReturned("fooId");
        verify(mockMetricService).recordStoreFooExistingFooFound("fooId");
    }
    ...
    void testStoreFoo5_OldServiceThrowsFooNotFoundException() throws Exception {
        ...
        verify(mockMetricService).recordCallingFooService("fooId");
        verify(mockMetricService).recordCallingOldFooService("fooId");
        verify(mockMetricService).recordFooNotFoundInOldService("fooId");
        verify(mockMetricService).recordExistingFooCallReturned("fooId");
        verify(mockMetricService).recordActuallyStoringFoo("fooId");
    }
    ...
    void testStoreFoo7_ThrowsFooAlreadyExistsException() throws Exception {
        ...
        verify(mockMetricService).recordStoreFooCalled("fooId");
        verify(mockMetricService).recordCallingFooService("fooId");
        verify(mockMetricService).recordFinishedCallingServiceHelper1("fooId");
        verify(mockMetricService).recordExistingFooCallReturned("fooId");
        verify(mockMetricService).recordStoreFooExistingFooFound("fooId");
    }
    ...
    void testStoreFoo7_FooServiceGetFooData2ThrowsFooNotFoundException() throws Exception {
        ...
        verify(mockMetricService).recordFinishedCallingServiceHelper1("fooId");
        verify(mockMetricService).recordCallingOldFooService("fooId");
        verify(mockMetricService).recordFinishedCallingOldServiceHelper1("fooId");
        verify(mockMetricService).recordExistingFooCallReturned("fooId");
        verify(mockMetricService).recordStoreFooExistingFooFound("fooId");
    }
