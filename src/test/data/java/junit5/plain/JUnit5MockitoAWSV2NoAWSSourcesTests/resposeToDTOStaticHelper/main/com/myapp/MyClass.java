...
public class MyClass {
    ...
    public String tryBatchWriteItem1() {
        ...
        GlobalTableHelper.printUnprocessedItems(result);
    ...
    public void tryCreateBackup1(final String backupNameParam) {
        final CreateBackupRequest createBackupRequest = GlobalTableHelper.getCreateBackupRequest(backupNameParam);
    ...
    public GlobalTableDTO tryCreateGlobalTable1(final String tableNameParam, final String regionNameParam) {
        final CreateGlobalTableRequest createGlobalTableRequest = GlobalTableHelper.getCreateGlobalTableRequest(tableNameParam, regionNameParam);
