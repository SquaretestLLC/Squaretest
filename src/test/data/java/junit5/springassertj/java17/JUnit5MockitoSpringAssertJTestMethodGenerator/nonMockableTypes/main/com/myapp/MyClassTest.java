...
class MyClassTest {
    ...
    @BeforeEach
    void setUp() {
        myClassUnderTest = new MyClass(new FinalFoo(), new MyClass.StaticFoo(), EnumFoo.RED, new Object[]{}, 0, "someOtherObjects");
    }
    ...
    void testPerformWithArrayListener() {
        // Setup
        // Run the test
        myClassUnderTest.performWithArrayListener(new Object[]{});
