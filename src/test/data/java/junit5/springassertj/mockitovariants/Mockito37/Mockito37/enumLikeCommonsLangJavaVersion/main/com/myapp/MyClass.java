...
public enum MyClass {
     ...
     */
    MyClass(final float value, final String name) {
        this.value = value;
        this.name = name;
    }
     ...
     *
     * <p>For example:<br>
     *  {@code myVersion.atLeast(MyClass.JAVA_1_4)}<p>
     *
     * @param requiredVersion  the version to check against, not null
     * @return true if this version is equal to or greater than the specified version
     */
    public boolean atLeast(final MyClass requiredVersion) {
     ...
     *
     * <p>For example:<br>
     *  {@code myVersion.atMost(MyClass.JAVA_1_4)}<p>
     *
     * @param requiredVersion  the version to check against, not null
     * @return true if this version is equal to or greater than the specified version
     * @since 3.9
     */
    public boolean atMost(final MyClass requiredVersion) {
        return this.value <= requiredVersion.value;
    }
    ...
    static MyClass getJavaVersion(final String nom) {
        return get(nom);
    }
     ...
     * version is unknown
     */
    static MyClass get(final String nom) {
        if (nom == null) {
            return null;
