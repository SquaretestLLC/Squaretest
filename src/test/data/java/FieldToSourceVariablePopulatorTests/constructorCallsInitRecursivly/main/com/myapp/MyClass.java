...
public class MyClass {
    ...
    public MyClass(
            final UserServiceAdapter userServiceAdapter, final ExecutorService executorService, final Foo foo,
            final Logger logger) {
        init(userServiceAdapter, executorService, foo, logger);
    }
    ...
    private void init(
        ...
        this.foo = foo;
        this.logger = logger;
        init2(userServiceAdapter, executorService, foo, logger);
    }
