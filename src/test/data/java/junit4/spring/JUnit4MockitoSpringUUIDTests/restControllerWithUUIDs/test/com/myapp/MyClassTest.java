...
public class MyClassTest {
    ...
    public void testGetDeal() throws Exception {
        ...
        when(mockDealsProvider.getDealForId(UUID.fromString("73636563-d2a2-4890-8a0b-fc2460bda4dc"))).thenReturn(deal);

        // Run the test and verify the results
        mockMvc.perform(get("/deals/getDeal")
                        .param("dealId", "73636563-d2a2-4890-8a0b-fc2460bda4dc")
