...
public class MyClassTest {
    ...
    @Test
    public void testGetFooById_FooServiceSafeGetFooDataByIdReturnsNull() throws Exception {
        // Setup
    ...
    @Test
    public void testGetFooByIdOpt_FooServiceGetFooDataByIdOptReturnsAbsent() throws Exception {
        // Setup
    ...
    @Test
    public void testGetFooByIdOpt1_FooServiceGetFooDataByIdOptReturnsAbsent() throws Exception {
        // Setup
        when(mockFooService.getFooDataByIdOpt(0L)).thenReturn(Optional.empty());
    ...
    @Test
    public void testGetFooByIdOpt1_FooServiceSaveFoo1ThrowsRuntimeException() throws Exception {
        // Setup
        // Configure FooService.getFooDataByIdOpt(...).
        final Optional<FooData> fooData = Optional.of(
                new FooData(0L, "name", "shortDisplayName", LocalDateTime.of(2020, 1, 1, 0, 0, 0),
