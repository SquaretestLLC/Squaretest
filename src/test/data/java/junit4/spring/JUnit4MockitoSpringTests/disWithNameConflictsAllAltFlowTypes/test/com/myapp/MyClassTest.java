...
public class MyClassTest {
    ...
    public void testGetFooData1_FooServiceGetFooData1ThrowsFooServiceException() {
        // Setup
    ...
    @Test(expected = FooServiceException.class)
    public void testGetFooData1_FooServiceGetFooData2ThrowsFooServiceException() {
        // Setup
    ...
    @Test
    public void testGetFooData2_FooServiceGetFooDataOpt1ReturnsAbsent() {
        // Setup
    ...
    @Test
    public void testGetFooData2_FooServiceGetFooDataOpt2ReturnsAbsent() {
        // Setup
    ...
    @Test
    public void testGetFooData3_FooServiceGetFooDataList1ReturnsNoItems() {
        // Setup
    ...
    @Test
    public void testGetFooData3_FooServiceGetFooDataList2ReturnsNoItems() {
        // Setup
    ...
    @Test
    public void testGetFooData4_FooServiceGetFooDataFuture1ReturnsFailure() {
        // Setup
        // Configure FooService.getFooDataFuture(...).
    ...
    @Test
    public void testGetFooData4_FooServiceGetFooDataFuture2ReturnsFailure() {
        // Setup
        // Configure FooService.getFooDataFuture(...).
        final CompletableFuture<FooData> fooDataCompletableFuture = new CompletableFuture<>();
        fooDataCompletableFuture.completeExceptionally(new Exception("message"));
    ...
    @Test
    public void testGetFooData_FooServiceGetFooDataStream1ReturnsNoContent() throws Exception {
        // Setup
        // Configure FooService.getFooDataStream(...).
    ...
    public void testGetFooData_FooServiceGetFooDataStream1ReturnsBrokenIo() throws Exception {
        // Setup
        // Configure FooService.getFooDataStream(...).
    ...
    @Test
    public void testGetFooData_FooServiceGetFooDataStream2ReturnsNoContent() throws Exception {
        // Setup
        // Configure FooService.getFooDataStream(...).
        final InputStream spyInputStream = spy(new ByteArrayInputStream(new byte[]{}));
    ...
    @Test(expected = IOException.class)
    public void testGetFooData_FooServiceGetFooDataStream2ReturnsBrokenIo() throws Exception {
        // Setup
        // Configure FooService.getFooDataStream(...).
        final InputStream spyInputStream = spy(new InputStream() {
            private final IOException exception = new IOException("Error");
