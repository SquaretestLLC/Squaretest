...
public class MyClass {
    ...
    public SettableListenableFuture<SimpleBean> createSettableFutureOfBean(String key) {
        return foo.createSettableFutureOfBean(key);
    }

    public SettableListenableFuture<? extends SimpleBean> createSettableFutureOfBeanSubtype(String key) {
    ...
    public SettableListenableFuture<List<SimpleBean>> createSettableFutureOfListOfBean(String key) {
    ...
    public SettableListenableFuture<SettableListenableFuture<SimpleBean>> createNestedSettableFutureOfBean(String key) {
    ...
    public SettableListenableFuture<Bar> createSettableFutureOfBar(String key) {
    ...
    public SettableListenableFuture<?> createSettableFutureOfUnknown(String key) {
        return foo.createSettableFutureOfUnknown(key);
    }

    public SettableListenableFuture<List<?>> createSettableFutureOfListOfUnknown(String key) {
    ...
    public SettableListenableFuture<Integer> createSettableFutureOfInt(String key) {
    ...
    public SettableListenableFuture createSettableFutureOfNoType(String key) {
    ...
    public SettableListenableFuture<String[]> createSettableFutureOfStringArray(String key) {
