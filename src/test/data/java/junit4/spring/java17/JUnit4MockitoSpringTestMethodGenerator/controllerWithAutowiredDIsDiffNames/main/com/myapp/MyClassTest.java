...
class MyClassTest {
    ...
    void testGreeting() throws Exception {
        // Setup
        // Run the test
        final MockHttpServletResponse response = theMockMvc.perform(post("/greeting")
                        .param("id", "0")
                        .param("name", "name")
    ...
    void testGreeting1() throws Exception {
        // Setup
        // Run the test
        final MockHttpServletResponse response = theMockMvc.perform(post("/greeting1")
                        .locale(Locale.US)
    ...
    void testGreeting2() throws Exception {
        // Setup
        // Run the test
        final MockHttpServletResponse response = theMockMvc.perform(post("/greeting2")
                        .locale(Locale.US)
                        .param("id", "0")
                        .param("name", "name")
                        .param("shortDisplayName", "shortDisplayName")
    ...
    void testGreetAll() throws Exception {
        ...
        // Run the test
        final MockHttpServletResponse response = theMockMvc.perform(post("/greetAll")
                        .param("id", "0")
                        .param("name", "name")
                        .param("shortDisplayName", "shortDisplayName")
                        .param("startDate", "startDate")
