...
class MyClassTest {
    ...
    // Ensure executorService2 is before executorService1 so that this test won't "work" just because the fields are
    // in the correct order.
    @Mock(name = "executorService2")
    private ExecutorService secondExecService;
    @Mock
    private UserServiceAdapter mockUserServiceAdapter;
    @Mock(name = "executorService1")
