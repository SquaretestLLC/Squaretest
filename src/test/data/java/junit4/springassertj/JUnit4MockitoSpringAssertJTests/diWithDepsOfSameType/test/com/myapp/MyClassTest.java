...
public class MyClassTest {
    ...
    public void testGetFooData_NewFooServiceThrowsFooServiceException() {
        ...
        // Run the test
        assertThatThrownBy(() -> myClassUnderTest.getFooData(0)).isInstanceOf(FooServiceException.class);
    }
    ...
    public void testGetFooData_NewFooServiceThrowsFooNetworkException() {
        ...
        // Run the test
        assertThatThrownBy(() -> myClassUnderTest.getFooData(0)).isInstanceOf(FooNetworkException.class);
    }
