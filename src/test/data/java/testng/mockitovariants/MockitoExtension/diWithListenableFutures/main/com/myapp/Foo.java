...
public class Foo {
    ...
    public ListenableFuture<Optional<String>> createListenableFutureOfOptionalString(final String key) {
        return SettableFuture.create();
    }
    public SettableFuture<Optional<String>> createSettableFutureOfOptionalString(final String key) {
        return SettableFuture.create();
    }
    public ListenableFuture<Optional<SimpleBean>> createListenableFutureOfOptionalSimpleBean(final String key) {
        return SettableFuture.create();
    }
    public SettableFuture<Optional<SimpleBean>> createSettableFutureOfOptionalSimpleBean(final String key) {
        return SettableFuture.create();
    }
}