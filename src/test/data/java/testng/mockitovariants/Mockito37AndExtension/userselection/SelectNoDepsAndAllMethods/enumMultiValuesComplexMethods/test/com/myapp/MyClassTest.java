...
public class MyClassTest {
    ...
    public void testName() {
        assertEquals("name", MyClass.PRIMARY.name());
        assertEquals("name", MyClass.SECONDARY.name());
    }

    @Test
    public void testOrdinal() {
        assertEquals(0, MyClass.PRIMARY.ordinal());
        assertEquals(0, MyClass.SECONDARY.ordinal());
    }

    @Test
    public void testToString() {
        assertEquals("name", MyClass.PRIMARY.toString());
        assertEquals("name", MyClass.SECONDARY.toString());
    }
    ...
    public void testHashCode() {
        assertEquals(0, MyClass.PRIMARY.hashCode());
        assertEquals(0, MyClass.SECONDARY.hashCode());
    }

    @Test
    public void testCompareTo() {
        assertEquals(0, MyClass.PRIMARY.compareTo(MyClass.PRIMARY));
        assertEquals(0, MyClass.SECONDARY.compareTo(MyClass.PRIMARY));
    }

    @Test
    public void testCompareTo_ThrowsNullPointerException() {
        assertThrows(NullPointerException.class, () -> MyClass.PRIMARY.compareTo(MyClass.PRIMARY));
        assertThrows(NullPointerException.class, () -> MyClass.SECONDARY.compareTo(MyClass.PRIMARY));
    }

    @Test
    public void testCompareTo_ThrowsClassCastException() {
        assertThrows(ClassCastException.class, () -> MyClass.PRIMARY.compareTo(MyClass.PRIMARY));
        assertThrows(ClassCastException.class, () -> MyClass.SECONDARY.compareTo(MyClass.PRIMARY));
    }

    @Test
    public void testGetDeclaringClass() {
        assertEquals(MyClass.class, MyClass.PRIMARY.getDeclaringClass());
        assertEquals(MyClass.class, MyClass.SECONDARY.getDeclaringClass());
    }

    @Test
    public void testValueOf() {
        assertEquals(MyClass.PRIMARY, Enum.valueOf(MyClass.class, "name"));
