...
public class MyClassTest {
    ...
    @Test
    public void testStoreFoo1_MyValidatorReturnsFailure() {
        // Setup
        final MyClass myClassUnderTest = new MyClass(mockFooService, mockValidator, mockMetrics, mockUnmockableMetrics);
        final FooData fooData = new FooData("id", "name");
    ...
    @Test
    public void testStoreFoo2_MyValidatorReturnsFailure() {
        // Setup
        final MyClass myClassUnderTest = new MyClass(mockFooService, mockValidator, mockMetrics, mockUnmockableMetrics);
        final FooData fooData = new FooData("id", "name");
    ...
    @Test
    public void testStoreFoo3_MyValidatorReturnsFailure() {
        // Setup
        final MyClass myClassUnderTest = new MyClass(mockFooService, mockValidator, mockMetrics, mockUnmockableMetrics);
        final FooData fooData = new FooData("id", "name");
    ...
    @Test
    public void testStoreFoo4_MyValidatorReturnsFailure() {
        // Setup
        final MyClass myClassUnderTest = new MyClass(mockFooService, mockValidator, mockMetrics, mockUnmockableMetrics);
        final FooData fooData = new FooData("id", "name");
    ...
    @Test
    public void testStoreFoo5_MyValidatorReturnsFailure() {
        // Setup
        final MyClass myClassUnderTest = new MyClass(mockFooService, mockValidator, mockMetrics, mockUnmockableMetrics);
        final FooData fooData = new FooData("id", "name");
    ...
    @Test
    public void testStoreFoo6_MyValidatorReturnsFailure() {
        // Setup
        final MyClass myClassUnderTest = new MyClass(mockFooService, mockValidator, mockMetrics, mockUnmockableMetrics);
        final FooData fooData = new FooData("id", "name");
    ...
    @Test
    public void testStoreFoo7_MyValidatorReturnsFailure() {
        // Setup
        final MyClass myClassUnderTest = new MyClass(mockFooService, mockValidator, mockMetrics, mockUnmockableMetrics);
        final FooData fooData = new FooData("id", "name");
    ...
    @Test
    public void testStoreFoo8_MyValidatorReturnsFailure() {
        // Setup
        final MyClass myClassUnderTest = new MyClass(mockFooService, mockValidator, mockMetrics, mockUnmockableMetrics);
        final FooData fooData = new FooData("id", "name");
    ...
    @Test
    public void testStoreFoo9_MyValidatorReturnsFailure() {
        // Setup
        final MyClass myClassUnderTest = new MyClass(mockFooService, mockValidator, mockMetrics, mockUnmockableMetrics);
        final FooData fooData = new FooData("id", "name");
    ...
    @Test
    public void testStoreFoo10_MyValidatorReturnsFailure() {
        // Setup
        final MyClass myClassUnderTest = new MyClass(mockFooService, mockValidator, mockMetrics, mockUnmockableMetrics);
        final FooData fooData = new FooData("id", "name");
