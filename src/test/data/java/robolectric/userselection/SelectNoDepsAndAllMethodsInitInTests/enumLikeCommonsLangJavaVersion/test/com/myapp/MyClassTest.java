...
public class MyClassTest {
    ...
    public void testName() {
        assertEquals("result", MyClass.JAVA_0_9.name());
        assertEquals("result", MyClass.JAVA_1_1.name());
        assertEquals("result", MyClass.JAVA_1_2.name());
        assertEquals("result", MyClass.JAVA_1_3.name());
        assertEquals("result", MyClass.JAVA_1_4.name());
        assertEquals("result", MyClass.JAVA_1_5.name());
        assertEquals("result", MyClass.JAVA_1_6.name());
        assertEquals("result", MyClass.JAVA_1_7.name());
        assertEquals("result", MyClass.JAVA_1_8.name());
        assertEquals("result", MyClass.JAVA_1_9.name());
        assertEquals("result", MyClass.JAVA_9.name());
        assertEquals("result", MyClass.JAVA_10.name());
        assertEquals("result", MyClass.JAVA_11.name());
        assertEquals("result", MyClass.JAVA_12.name());
        assertEquals("result", MyClass.JAVA_13.name());
        assertEquals("result", MyClass.JAVA_14.name());
        assertEquals("result", MyClass.JAVA_15.name());
        assertEquals("result", MyClass.JAVA_16.name());
        assertEquals("result", MyClass.JAVA_RECENT.name());
    }
