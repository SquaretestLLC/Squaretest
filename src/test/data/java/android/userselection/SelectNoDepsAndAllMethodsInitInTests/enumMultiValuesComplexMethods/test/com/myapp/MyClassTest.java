...
public class MyClassTest {
    ...
    public void testName() {
        assertEquals("result", MyClass.PRIMARY.name());
        assertEquals("result", MyClass.SECONDARY.name());
    }
    ...
    public void testToString() {
        assertEquals("result", MyClass.PRIMARY.toString());
        assertEquals("result", MyClass.SECONDARY.toString());
    }
