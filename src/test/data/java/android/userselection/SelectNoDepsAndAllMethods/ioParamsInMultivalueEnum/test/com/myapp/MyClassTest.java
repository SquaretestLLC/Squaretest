...
public class MyClassTest {
    ...
    public void testName() {
        assertEquals("result", MyClass.INSTANCE1.name());
        assertEquals("result", MyClass.INSTANCE2.name());
    }
    ...
    public void testToString() {
        assertEquals("result", MyClass.INSTANCE1.toString());
        assertEquals("result", MyClass.INSTANCE2.toString());
    }
