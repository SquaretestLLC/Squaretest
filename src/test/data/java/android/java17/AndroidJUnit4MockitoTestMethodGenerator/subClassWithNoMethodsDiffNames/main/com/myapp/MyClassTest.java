...
class MyClassTest {
    ...
    void testGetItems1() {
        // Setup
        when(theMockFooService.getItems("bucketName")).thenReturn(Arrays.asList("value"));
    ...
    void testGetItems2() {
        // Setup
        when(theMockFooService.getItems("bucketName", "criteria")).thenReturn(Arrays.asList("value"));
