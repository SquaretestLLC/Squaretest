...
public class MyClass {
    ...
    public List<String> getLongNamesRequiredForType() {
        return canonicalNamesRequiredForType.stream().filter(name -> name.length() > 10).collect(Collectors.toList());
    }
    ...
    public String getCanonicalTextUpper() {
        return canonicalText.toUpperCase();
    }
