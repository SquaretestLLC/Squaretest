...
public class MyClass {
    ...
    public void tryMarshallIntoObjects() {
        final List<Map<String, AttributeValue>> itemAttributes = Arrays.asList();
        final DynamoDBMapperConfig config = DynamoDBMapperConfig.builder().build();
    ...
    public void tryBatchWrite() {
        final Iterable<? extends Object> objectsToWrite = Arrays.asList();
        final Iterable<? extends Object> objectsToDelete = Arrays.asList();
        final DynamoDBMapperConfig config = DynamoDBMapperConfig.builder().build();
    ...
    public void tryBatchLoad() {
        final Iterable<? extends Object> itemsToGet = Arrays.asList();
        final DynamoDBMapperConfig config = DynamoDBMapperConfig.builder().build();
