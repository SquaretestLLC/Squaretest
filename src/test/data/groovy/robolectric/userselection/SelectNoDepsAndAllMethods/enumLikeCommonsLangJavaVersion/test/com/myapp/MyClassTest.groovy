...
class MyClassTest {
    ...
    @Test
    void testName() {
        assert "result" == MyClass.JAVA_0_9.name()
        assert "result" == MyClass.JAVA_1_1.name()
        assert "result" == MyClass.JAVA_1_2.name()
        assert "result" == MyClass.JAVA_1_3.name()
        assert "result" == MyClass.JAVA_1_4.name()
        assert "result" == MyClass.JAVA_1_5.name()
        assert "result" == MyClass.JAVA_1_6.name()
        assert "result" == MyClass.JAVA_1_7.name()
        assert "result" == MyClass.JAVA_1_8.name()
        assert "result" == MyClass.JAVA_1_9.name()
        assert "result" == MyClass.JAVA_9.name()
        assert "result" == MyClass.JAVA_10.name()
        assert "result" == MyClass.JAVA_11.name()
        assert "result" == MyClass.JAVA_12.name()
        assert "result" == MyClass.JAVA_13.name()
        assert "result" == MyClass.JAVA_14.name()
        assert "result" == MyClass.JAVA_15.name()
        assert "result" == MyClass.JAVA_16.name()
        assert "result" == MyClass.JAVA_RECENT.name()
    }
