...
public class SuperBase {
    ...
    public List<String> getItems(final String criteria, final String otherData) {
        return fooService.getItems(bucketName, criteria, otherData);
    }

    public List<String> getItems(final String criteria, final String otherData, final String thirdData) {
