...
public class MyClass {
    ...
    public void generateCreateTableRequest() {
        dynamoDBMapper.generateCreateTableRequest(StoredOrder.class, DynamoDBMapperConfig.DEFAULT);
    }

    public void generateDeleteTableRequest() {
        dynamoDBMapper.generateDeleteTableRequest(StoredOrder.class, DynamoDBMapperConfig.DEFAULT);
    }

    public void getTableModel() {
        dynamoDBMapper.getTableModel(StoredOrder.class, DynamoDBMapperConfig.DEFAULT);
    }

    public void marshallIntoObject() {
        dynamoDBMapper.marshallIntoObject(StoredOrder.class, new HashMap<>(), DynamoDBMapperConfig.DEFAULT);
    }
    ...
    public List<StoredOrder> getAllWithQueryOrders() {
