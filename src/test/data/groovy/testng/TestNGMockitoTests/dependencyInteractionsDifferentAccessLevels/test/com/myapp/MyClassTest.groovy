...
class MyClassTest {
    ...
    void testDoSomethingWithStringProtected() {
        assert "result" == MyClass.doSomethingWithStringProtected("str")
    }

    @Test
    void testDoSomethingWithStringPackageLocal() {
        assert "result" == MyClass.doSomethingWithStringPackageLocal("str")
    }

    @Test
    void testDoSomethingWithString() {
        assert "result" == MyClass.doSomethingWithString("str")
    }
