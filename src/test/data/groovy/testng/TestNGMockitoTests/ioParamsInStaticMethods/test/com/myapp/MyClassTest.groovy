...
class MyClassTest {
    ...
    @Test(expectedExceptions = [IOException.class])
    void testResourceToByteArray1_ThrowsIOException() {
    ...
    @Test(expectedExceptions = [IOException.class])
    void testResourceToString1_ThrowsIOException() {
    ...
    @Test(expectedExceptions = [IOException.class])
    void testResourceToURL1_ThrowsIOException() {
    ...
    @Test(expectedExceptions = [IOException.class])
    void testToByteArray7_ThrowsIOException() {
        MyClass.toByteArray("input")
    }

    @Test(expectedExceptions = [NullPointerException.class])
    void testToByteArray7_ThrowsNullPointerException() {
        MyClass.toByteArray("input")
    }
    ...
    @Test(expectedExceptions = [IOException.class])
    void testToByteArray8_ThrowsIOException() {
        MyClass.toByteArray(new URI("https://example.com/"))
    }

    @Test(expectedExceptions = [NullPointerException.class])
    void testToByteArray8_ThrowsNullPointerException() {
        MyClass.toByteArray(new URI("https://example.com/"))
    }
    ...
    @Test(expectedExceptions = [IOException.class])
    void testToByteArray9_ThrowsIOException() {
        MyClass.toByteArray(new URL("https://example.com/"))
    }

    @Test(expectedExceptions = [NullPointerException.class])
    void testToByteArray9_ThrowsNullPointerException() {
        MyClass.toByteArray(new URL("https://example.com/"))
    }
    ...
    @Test(expectedExceptions = [IOException.class])
    void testToString1_ThrowsIOException() {
        MyClass.toString("content".getBytes())
    }

    @Test(expectedExceptions = [NullPointerException.class])
    void testToString1_ThrowsNullPointerException() {
        MyClass.toString("content".getBytes())
    }
    ...
    @Test(expectedExceptions = [IOException.class])
    void testToString2_ThrowsIOException() {
        MyClass.toString("content".getBytes(), "UTF-8")
    }

    @Test(expectedExceptions = [NullPointerException.class])
    void testToString2_ThrowsNullPointerException() {
        MyClass.toString("content".getBytes(), "UTF-8")
    }
    ...
    @Test(expectedExceptions = [IOException.class])
    void testToString7_ThrowsIOException() {
    ...
    @Test(expectedExceptions = [IOException.class])
    void testToString8_ThrowsIOException() {
    ...
    @Test(expectedExceptions = [IOException.class])
    void testToString9_ThrowsIOException() {
        MyClass.toString(new URI("https://example.com/"), "UTF-8")
    }

    @Test(expectedExceptions = [UnsupportedCharsetException.class])
    void testToString9_ThrowsUnsupportedCharsetException() {
        MyClass.toString(new URI("https://example.com/"), "UTF-8")
    }
    ...
    @Test(expectedExceptions = [IOException.class])
    void testToString10_ThrowsIOException() {
    ...
    @Test(expectedExceptions = [IOException.class])
    void testToString11_ThrowsIOException() {
    ...
    @Test(expectedExceptions = [IOException.class])
    void testToString12_ThrowsIOException() {
        MyClass.toString(new URL("https://example.com/"), "UTF-8")
    }

    @Test(expectedExceptions = [UnsupportedCharsetException.class])
    void testToString12_ThrowsUnsupportedCharsetException() {
        MyClass.toString(new URL("https://example.com/"), "UTF-8")
    }
