...
public class Bean {
    ...
    private OtherSubBean[] otherBeanArray;
    private OtherSubBean[][] otherBeanMatrix;
    ...
    public OtherSubBean[][] getOtherBeanMatrix() {
        return otherBeanMatrix;
    }

    public void setOtherBeanMatrix(OtherSubBean[][] otherBeanMatrix) {
        this.otherBeanMatrix = otherBeanMatrix;
    }

    public OtherSubBean[] getOtherBeanArray() {
        return otherBeanArray;
    }

    public void setOtherBeanArray(OtherSubBean[] otherBeanArray) {
        this.otherBeanArray = otherBeanArray;
    }
