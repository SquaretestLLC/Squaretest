...
public class MyClass {
    ...
    final SubListeningExecutorService executorService;
    final Logger logger;
    final Foo foo;
    ...
    public Future<User> doSomethingWithCompletable(final String userId) {
        try {
            return foo.submitWithCompletable(() -> getUserWithIdSync("userId"));
        } catch (Exception e) {
