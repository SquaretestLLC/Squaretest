...
public class MyClass {
    ...
    private static FooService epsilonService;
    // Package static field should be ignored.
    static FooService zetaService;
    ...
    private FooService alphaService;
    // Has Autowired setter that should be invoked.
    private FooService deltaService;
    ...
    public MyClass(FooService fooService, FooService barService, FooService gammaService, String defaultBarId) {
    ...
    @Autowired
    public void setDeltaService(FooService deltaService) {
    ...
    public static void setEpsilonService(FooService epsilonService) {
