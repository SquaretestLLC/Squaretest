...
@RestController
@RequestMapping(path={MyClass.BasePath, MyClass.OtherBasePath})
public class MyClass {

    public static final String BasePath = "/baseDeals/";
    public static final String OtherBasePath = "/baseDeals2/";
