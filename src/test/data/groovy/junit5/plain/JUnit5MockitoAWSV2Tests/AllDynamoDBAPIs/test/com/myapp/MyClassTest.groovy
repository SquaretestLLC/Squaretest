...
class MyClassTest {
    ...
    void testTryBatchGetItem() {
        ...
        def batchGetItemResponse = BatchGetItemResponse.builder()
                .responses([:]).build()
        when(mockDynamoDbClient.batchGetItem(BatchGetItemRequest.builder()
                .requestItems([:]).build())).thenReturn(batchGetItemResponse)
    ...
    void testTryBatchGetItem_DynamoDbClientReturnsNoItems() {
        // Setup
        when(mockDynamoDbClient.batchGetItem(BatchGetItemRequest.builder()
                .requestItems([:]).build())).thenReturn(BatchGetItemResponse.builder().build())
    ...
    void testTryBatchGetItem_DynamoDbClientThrowsProvisionedThroughputExceededException() {
        // Setup
        when(mockDynamoDbClient.batchGetItem(BatchGetItemRequest.builder()
                .requestItems([:]).build())).thenThrow(ProvisionedThroughputExceededException.class)
    ...
    void testTryBatchGetItem_DynamoDbClientThrowsResourceNotFoundException() {
        // Setup
        when(mockDynamoDbClient.batchGetItem(BatchGetItemRequest.builder()
                .requestItems([:]).build())).thenThrow(ResourceNotFoundException.class)
    ...
    void testTryBatchGetItem_DynamoDbClientThrowsRequestLimitExceededException() {
        // Setup
        when(mockDynamoDbClient.batchGetItem(BatchGetItemRequest.builder()
                .requestItems([:]).build())).thenThrow(RequestLimitExceededException.class)
    ...
    void testTryBatchGetItem_DynamoDbClientThrowsInternalServerErrorException() {
        // Setup
        when(mockDynamoDbClient.batchGetItem(BatchGetItemRequest.builder()
                .requestItems([:]).build())).thenThrow(InternalServerErrorException.class)
    ...
    void testTryBatchGetItem_DynamoDbClientThrowsAwsServiceException() {
        // Setup
        when(mockDynamoDbClient.batchGetItem(BatchGetItemRequest.builder()
                .requestItems([:]).build())).thenThrow(AwsServiceException.class)
    ...
    void testTryBatchGetItem_DynamoDbClientThrowsSdkClientException() {
        // Setup
        when(mockDynamoDbClient.batchGetItem(BatchGetItemRequest.builder()
                .requestItems([:]).build())).thenThrow(SdkClientException.class)
    ...
    void testTryBatchGetItem_DynamoDbClientThrowsDynamoDbException() {
        // Setup
        when(mockDynamoDbClient.batchGetItem(BatchGetItemRequest.builder()
                .requestItems([:]).build())).thenThrow(DynamoDbException.class)
    ...
    void testTryBatchGetItemPaginator() {
        ...
        def mockBatchGetItemIterable = mock(BatchGetItemIterable.class)
        when(mockDynamoDbClient.batchGetItemPaginator(BatchGetItemRequest.builder()
                .requestItems([:]).build())).thenReturn(mockBatchGetItemIterable)
    ...
    void testTryBatchWriteItem() {
        // Setup
        when(mockDynamoDbClient.batchWriteItem(BatchWriteItemRequest.builder().requestItems([:]).build()))
    ...
    void testTryCreateGlobalTable() {
        ...
        def createGlobalTableResponse = CreateGlobalTableResponse.builder().build()
    ...
    void testTryDeleteItem() {
        ...
        when(mockDynamoDbClient.deleteItem(DeleteItemRequest.builder()
                .tableName("TableName")
                .key([:]).build())).thenReturn(DeleteItemResponse.builder().build())
    ...
    void testTryDeleteItem_DynamoDbClientThrowsConditionalCheckFailedException() {
        ...
        when(mockDynamoDbClient.deleteItem(DeleteItemRequest.builder()
                .tableName("TableName")
                .key([:]).build())).thenThrow(ConditionalCheckFailedException.class)
    ...
    void testTryDeleteItem_DynamoDbClientThrowsProvisionedThroughputExceededException() {
        ...
        when(mockDynamoDbClient.deleteItem(DeleteItemRequest.builder()
                .tableName("TableName")
                .key([:]).build())).thenThrow(ProvisionedThroughputExceededException.class)
    ...
    void testTryDeleteItem_DynamoDbClientThrowsResourceNotFoundException() {
        ...
        when(mockDynamoDbClient.deleteItem(DeleteItemRequest.builder()
                .tableName("TableName")
                .key([:]).build())).thenThrow(ResourceNotFoundException.class)
    ...
    void testTryDeleteItem_DynamoDbClientThrowsItemCollectionSizeLimitExceededException() {
        ...
        when(mockDynamoDbClient.deleteItem(DeleteItemRequest.builder()
                .tableName("TableName")
                .key([:]).build())).thenThrow(ItemCollectionSizeLimitExceededException.class)
    ...
    void testTryDeleteItem_DynamoDbClientThrowsTransactionConflictException() {
        ...
        when(mockDynamoDbClient.deleteItem(DeleteItemRequest.builder()
                .tableName("TableName")
                .key([:]).build())).thenThrow(TransactionConflictException.class)
    ...
    void testTryDeleteItem_DynamoDbClientThrowsRequestLimitExceededException() {
        ...
        when(mockDynamoDbClient.deleteItem(DeleteItemRequest.builder()
                .tableName("TableName")
                .key([:]).build())).thenThrow(RequestLimitExceededException.class)
    ...
    void testTryDeleteItem_DynamoDbClientThrowsInternalServerErrorException() {
        ...
        when(mockDynamoDbClient.deleteItem(DeleteItemRequest.builder()
                .tableName("TableName")
                .key([:]).build())).thenThrow(InternalServerErrorException.class)
    ...
    void testTryDeleteItem_DynamoDbClientThrowsAwsServiceException() {
        ...
        when(mockDynamoDbClient.deleteItem(DeleteItemRequest.builder()
                .tableName("TableName")
                .key([:]).build())).thenThrow(AwsServiceException.class)
    ...
    void testTryDeleteItem_DynamoDbClientThrowsSdkClientException() {
        ...
        when(mockDynamoDbClient.deleteItem(DeleteItemRequest.builder()
                .tableName("TableName")
                .key([:]).build())).thenThrow(SdkClientException.class)
    ...
    void testTryDeleteItem_DynamoDbClientThrowsDynamoDbException() {
        ...
        when(mockDynamoDbClient.deleteItem(DeleteItemRequest.builder()
                .tableName("TableName")
                .key([:]).build())).thenThrow(DynamoDbException.class)
    ...
    void testTryDescribeContinuousBackups() {
        ...
        def describeContinuousBackupsResponse = DescribeContinuousBackupsResponse.builder().build()
    ...
    void testTryDescribeEndpoints() {
        ...
        def describeEndpointsResponse = DescribeEndpointsResponse.builder().build()
    ...
    void testTryDescribeGlobalTable() {
        ...
        def describeGlobalTableResponse = DescribeGlobalTableResponse.builder().build()
    ...
    void testTryDescribeGlobalTableSettings() {
        ...
        def describeGlobalTableSettingsResponse = DescribeGlobalTableSettingsResponse.builder().build()
    ...
    void testTryDescribeTimeToLive() {
        ...
        def describeTimeToLiveResponse = DescribeTimeToLiveResponse.builder().build()
    ...
    void testTryGetItem() {
        ...
        def getItemResponse = GetItemResponse.builder()
                .item([:]).build()
        when(mockDynamoDbClient.getItem(GetItemRequest.builder()
                .tableName("TableName")
                .key([:]).build())).thenReturn(getItemResponse)
    ...
    void testTryGetItem_DynamoDbClientReturnsNoItem() {
        ...
        when(mockDynamoDbClient.getItem(GetItemRequest.builder()
                .tableName("TableName")
                .key([:]).build())).thenReturn(GetItemResponse.builder().build())
    ...
    void testTryListGlobalTables() {
        ...
        def listGlobalTablesResponse = ListGlobalTablesResponse.builder().build()
    ...
    void testTryListTablesPaginator() {
        ...
        def mockListTablesIterable = mock(ListTablesIterable.class)
    ...
    void testTryListTagsOfResource() {
        ...
        def listTagsOfResourceResponse = ListTagsOfResourceResponse.builder().build()
    ...
    void testTryPutItem() {
        ...
        when(mockDynamoDbClient.putItem(PutItemRequest.builder()
                .tableName("TableName")
                .item([:]).build())).thenReturn(PutItemResponse.builder().build())
    ...
    void testTryPutItem_DynamoDbClientThrowsConditionalCheckFailedException() {
        ...
        when(mockDynamoDbClient.putItem(PutItemRequest.builder()
                .tableName("TableName")
                .item([:]).build())).thenThrow(ConditionalCheckFailedException.class)
    ...
    void testTryPutItem_DynamoDbClientThrowsProvisionedThroughputExceededException() {
        ...
        when(mockDynamoDbClient.putItem(PutItemRequest.builder()
                .tableName("TableName")
                .item([:]).build())).thenThrow(ProvisionedThroughputExceededException.class)
    ...
    void testTryPutItem_DynamoDbClientThrowsResourceNotFoundException() {
        ...
        when(mockDynamoDbClient.putItem(PutItemRequest.builder()
                .tableName("TableName")
                .item([:]).build())).thenThrow(ResourceNotFoundException.class)
    ...
    void testTryPutItem_DynamoDbClientThrowsItemCollectionSizeLimitExceededException() {
        ...
        when(mockDynamoDbClient.putItem(PutItemRequest.builder()
                .tableName("TableName")
                .item([:]).build())).thenThrow(ItemCollectionSizeLimitExceededException.class)
    ...
    void testTryPutItem_DynamoDbClientThrowsTransactionConflictException() {
        ...
        when(mockDynamoDbClient.putItem(PutItemRequest.builder()
                .tableName("TableName")
                .item([:]).build())).thenThrow(TransactionConflictException.class)
    ...
    void testTryPutItem_DynamoDbClientThrowsRequestLimitExceededException() {
        ...
        when(mockDynamoDbClient.putItem(PutItemRequest.builder()
                .tableName("TableName")
                .item([:]).build())).thenThrow(RequestLimitExceededException.class)
    ...
    void testTryPutItem_DynamoDbClientThrowsInternalServerErrorException() {
        ...
        when(mockDynamoDbClient.putItem(PutItemRequest.builder()
                .tableName("TableName")
                .item([:]).build())).thenThrow(InternalServerErrorException.class)
    ...
    void testTryPutItem_DynamoDbClientThrowsAwsServiceException() {
        ...
        when(mockDynamoDbClient.putItem(PutItemRequest.builder()
                .tableName("TableName")
                .item([:]).build())).thenThrow(AwsServiceException.class)
    ...
    void testTryPutItem_DynamoDbClientThrowsSdkClientException() {
        ...
        when(mockDynamoDbClient.putItem(PutItemRequest.builder()
                .tableName("TableName")
                .item([:]).build())).thenThrow(SdkClientException.class)
    ...
    void testTryPutItem_DynamoDbClientThrowsDynamoDbException() {
        ...
        when(mockDynamoDbClient.putItem(PutItemRequest.builder()
                .tableName("TableName")
                .item([:]).build())).thenThrow(DynamoDbException.class)
    ...
    void testTryQueryPaginator() {
        ...
        def mockQueryIterable = mock(QueryIterable.class)
    ...
    void testTryRestoreTableFromBackup() {
        ...
        def restoreTableFromBackupResponse = RestoreTableFromBackupResponse.builder().build()
    ...
    void testTryRestoreTableToPointInTime() {
        ...
        def restoreTableToPointInTimeResponse = RestoreTableToPointInTimeResponse.builder().build()
    ...
    void testTryScan() {
        ...
        def scanResponse = ScanResponse.builder()
                .items([:]).build()
    ...
    void testTryScanPaginator() {
        ...
        def mockScanIterable = mock(ScanIterable.class)
    ...
    void testTryTransactGetItems() {
        ...
        def transactGetItemsResponse = TransactGetItemsResponse.builder()
    ...
    void testTryTransactGetItems_DynamoDbClientReturnsNoItems() {
        // Setup
        // Configure DynamoDbClient.transactGetItems(...).
        def transactGetItemsResponse = TransactGetItemsResponse.builder().build()
        when(mockDynamoDbClient.transactGetItems(TransactGetItemsRequest.builder()
                .transactItems(Arrays.asList(
                        TransactGetItem.builder().get(Get.builder()
                                .tableName("TableName")
    ...
    void testTryTransactWriteItems() {
        ...
        def transactWriteItemsResponse = TransactWriteItemsResponse.builder().build()
    ...
    void testTryUpdateContinuousBackups() {
        ...
        def updateContinuousBackupsResponse = UpdateContinuousBackupsResponse.builder().build()
    ...
    void testTryUpdateGlobalTable() {
        ...
        def updateGlobalTableResponse = UpdateGlobalTableResponse.builder().build()
    ...
    void testTryUpdateGlobalTableSettings() {
        ...
        def updateGlobalTableSettingsResponse = UpdateGlobalTableSettingsResponse.builder().build()
    ...
    void testTryUpdateTimeToLive() {
        ...
        def updateTimeToLiveResponse = UpdateTimeToLiveResponse.builder().build()
