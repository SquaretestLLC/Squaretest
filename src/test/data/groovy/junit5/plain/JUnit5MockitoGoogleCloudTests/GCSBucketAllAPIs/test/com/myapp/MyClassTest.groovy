...
class MyClassTest {
    ...
    void testTryGet2() {
        // Setup
        when(mockBucket.get("blobName1", "blobName2", "blobNames")).thenReturn([])
    ...
    void testTryGet3() {
        // Setup
        when(mockBucket.get(any(Iterable.class))).thenReturn([])
    ...
    void testTryListAcls_BucketReturnsNoItems() {
        // Setup
        when(mockBucket.listAcls()).thenReturn([])
    ...
    void testTryListDefaultAcls_BucketReturnsNoItems() {
        // Setup
        when(mockBucket.listDefaultAcls()).thenReturn([])
