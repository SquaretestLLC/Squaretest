...
class MyClassTest {
    ...
    void testTryCreate1() {
        ...
        def mockBucket = mock(Bucket.class)
    ...
    @Test
    void testTryCreateFrom1_StorageThrowsIOException() {
        // Setup
        when(mockStorage.createFrom(BlobInfo.newBuilder(BlobId.of("bucket", "name")).build(), Paths.get("filename.txt"),
    ...
    @Test
    void testTryCreateFrom2_StorageThrowsIOException() {
        // Setup
        when(mockStorage.createFrom(BlobInfo.newBuilder(BlobId.of("bucket", "name")).build(), Paths.get("filename.txt"),
                0, Storage.BlobWriteOption.predefinedAcl(Storage.PredefinedAcl.AUTHENTICATED_READ)))
                .thenThrow(IOException.class)
    ...
    @Test
    void testTryCreateFrom3_StorageThrowsIOException() {
        // Setup
        when(mockStorage.createFrom(eq(BlobInfo.newBuilder(BlobId.of("bucket", "name")).build()),
                any(InputStream.class),
                eq(Storage.BlobWriteOption.predefinedAcl(Storage.PredefinedAcl.AUTHENTICATED_READ))))
    ...
    @Test
    void testTryCreateFrom4_StorageThrowsIOException() {
        // Setup
        when(mockStorage.createFrom(eq(BlobInfo.newBuilder(BlobId.of("bucket", "name")).build()),
                any(InputStream.class), eq(0),
                eq(Storage.BlobWriteOption.predefinedAcl(Storage.PredefinedAcl.AUTHENTICATED_READ))))
    ...
    void testTryCopy() {
        ...
        def mockCopyWriter = mock(CopyWriter.class)
    ...
    void testTryReader1() {
        ...
        def mockReadChannel = mock(ReadChannel.class)
    ...
    void testTryWriter1() {
        ...
        def mockWriteChannel = mock(WriteChannel.class)
    ...
    @Test
    void testTryWriter2_StorageThrowsStorageException() {
        // Setup
    ...
    void testTrySignUrl_StorageThrowsSigningException() {
        ...
        // Run the test
        assertThrows(ServiceAccountSigner.SigningException.class, {
            myClassUnderTest.trySignUrl()
        })
    }
    ...
    void testTryGenerateSignedPostPolicyV41() {
        // Setup
        // Configure Storage.generateSignedPostPolicyV4(...).
        def postPolicyV4 = PostPolicyV4.of("url", ["value": "value"])
    ...
    void testTryGenerateSignedPostPolicyV42() {
        ...
        when(mockStorage.generateSignedPostPolicyV4(eq(BlobInfo.newBuilder(BlobId.of("bucket", "name")).build()),
                eq(0L), eq(TimeUnit.MILLISECONDS), any(PostPolicyV4.PostFieldsV4.class),
                any(Storage.PostPolicyV4Option.class))).thenReturn(postPolicyV4)
    ...
    void testTryGenerateSignedPostPolicyV44() {
        ...
        def postPolicyV4 = PostPolicyV4.of("url", ["value": "value"])
        when(mockStorage.generateSignedPostPolicyV4(eq(BlobInfo.newBuilder(BlobId.of("bucket", "name")).build()),
                eq(0L), eq(TimeUnit.MILLISECONDS), any(Storage.PostPolicyV4Option.class))).thenReturn(postPolicyV4)
    ...
    void testTryGet6() {
        // Setup
        when(mockStorage.get(any(Iterable.class))).thenReturn([])
    ...
    void testTryUpdate5() {
        // Setup
        when(mockStorage.update(any(Iterable.class))).thenReturn([])
    ...
    void testTryDelete6() {
        // Setup
        when(mockStorage.delete(any(Iterable.class))).thenReturn([false])
    ...
    void testTryDelete6_StorageReturnsNoItems() {
        // Setup
        when(mockStorage.delete(any(Iterable.class))).thenReturn([])
    ...
    void testTryGetAcl1() {
        ...
        def acl = Acl.of(null, Acl.Role.valueOfStrict("constant"))
    ...
    void testTryListAcls1() {
        ...
        def acls = [Acl.of(null, Acl.Role.valueOfStrict("constant"))]
    ...
    void testTryListAcls1_StorageReturnsNoItems() {
        // Setup
        when(mockStorage.listAcls("bucket", Storage.BucketSourceOption.metagenerationMatch(0L))).thenReturn([])
    ...
    void testTryListAcls2_StorageReturnsNoItems() {
        // Setup
        when(mockStorage.listAcls("bucket")).thenReturn([])
    ...
    void testTryListDefaultAcls_StorageReturnsNoItems() {
        // Setup
        when(mockStorage.listDefaultAcls("bucket")).thenReturn([])
    ...
    void testTryListAcls3_StorageReturnsNoItems() {
        // Setup
        when(mockStorage.listAcls(BlobId.of("bucket", "name"))).thenReturn([])
    ...
    void testTryGetHmacKey() {
        ...
        def hmacKeyMetadata = HmacKey.HmacKeyMetadata.of(ServiceAccount.of("email"), "accessId", "projectId")
    ...
    void testTryTestIamPermissions() {
        // Setup
        when(mockStorage.testIamPermissions("bucket", ["value"],
                Storage.BucketSourceOption.metagenerationMatch(0L))).thenReturn([false])
    ...
    void testTryTestIamPermissions_StorageReturnsNoItems() {
        // Setup
        when(mockStorage.testIamPermissions("bucket", ["value"],
                Storage.BucketSourceOption.metagenerationMatch(0L))).thenReturn([])
